...
public class WorkProduct_1_0_0
{
    ...
    public WorkProduct_1_0_0Data? Data { get; set; }

}

public class WorkProduct_1_0_0Data : AbstractCommonResources100
{
    ...
    public AbstractSpatialLocation100? SpatialPoint { get; set; }

    [JsonPropertyName("SpatialArea")]
    public AbstractSpatialLocation100? SpatialArea { get; set; }
    ...
    public List<WorkProduct_1_0_0DataLineageAssertions> LineageAssertions { get; set; }
...
public class WorkProduct_1_0_0DataLineageAssertions
{
    /// <summary>
