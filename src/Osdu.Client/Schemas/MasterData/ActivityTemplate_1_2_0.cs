...
/// </summary>
public class ActivityTemplate_1_2_0
{
    /// <summary>
...
public class ActivityTemplate_1_2_0Data : AbstractCommonResources101 // Also composes: AbstractMaster120
{
    /// <summary>
...
public class ActivityTemplate_1_2_0DataParameters
{
    ...
    public AbstractActivityParameter120? DefaultValue { get; set; }
    ...
    /// <summary>
    /// A human-readable description of this parameter, explaining its purpose, expected values, and any relevant constraints. Used to document the intent of the parameter for users implementing or interpreting the workflow.
    /// </summary>
    [JsonPropertyName("Description")]
    public string Description { get; set; }
