...
/// <summary>
/// A standard report of all drilling, completion or well work events conducted on a well during a given period, usually a 24-hour day, not necessarily aligned with the local time zone. Printed snapshots, e.g. PDF files, are captured as work-product-component--Document, which relate via data.LineageAssertions.
/// </summary>
public class OperationsReport_1_4_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:master-data\-\-OperationsReport:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public OperationsReport_1_4_0_Data? Data { get; set; }

}

public class OperationsReport_1_4_0_Data : AbstractCommonResources_1_0_0 // Also composes: AbstractMaster_1_2_0
{
    /// <summary>
    ...
    public List<OperationsReport_1_4_0_Data_BitRecord> BitRecord { get; set; }
    ...
    public List<OperationsReport_1_4_0_Data_DrillActivity> DrillActivity { get; set; }
    ...
    public List<OperationsReport_1_4_0_Data_OperationsActivity> OperationsActivity { get; set; }
    ...
    public OperationsReport_1_4_0_Data_WellAlias? WellAlias { get; set; }

    /// <summary>
    /// Local name defined for the wellbore
    /// </summary>
    [JsonPropertyName("WellboreAlias")]
    public List<OperationsReport_1_4_0_Data_WellboreAlias> WellboreAlias { get; set; }

    /// <summary>
    /// Information regarding the status of the wellbore during this reporting period
    /// </summary>
    [JsonPropertyName("StatusInfo")]
    public List<OperationsReport_1_4_0_Data_StatusInfo> StatusInfo { get; set; }
    ...
    public List<OperationsReport_1_4_0_Data_TimedComments> TimedComments { get; set; }
    ...
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:master-data\-\-Organisation:[\w\-\.\:\%]+:[0-9]*$")]
    [JsonPropertyName("StewardingCompanyID")]
    public string StewardingCompanyID { get; set; }
    ...
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:master-data\-\-Organisation:[\w\-\.\:\%]+:[0-9]*$")]
    [JsonPropertyName("StewardingCompanyTeamID")]
    public string StewardingCompanyTeamID { get; set; }

    /// <summary>
    /// Meteorological readings for the defined time period on an operations report
    /// </summary>
    [JsonPropertyName("Weather")]
    public List<OperationsReport_1_4_0_Data_Weather> Weather { get; set; }
...
/// </summary>
public class OperationsReport_1_4_0_Data_BitRecord
{
    /// <summary>
...
/// </summary>
public class OperationsReport_1_4_0_Data_DrillActivity
{
    /// <summary>
    ...
    public List<OperationsReport_1_4_0_Data_DrillActivity_ProprietaryActivityCode> ProprietaryActivityCode { get; set; }
...
/// </summary>
public class OperationsReport_1_4_0_Data_DrillActivity_ProprietaryActivityCode
{
    /// <summary>
    /// Identifier property
    /// </summary>
...
/// </summary>
public class OperationsReport_1_4_0_Data_OperationsActivity
{
    /// <summary>
    ...
    /// </summary>
    [JsonPropertyName("ProprietaryActivityCode")]
    public List<OperationsReport_1_4_0_Data_OperationsActivity_ProprietaryActivityCode> ProprietaryActivityCode { get; set; }
...
/// Definition of an alias
/// </summary>
public class OperationsReport_1_4_0_Data_OperationsActivity_ProprietaryActivityCode
{
    /// <summary>
    /// Identifier property
    /// </summary>
...
/// Local name defined for the Well
/// </summary>
public class OperationsReport_1_4_0_Data_WellAlias
{
    /// <summary>
    /// Identifier property
    /// </summary>
...
/// Definition of an alias
/// </summary>
public class OperationsReport_1_4_0_Data_WellboreAlias
{
    /// <summary>
    /// Identifier property
    /// </summary>
...
/// </summary>
public class OperationsReport_1_4_0_Data_StatusInfo
{
    /// <summary>
...
/// </summary>
public class OperationsReport_1_4_0_Data_TimedComments
{
    /// <summary>
...
/// Meteorological readings for the defined time period on an operations report
/// </summary>
public class OperationsReport_1_4_0_Data_Weather
{
    /// <summary>
    ...
    public TimeOnly WavePeriod { get; set; }
...
/// Snapshot of operations personnel broken down by each company on the rig at the time of the report.
/// </summary>
public class OperationsReport_1_4_0_Data_Personnel
{
    /// <summary>
...
/// Information related to pump operations on a drilling/operations report
/// </summary>
public class OperationsReport_1_4_0_Data_PumpOp
{
    /// <summary>
...
/// Information related to mud volumes for drilling/operations report
/// </summary>
public class OperationsReport_1_4_0_Data_MudVolume
{
    /// <summary>
    ...
    /// </summary>
    [JsonPropertyName("MudVolumeBuilt")]
    public string MudVolumeBuilt { get; set; }
...
/// Quantity of items inventoried during drilling and/or operations
/// </summary>
public class OperationsReport_1_4_0_Data_Inventory
{
    /// <summary>
    /// DEPRECATED: Cost for the product for the report interval.
    /// </summary>
    [JsonPropertyName("CostItem")]
...
/// Cost information captured for a defined time period during operations and/or drilling
/// </summary>
public class OperationsReport_1_4_0_Data_Cost
{
    /// <summary>
    /// Comments and remarks
    /// </summary>
...
/// Health Safety or Environment events that occurred since the last drilling/operation report. Captures data related to HSE events (e.g., tests, inspections, meetings, and drills), test values (e.g., pressure tested to), and/or incidents (e.g., discharges, non-compliance notices received, etc.).
/// </summary>
public class OperationsReport_1_4_0_Data_HSE
{
    /// <summary>
    /// Comments and remarks
    /// </summary>
...
/// Description of incidents that have occurred during the last drilling/operations report
/// </summary>
public class OperationsReport_1_4_0_Data_Incident
{
    /// <summary>
    /// Comments and remarks
    /// </summary>
...
/// Mud that has been lost during drilling / operations
/// </summary>
public class OperationsReport_1_4_0_Data_MudLosses
{
    /// <summary>
    /// Comments and remarks
    /// </summary>
...
/// General information about a gas reading taken during the drill report period
/// </summary>
public class OperationsReport_1_4_0_Data_GasReading
{
    /// <summary>
