...
public class ConnectedSourceDataJob_1_9_0
{
    ...
    public ConnectedSourceDataJob_1_9_0Data? Data { get; set; }

}

public class ConnectedSourceDataJob_1_9_0Data : AbstractCommonResources101 // Also composes: AbstractMaster120, AbstractProject100, AbstractProjectActivity120
{
    /// <summary>
    ...
    public List<ConnectedSourceDataJob_1_9_0DataWorkflows> Workflows { get; set; }

    [JsonPropertyName("OnIngestionLegalTags")]
    public AbstractLegalTags100? OnIngestionLegalTags { get; set; }

    [JsonPropertyName("OnIngestionAcl")]
    public AbstractAccessControlList100? OnIngestionAcl { get; set; }
    ...
    public List<ConnectedSourceDataJob_1_9_0DataExternalProcesses> ExternalProcesses { get; set; }
...
/// </summary>
public class ConnectedSourceDataJob_1_9_0DataWorkflows
{
    /// <summary>
    ...
    public List<ConnectedSourceDataJob_1_9_0DataWorkflowsParameters> Parameters { get; set; }
...
/// </summary>
public class ConnectedSourceDataJob_1_9_0DataWorkflowsParameters
{
    /// <summary>
...
/// A workflow configuration in the context of a scheduled job.
/// </summary>
public class ConnectedSourceDataJob_1_9_0DataExternalProcesses
{
    /// <summary>
