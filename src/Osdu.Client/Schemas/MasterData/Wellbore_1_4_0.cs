...
public class Wellbore_1_4_0
{
    ...
    public Wellbore_1_4_0Data? Data { get; set; }

}

public class Wellbore_1_4_0Data : AbstractCommonResources100 // Also composes: AbstractMaster120, AbstractFacility110
{
    ...
    public List<Wellbore_1_4_0DataVerticalMeasurements> VerticalMeasurements { get; set; }
    ...
    public List<Wellbore_1_4_0DataHistoricalInterests> HistoricalInterests { get; set; }
    ...
    public List<Wellbore_1_4_0DataWellboreCosts> WellboreCosts { get; set; }
...
public class Wellbore_1_4_0DataVerticalMeasurements : AbstractFacilityVerticalMeasurement100
{
    /// <summary>
...
/// </summary>
public class Wellbore_1_4_0DataHistoricalInterests
{
    /// <summary>
...
/// </summary>
public class Wellbore_1_4_0DataWellboreCosts
{
    /// <summary>
