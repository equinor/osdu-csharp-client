...
/// <summary>
/// Preliminary placeholder for the ReservoirSegment schema.
/// </summary>
public class ReservoirSegment_0_0_0
{
    /// <summary>
    ...
    public ReservoirSegment_0_0_0Data? Data { get; set; }

}

public class ReservoirSegment_0_0_0Data : AbstractCommonResources100 // Also composes: AbstractMaster120
{
    /// <summary>
    /// The name of the ReservoirSegment.
    /// </summary>
    [JsonPropertyName("Name")]
    public string Name { get; set; }

    /// <summary>
    /// The relationship to the (main) reservoir.
    /// </summary>
