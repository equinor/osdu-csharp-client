...
public class Wellbore_1_2_0
{
    ...
    public Wellbore_1_2_0Data? Data { get; set; }

}

public class Wellbore_1_2_0Data : AbstractCommonResources100 // Also composes: AbstractMaster110, AbstractFacility110
{
    ...
    public List<Wellbore_1_2_0DataVerticalMeasurements> VerticalMeasurements { get; set; }
    ...
    public List<Wellbore_1_2_0DataHistoricalInterests> HistoricalInterests { get; set; }
...
public class Wellbore_1_2_0DataVerticalMeasurements : AbstractFacilityVerticalMeasurement100
{
    /// <summary>
...
/// </summary>
public class Wellbore_1_2_0DataHistoricalInterests
{
    /// <summary>
