...
/// </summary>
public class FluidsProgram_1_1_0
{
    /// <summary>
    ...
    public FluidsProgram_1_1_0Data? Data { get; set; }

}

public class FluidsProgram_1_1_0Data : AbstractCommonResources100 // Also composes: AbstractMaster120
{
    /// <summary>
    ...
    public List<FluidsProgram_1_1_0DataFluidIntervals> FluidIntervals { get; set; }
...
/// </summary>
public class FluidsProgram_1_1_0DataFluidIntervals
{
    /// <summary>
    ...
    public FluidsProgram_1_1_0DataFluidIntervalsFluidsSystem FluidsSystem { get; set; }
...
/// Provides the overall description of the drilling fluids system.
/// </summary>
public class FluidsProgram_1_1_0DataFluidIntervalsFluidsSystem
{
    /// <summary>
    ...
    public List<FluidsProgram_1_1_0DataFluidIntervalsFluidsSystemFluidProperties> FluidProperties { get; set; }

    /// <summary>
    /// Description of the formulation to be used for the drilling activity
    /// </summary>
    [JsonPropertyName("BarrelFormulation")]
    public List<FluidsProgram_1_1_0DataFluidIntervalsFluidsSystemBarrelFormulation> BarrelFormulation { get; set; }
...
/// </summary>
public class FluidsProgram_1_1_0DataFluidIntervalsFluidsSystemFluidProperties
{
    /// <summary>
    ...
    public List<FluidsProgram_1_1_0DataFluidIntervalsFluidsSystemFluidPropertiesFluidFacets> FluidFacets { get; set; }
...
/// </summary>
public class FluidsProgram_1_1_0DataFluidIntervalsFluidsSystemFluidPropertiesFluidFacets
{
    /// <summary>
...
/// </summary>
public class FluidsProgram_1_1_0DataFluidIntervalsFluidsSystemBarrelFormulation
{
    /// <summary>
    /// Name of the Product
    /// </summary>
