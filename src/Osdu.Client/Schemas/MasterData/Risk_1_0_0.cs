...
public class Risk_1_0_0
{
    ...
    public Risk_1_0_0Data? Data { get; set; }

}

public class Risk_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractMaster100
{
    /// <summary>
    /// A textual description of the steps to prevent this risk
    /// </summary>
    [JsonPropertyName("Preventions")]
    public List<Risk_1_0_0DataPreventions> Preventions { get; set; }
    ...
    public List<Risk_1_0_0DataMitigations> Mitigations { get; set; }
    ...
    public List<AbstractContact100> RiskResponsibles { get; set; }
...
/// </summary>
public class Risk_1_0_0DataPreventions
{
    /// <summary>
    ...
    public List<AbstractContact100> Responsibles { get; set; }
...
/// Describe a set of action to prevent for a risk or to mitigate its consequences
/// </summary>
public class Risk_1_0_0DataMitigations
{
    /// <summary>
    /// Name of the response
    /// </summary>
