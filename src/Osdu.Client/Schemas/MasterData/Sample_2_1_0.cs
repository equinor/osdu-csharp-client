...
public class Sample_2_1_0
{
    ...
    public Sample_2_1_0Data? Data { get; set; }

}

public class Sample_2_1_0Data : AbstractCommonResources100 // Also composes: AbstractMaster120
{
    /// <summary>
    ...
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:(reference-data\-\-SampleType|reference-data\-\-ConventionalCoreType|reference-data\-\-SidewallCoreType|reference-data\-\-RockSampleType):[\w\-\.\:\%]+:[0-9]*$")]
    ...
    public Sample_2_1_0DataSampleAcquisition? SampleAcquisition { get; set; }

    [JsonPropertyName("SampleProperties")]
    public AbstractSampleProperties110? SampleProperties { get; set; }
    ...
    public Sample_2_1_0DataRecombinationSpecification? RecombinationSpecification { get; set; }
    ...
    public List<Sample_2_1_0DataSamplePreparation> SamplePreparation { get; set; }
...
/// This captures the acquisition parameters obtained during  the sample acquisition event associated with this sample. Note that this attribute should only be used when associating the sample with an acquisition event from its original source and not for sub-sampling or derivative sources.
/// </summary>
public class Sample_2_1_0DataSampleAcquisition
{
    /// <summary>
    ...
    public Sample_2_1_0DataSampleAcquisitionSampleAcquisitionDetail? SampleAcquisitionDetail { get; set; }
...
/// This attribute provides information about the acquisition parameters and process used in acquiring the target sample. Other information about the sample itself can be found in the Sample object.
/// </summary>
public class Sample_2_1_0DataSampleAcquisitionSampleAcquisitionDetail
{
    ...
    public AbstractPTCondition100? WellheadOperatingCondition { get; set; }
    ...
    public AbstractPTCondition100? SeparatorOperatingCondition { get; set; }
    ...
    public Sample_2_1_0DataSampleAcquisitionSampleAcquisitionDetailSamplingPoint? SamplingPoint { get; set; }
    ...
    public AbstractPTCondition100? FormationCondition { get; set; }

    [JsonPropertyName("CorrectionRemarks")]
    public AbstractRemark100? CorrectionRemarks { get; set; }
    ...
    public AbstractPTCondition100? FacilityEquipmentOperatingCondition { get; set; }
    ...
    public AbstractPTCondition100? AcquisitionCondition { get; set; }
...
/// SamplingPoint= [ PRODML:2.1:FluidSampleAcquisitionJob.FluidSampleAcquisition&lt;SeparatorSampleAcquisition | FacilitySampleAcquisition | SeparatorSampleAcquisition&gt;[].Item.SamplingPoint
/// </summary>
public class Sample_2_1_0DataSampleAcquisitionSampleAcquisitionDetailSamplingPoint
{
    /// <summary>
...
/// For a sample that has been recombined from separate samples, e.g. liquid sample and vapor sample, this object records the specified: recombination conditions (pressure and temperature), recombination ratio, the saturation pressure and  target recombined sample composition, whichever of these are appropriate for this recombination effort.
/// </summary>
public class Sample_2_1_0DataRecombinationSpecification
{
    [Required]
    [JsonPropertyName("RecombinationCondition")]
    public AbstractPTCondition100 RecombinationCondition { get; set; }
    ...
    public Sample_2_1_0DataRecombinationSpecificationRecombinationGasOilRatio? RecombinationGasOilRatio { get; set; }
    ...
    public List<Sample_2_1_0DataRecombinationSpecificationTargetSampleComposition> TargetSampleComposition { get; set; }
    ...
    public List<Sample_2_1_0DataRecombinationSpecificationRecombinedSampleFraction> RecombinedSampleFraction { get; set; }
...
/// The gas-oil ratio recorded for this sample recombination process as well as the volumetric reference conditions for both the oil and gas phases. This is typically required for fluid sample types.
/// </summary>
public class Sample_2_1_0DataRecombinationSpecificationRecombinationGasOilRatio
{
    /// <summary>
    ...
    public AbstractPTCondition100 VolumeReferenceConditionGas { get; set; }

    [Required]
    [JsonPropertyName("VolumeReferenceConditionOil")]
    public AbstractPTCondition100 VolumeReferenceConditionOil { get; set; }
...
/// </summary>
public class Sample_2_1_0DataRecombinationSpecificationTargetSampleComposition
{
    /// <summary>
...
/// This object holds information about a sample or component of a sample and its contribution to a target sample created through the recombination process.
/// </summary>
public class Sample_2_1_0DataRecombinationSpecificationRecombinedSampleFraction
{
    /// <summary>
    /// This is the OSDU Record ID of an item in the list of  sample components. This attribute references the components that make up a sample.
    /// </summary>
...
/// This captures information about the preparation process executed after the sample acquisition event.
/// </summary>
public class Sample_2_1_0DataSamplePreparation
{
    /// <summary>
    ...
    public AbstractPTCondition100? SamplePreparationCondition { get; set; }
