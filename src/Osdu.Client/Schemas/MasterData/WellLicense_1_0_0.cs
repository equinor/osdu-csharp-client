...
public class WellLicense_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractMaster120
{
    /// <summary>
    ...
    public List<AbstractWellLicenseCondition100> LicenseConditions { get; set; }

    /// <summary>
    /// Remarks and narratives associated to the license.
    /// </summary>
    [JsonPropertyName("LicenseRemarks")]
    public List<AbstractRemark100> LicenseRemarks { get; set; }

    /// <summary>
    /// Services associated with the license.
    /// </summary>
    [JsonPropertyName("LicenseServices")]
    public List<AbstractWellLicenseService100> LicenseServices { get; set; }

    /// <summary>
    /// Details about LicenseStates, past and present.
    /// </summary>
    [JsonPropertyName("LicenseStates")]
    public List<AbstractWellLicenseStatus100> LicenseStates { get; set; }

    /// <summary>
    /// Details about violations of conditions, past and present.
    /// </summary>
    [JsonPropertyName("LicenseViolations")]
    public List<AbstractWellLicenseViolation100> LicenseViolations { get; set; }
