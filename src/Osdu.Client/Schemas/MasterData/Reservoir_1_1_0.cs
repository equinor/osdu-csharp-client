...
public class Reservoir_1_1_0_Data : AbstractCommonResources_1_0_0 // Also composes: AbstractMaster_1_2_0, AbstractGenericReservoirUnit_1_1_0
{
    ...
    public List<Reservoir_1_1_0_Data_Status> Status { get; set; }
    ...
    public Reservoir_1_1_0_Data_CurrentStatus? CurrentStatus { get; set; }
...
/// </summary>
public class Reservoir_1_1_0_Data_Status
{
    /// <summary>
...
/// Currently active Status of a production model element as exploration, appraisal and development. The operational or legal status of the reservoir.
/// </summary>
public class Reservoir_1_1_0_Data_CurrentStatus
{
    /// <summary>
    /// Status description, e.g., Discovery, FirstProduction, Active, FirstInjection, Abandonned.
    /// </summary>
