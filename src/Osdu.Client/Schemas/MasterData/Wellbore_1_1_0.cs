...
public class Wellbore_1_1_0
{
    ...
    public Wellbore_1_1_0_Data? Data { get; set; }

}

public class Wellbore_1_1_0_Data : AbstractCommonResources_1_0_0 // Also composes: AbstractMaster_1_1_0, AbstractFacility_1_0_0
{
    /// <summary>
    ...
    public List<Wellbore_1_1_0_Data_VerticalMeasurements> VerticalMeasurements { get; set; }
    ...
    public List<Wellbore_1_1_0_Data_HistoricalInterests> HistoricalInterests { get; set; }
...
public class Wellbore_1_1_0_Data_VerticalMeasurements : AbstractFacilityVerticalMeasurement_1_0_0
{
    /// <summary>
...
/// </summary>
public class Wellbore_1_1_0_Data_HistoricalInterests
{
    /// <summary>
