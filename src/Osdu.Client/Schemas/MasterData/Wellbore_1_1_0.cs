...
public class Wellbore_1_1_0
{
    ...
    public Wellbore_1_1_0Data? Data { get; set; }

}

public class Wellbore_1_1_0Data : AbstractCommonResources100 // Also composes: AbstractMaster110, AbstractFacility100
{
    ...
    public List<Wellbore_1_1_0DataVerticalMeasurements> VerticalMeasurements { get; set; }
    ...
    public List<Wellbore_1_1_0DataHistoricalInterests> HistoricalInterests { get; set; }
...
public class Wellbore_1_1_0DataVerticalMeasurements : AbstractFacilityVerticalMeasurement100
{
    /// <summary>
...
/// </summary>
public class Wellbore_1_1_0DataHistoricalInterests
{
    /// <summary>
