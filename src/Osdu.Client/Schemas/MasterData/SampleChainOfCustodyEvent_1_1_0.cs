...
public class SampleChainOfCustodyEvent_1_1_0Data : AbstractCommonResources101 // Also composes: AbstractMaster120
{
    /// <summary>
    ...
    public AbstractPTCondition110? TransferCondition { get; set; }

    [JsonPropertyName("OpeningCondition")]
    public AbstractPTCondition110? OpeningCondition { get; set; }

    [JsonPropertyName("ClosingCondition")]
    public AbstractPTCondition110? ClosingCondition { get; set; }

    [JsonPropertyName("InitialSampleProperties")]
    public AbstractSampleProperties110? InitialSampleProperties { get; set; }

    [JsonPropertyName("RemainingSampleProperties")]
    public AbstractSampleProperties110? RemainingSampleProperties { get; set; }

    [JsonPropertyName("LostSampleProperties")]
    public AbstractSampleProperties110? LostSampleProperties { get; set; }
    ...
    public AbstractStorageLocation100? PreviousStorageLocation { get; set; }

    [JsonPropertyName("CurrentStorageLocation")]
    public AbstractStorageLocation100? CurrentStorageLocation { get; set; }
