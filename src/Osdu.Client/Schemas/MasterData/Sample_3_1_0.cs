...
public class Sample_3_1_0
{
    ...
    public Sample_3_1_0_Data? Data { get; set; }

}

public class Sample_3_1_0_Data : AbstractCommonResources_1_0_1 // Also composes: AbstractMaster_1_2_0
{
    /// <summary>
    ...
    public Sample_3_1_0_Data_SampleAcquisition? SampleAcquisition { get; set; }
    ...
    public Sample_3_1_0_Data_RecombinationSpecification? RecombinationSpecification { get; set; }
    ...
    public List<Sample_3_1_0_Data_SamplePreparation> SamplePreparation { get; set; }
    ...
    public List<AbstractFacilityVerticalMeasurement_1_0_0> DepthMeasurements { get; set; }

    [JsonPropertyName("DefinitiveDepthShift")]
    public AbstractDefinitiveDepthShift_1_0_0? DefinitiveDepthShift { get; set; }
...
/// This captures the acquisition parameters obtained during  the sample acquisition event associated with this sample. Note that this attribute should only be used when associating the sample with an acquisition event from its original source and not for sub-sampling or derivative sources.
/// </summary>
public class Sample_3_1_0_Data_SampleAcquisition
{
    /// <summary>
    ...
    public Sample_3_1_0_Data_SampleAcquisition_SampleAcquisitionDetail? SampleAcquisitionDetail { get; set; }
...
/// This attribute provides information about the acquisition parameters and process used in acquiring the target sample. Other information about the sample itself can be found in the Sample object.
/// </summary>
public class Sample_3_1_0_Data_SampleAcquisition_SampleAcquisitionDetail
{
    ...
    public AbstractPTCondition_1_1_0? WellheadOperatingCondition { get; set; }
    ...
    public AbstractPTCondition_1_1_0? SeparatorOperatingCondition { get; set; }
    ...
    public Sample_3_1_0_Data_SampleAcquisition_SampleAcquisitionDetail_SamplingPoint? SamplingPoint { get; set; }
    ...
    public AbstractPTCondition_1_1_0? FacilityEquipmentOperatingCondition { get; set; }
...
/// SamplingPoint= [ PRODML:2.1:FluidSampleAcquisitionJob.FluidSampleAcquisition&lt;SeparatorSampleAcquisition | FacilitySampleAcquisition | SeparatorSampleAcquisition&gt;[].Item.SamplingPoint
/// </summary>
public class Sample_3_1_0_Data_SampleAcquisition_SampleAcquisitionDetail_SamplingPoint
{
    /// <summary>
...
/// For a sample that has been recombined from separate samples, e.g. liquid sample and vapor sample, this object records the specified: recombination conditions (pressure and temperature), recombination ratio, the saturation pressure and  target recombined sample composition, whichever of these are appropriate for this recombination effort.
/// </summary>
public class Sample_3_1_0_Data_RecombinationSpecification
{
    [Required]
    ...
    public Sample_3_1_0_Data_RecombinationSpecification_RecombinationGasOilRatio? RecombinationGasOilRatio { get; set; }
    ...
    public List<Sample_3_1_0_Data_RecombinationSpecification_TargetSampleComposition> TargetSampleComposition { get; set; }
    ...
    public List<Sample_3_1_0_Data_RecombinationSpecification_RecombinedSampleFraction> RecombinedSampleFraction { get; set; }
...
/// The gas-oil ratio recorded for this sample recombination process as well as the volumetric reference conditions for both the oil and gas phases. This is typically required for fluid sample types.
/// </summary>
public class Sample_3_1_0_Data_RecombinationSpecification_RecombinationGasOilRatio
{
    /// <summary>
...
/// </summary>
public class Sample_3_1_0_Data_RecombinationSpecification_TargetSampleComposition
{
    /// <summary>
...
/// This object holds information about a sample or component of a sample and its contribution to a target sample created through the recombination process.
/// </summary>
public class Sample_3_1_0_Data_RecombinationSpecification_RecombinedSampleFraction
{
    /// <summary>
    /// This is the OSDU Record ID of an item in the list of  sample components. This attribute references the components that make up a sample.
    /// </summary>
...
/// This captures information about the preparation process executed after the sample acquisition event.
/// </summary>
public class Sample_3_1_0_Data_SamplePreparation
{
    /// <summary>
    ...
    public AbstractPTCondition_1_1_0? SamplePreparationCondition { get; set; }
