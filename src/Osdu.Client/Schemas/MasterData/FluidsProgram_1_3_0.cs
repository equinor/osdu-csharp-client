...
/// </summary>
public class FluidsProgram_1_3_0
{
    /// <summary>
    ...
    public FluidsProgram_1_3_0_Data? Data { get; set; }

}

public class FluidsProgram_1_3_0_Data : AbstractCommonResources_1_0_0 // Also composes: AbstractMaster_1_2_0
{
    /// <summary>
    ...
    public List<FluidsProgram_1_3_0_Data_FluidIntervals> FluidIntervals { get; set; }
...
/// </summary>
public class FluidsProgram_1_3_0_Data_FluidIntervals
{
    /// <summary>
    /// An identifier of a specific Fluid Interval that can be used by another object to reference the interval For example may be used by BHARun  to reference the fluid interval(s) planned to be used during a drilling run.
    /// </summary>
    [JsonPropertyName("FluidIntervalIdentifier")]
    public string FluidIntervalIdentifier { get; set; }
    ...
    /// <summary>
    /// A list of reference values defining the status of the fluid, e.g., water based, oil based, etc.)
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-MudClass:[\w\-\.\:\%]+:[0-9]*$")]
    [JsonPropertyName("MudClassID")]
    public string MudClassID { get; set; }
    ...
    public FluidsProgram_1_3_0_Data_FluidIntervals_FluidsSystem FluidsSystem { get; set; }
...
/// Provides the overall description of the drilling fluids system.
/// </summary>
public class FluidsProgram_1_3_0_Data_FluidIntervals_FluidsSystem
{
    /// <summary>
    ...
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:(reference-data\-\-WellFluidRole|reference-data\-\-FluidRole):[\w\-\.\:\%]+:[0-9]*$")]
    ...
    [JsonPropertyName("RheologicalModelID")]
    public string RheologicalModelID { get; set; }
    ...
    public List<FluidsProgram_1_3_0_Data_FluidIntervals_FluidsSystem_FluidProperties> FluidProperties { get; set; }

    /// <summary>
    /// Description of the formulation to be used for the drilling activity
    /// </summary>
    [JsonPropertyName("BarrelFormulation")]
    public List<FluidsProgram_1_3_0_Data_FluidIntervals_FluidsSystem_BarrelFormulation> BarrelFormulation { get; set; }
...
/// </summary>
public class FluidsProgram_1_3_0_Data_FluidIntervals_FluidsSystem_FluidProperties
{
    /// <summary>
    ...
    public List<FluidsProgram_1_3_0_Data_FluidIntervals_FluidsSystem_FluidProperties_FluidFacets> FluidFacets { get; set; }
...
/// </summary>
public class FluidsProgram_1_3_0_Data_FluidIntervals_FluidsSystem_FluidProperties_FluidFacets
{
    /// <summary>
...
/// </summary>
public class FluidsProgram_1_3_0_Data_FluidIntervals_FluidsSystem_BarrelFormulation
{
    /// <summary>
    /// Name of the Product
    /// </summary>
