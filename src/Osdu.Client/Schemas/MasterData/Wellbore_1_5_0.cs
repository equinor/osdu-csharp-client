...
public class Wellbore_1_5_0
{
    ...
    public Wellbore_1_5_0Data? Data { get; set; }

}

public class Wellbore_1_5_0Data : AbstractCommonResources100 // Also composes: AbstractMaster120, AbstractFacility110
{
    ...
    public List<Wellbore_1_5_0DataVerticalMeasurements> VerticalMeasurements { get; set; }

    /// <summary>
    /// The history of drilling reasons of the wellbore.
    /// </summary>
    [JsonPropertyName("DrillingReasons")]
    public List<AbstractWellboreDrillingReason110> DrillingReasons { get; set; }
    ...
    public AbstractSpatialLocation110? ProjectedBottomHoleLocation { get; set; }

    [JsonPropertyName("GeographicBottomHoleLocation")]
    public AbstractSpatialLocation110? GeographicBottomHoleLocation { get; set; }
    ...
    public List<Wellbore_1_5_0DataHistoricalInterests> HistoricalInterests { get; set; }
    ...
    public List<Wellbore_1_5_0DataWellboreCosts> WellboreCosts { get; set; }
...
public class Wellbore_1_5_0DataVerticalMeasurements : AbstractFacilityVerticalMeasurement100
{
    /// <summary>
...
/// </summary>
public class Wellbore_1_5_0DataHistoricalInterests
{
    /// <summary>
...
/// </summary>
public class Wellbore_1_5_0DataWellboreCosts
{
    /// <summary>
    ...
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:(reference-data\-\-WellActivityPhaseType|reference-data\-\-WellActivityType):[\w\-\.\:\%]+:[0-9]*$")]
