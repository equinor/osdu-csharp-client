...
public class GeometricTargetSet_1_0_0
{
    ...
    public GeometricTargetSet_1_0_0Data? Data { get; set; }

}

public class GeometricTargetSet_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractMaster100
{
    /// <summary>
    ...
    public List<GeometricTargetSet_1_0_0DataTargets> Targets { get; set; }
...
/// </summary>
public class GeometricTargetSet_1_0_0DataTargets
{
    /// <summary>
    ...
    public AbstractSpatialLocation100? Location { get; set; }

    /// <summary>
    /// The Geometry of the target.
    /// </summary>
    [JsonPropertyName("Geometry")]
    public GeometricTargetSet_1_0_0DataTargetsGeometry? Geometry { get; set; }
...
/// The Geometry of the target.
/// </summary>
public class GeometricTargetSet_1_0_0DataTargetsGeometry
{
    /// <summary>
    ...
    public List<GeometricTargetSet_1_0_0DataTargetsGeometryGeometrySections> GeometrySections { get; set; }
...
/// </summary>
public class GeometricTargetSet_1_0_0DataTargetsGeometryGeometrySections
{
    /// <summary>
