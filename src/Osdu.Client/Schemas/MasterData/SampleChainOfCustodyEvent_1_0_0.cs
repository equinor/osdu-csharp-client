...
public class SampleChainOfCustodyEvent_1_0_0
{
    ...
    public SampleChainOfCustodyEvent_1_0_0Data? Data { get; set; }

}

public class SampleChainOfCustodyEvent_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractMaster120
{
    /// <summary>
    ...
    public AbstractPTCondition100? TransferCondition { get; set; }

    [JsonPropertyName("OpeningCondition")]
    public AbstractPTCondition100? OpeningCondition { get; set; }

    [JsonPropertyName("ClosingCondition")]
    public AbstractPTCondition100? ClosingCondition { get; set; }

    [JsonPropertyName("InitialSampleProperties")]
    public AbstractSampleProperties100? InitialSampleProperties { get; set; }

    [JsonPropertyName("RemainingSampleProperties")]
    public AbstractSampleProperties100? RemainingSampleProperties { get; set; }

    [JsonPropertyName("LostSampleProperties")]
    public AbstractSampleProperties100? LostSampleProperties { get; set; }
