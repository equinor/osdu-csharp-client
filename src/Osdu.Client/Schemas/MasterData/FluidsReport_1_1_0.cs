...
/// </summary>
public class FluidsReport_1_1_0
{
    /// <summary>
    ...
    public FluidsReport_1_1_0Data? Data { get; set; }

}

public class FluidsReport_1_1_0Data : AbstractCommonResources100 // Also composes: AbstractMaster100
{
    /// <summary>
    ...
    public List<FluidsReport_1_1_0DataFluid> Fluid { get; set; }
...
/// </summary>
public class FluidsReport_1_1_0DataFluid
{
    /// <summary>
    ...
    public List<FluidsReport_1_1_0DataFluidRheometer> Rheometer { get; set; }
...
/// </summary>
public class FluidsReport_1_1_0DataFluidRheometer
{
    /// <summary>
    ...
    public List<FluidsReport_1_1_0DataFluidRheometerRheometerViscosities> RheometerViscosities { get; set; }
...
/// </summary>
public class FluidsReport_1_1_0DataFluidRheometerRheometerViscosities
{
    /// <summary>
