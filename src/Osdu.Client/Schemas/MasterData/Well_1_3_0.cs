...
public class Well_1_3_0
{
    ...
    public Well_1_3_0Data? Data { get; set; }

}

public class Well_1_3_0Data : AbstractCommonResources100 // Also composes: AbstractMaster120, AbstractFacility110
{
    /// <summary>
    ...
    public List<Well_1_3_0DataVerticalMeasurements> VerticalMeasurements { get; set; }
    ...
    public List<Well_1_3_0DataHistoricalInterests> HistoricalInterests { get; set; }
...
public class Well_1_3_0DataVerticalMeasurements : AbstractFacilityVerticalMeasurement100
{
    /// <summary>
...
/// </summary>
public class Well_1_3_0DataHistoricalInterests
{
    /// <summary>
    /// Business Interest [Well Interest Type] describes whether a company currently considers a well or its data to be a real or planned asset, and if so, the nature of and motivation for that company's interest.
    /// </summary>
