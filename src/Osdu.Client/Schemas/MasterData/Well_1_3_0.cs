...
public class Well_1_3_0
{
    ...
    public Well_1_3_0_Data? Data { get; set; }

}

public class Well_1_3_0_Data : AbstractCommonResources_1_0_0 // Also composes: AbstractMaster_1_2_0, AbstractFacility_1_1_0
{
    /// <summary>
    ...
    public List<Well_1_3_0_Data_VerticalMeasurements> VerticalMeasurements { get; set; }
    ...
    public List<Well_1_3_0_Data_HistoricalInterests> HistoricalInterests { get; set; }
...
public class Well_1_3_0_Data_VerticalMeasurements : AbstractFacilityVerticalMeasurement_1_0_0
{
    /// <summary>
...
/// </summary>
public class Well_1_3_0_Data_HistoricalInterests
{
    /// <summary>
    /// Business Interest [Well Interest Type] describes whether a company currently considers a well or its data to be a real or planned asset, and if so, the nature of and motivation for that company's interest.
    /// </summary>
