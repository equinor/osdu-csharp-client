...
/// <summary>
/// A named area that likely contains a combination of certain geological factors making it prospective for mineral exploration. It is often considered to be a set of prospects with a common set of characteristics.
/// </summary>
public class Play_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:master-data\-\-Play:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public Play_1_0_0Data? Data { get; set; }

}

public class Play_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractMaster100
{
    /// <summary>
    ...
    /// </summary>
    [JsonPropertyName("PlayNameAliases")]
    public List<AbstractAliasNames100> PlayNameAliases { get; set; }

    /// <summary>
    /// Textual description about a Play.
    /// </summary>
    [JsonPropertyName("PlayDescription")]
