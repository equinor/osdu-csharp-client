...
public class ActivityTemplateArc_1_1_0
{
    ...
    public ActivityTemplateArc_1_1_0Data? Data { get; set; }

}

public class ActivityTemplateArc_1_1_0Data : AbstractCommonResources100 // Also composes: AbstractMaster120
{
    /// <summary>
    ...
    /// <summary>
    /// A detailed textual description of the activity template arc connecting inputs and outputs of workflows (ActivityTemplate).
    /// </summary>
    ...
    public List<ActivityTemplateArc_1_1_0DataOutputInputArcs> OutputInputArcs { get; set; }

    /// <summary>
    /// The array of arcs, which link pairs of ActivityTemplate as predecessor and successor.
    /// </summary>
    [JsonPropertyName("ActivityArcs")]
    public List<ActivityTemplateArc_1_1_0DataActivityArcs> ActivityArcs { get; set; }
...
/// </summary>
public class ActivityTemplateArc_1_1_0DataOutputInputArcs
{
    /// <summary>
    ...
    [JsonPropertyName("ProducingActivityTemplateID")]
    public string ProducingActivityTemplateID { get; set; }

    /// <summary>
    /// The Title of the producing ActivityTemplate Parameter array element.
    /// </summary>
    [Required]
    [JsonPropertyName("ProducingParameterTitle")]
    public string ProducingParameterTitle { get; set; }
    ...
    [Required]
    [RegularExpression(@"^[\w\-\.]+:master-data\-\-ActivityTemplate:[\w\-\.\:\%]+:[0-9]*$")]
    [JsonPropertyName("ConsumingActivityTemplateID")]
    public string ConsumingActivityTemplateID { get; set; }

    /// <summary>
    /// The Title of the consuming ActivityTemplate Parameter array element.
    /// </summary>
    [Required]
    [JsonPropertyName("ConsumingParameterTitle")]
    public string ConsumingParameterTitle { get; set; }
...
/// An 'arc' establishing a link between a single pair of ActivityTemplate input and output parameters.
/// </summary>
public class ActivityTemplateArc_1_1_0DataActivityArcs
{
    /// <summary>
    ...
    [Required]
    [RegularExpression(@"^[\w\-\.]+:master-data\-\-ActivityTemplate:[\w\-\.\:\%]+:[0-9]*$")]
    [JsonPropertyName("PrecedingActivityTemplateID")]
    public string PrecedingActivityTemplateID { get; set; }

    /// <summary>
    /// The relationship to the ActivityTemplate succeeding the first ActivityTemplate in the workflow.
    /// </summary>
    [Required]
    [RegularExpression(@"^[\w\-\.]+:master-data\-\-ActivityTemplate:[\w\-\.\:\%]+:[0-9]*$")]
    [JsonPropertyName("SucceedingActivityTemplateID")]
    public string SucceedingActivityTemplateID { get; set; }
