...
/// <summary>
/// A ModelFeature is an explicit description of the relationships between geologic features such as rock volume features (e.g. stratigraphic units, geobodies, phase unit) and boundary features (e.g., genetic, tectonic, and fluid boundaries).
/// </summary>
public class ModelFeature_1_1_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:master-data\-\-ModelFeature:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public ModelFeature_1_1_0Data? Data { get; set; }

}

public class ModelFeature_1_1_0Data : AbstractCommonResources100 // Also composes: AbstractMaster120
{
    /// <summary>
