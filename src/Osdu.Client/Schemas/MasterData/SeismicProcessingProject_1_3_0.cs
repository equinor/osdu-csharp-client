...
/// </summary>
public class SeismicProcessingProject_1_3_0
{
    /// <summary>
    ...
    public SeismicProcessingProject_1_3_0_Data? Data { get; set; }

}

public class SeismicProcessingProject_1_3_0_Data : AbstractCommonResources_1_0_0 // Also composes: AbstractMaster_1_2_0, AbstractProject_1_0_0, AbstractProjectActivity_1_2_0
{
    /// <summary>
    ...
    public List<SeismicProcessingProject_1_3_0_Data_FundsAuthorizations> FundsAuthorizations { get; set; }
    ...
    public List<SeismicProcessingProject_1_3_0_Data_Contractors> Contractors { get; set; }
    ...
    public List<SeismicProcessingProject_1_3_0_Data_Personnel> Personnel { get; set; }
    ...
    public List<SeismicProcessingProject_1_3_0_Data_ProjectSpecifications> ProjectSpecifications { get; set; }

    /// <summary>
    /// The history of life cycle states that the Project has been through..
    /// </summary>
    [JsonPropertyName("ProjectStates")]
    public List<SeismicProcessingProject_1_3_0_Data_ProjectStates> ProjectStates { get; set; }
...
/// The history of expenditure approvals.
/// </summary>
public class SeismicProcessingProject_1_3_0_Data_FundsAuthorizations
{
    /// <summary>
...
/// References to organisations which supplied services to the Project.
/// </summary>
public class SeismicProcessingProject_1_3_0_Data_Contractors
{
    /// <summary>
...
/// List of key individuals supporting the Project.  This could be Abstracted for re-use, and could reference a separate Persons master data object.
/// </summary>
public class SeismicProcessingProject_1_3_0_Data_Personnel
{
    /// <summary>
...
/// General parameters defining the configuration of the Project.  In the case of a seismic acquisition project it is like receiver interval, source depth, source type.  In the case of a processing project, it is like replacement velocity, reference datum above mean sea level.
/// </summary>
public class SeismicProcessingProject_1_3_0_Data_ProjectSpecifications
{
    /// <summary>
...
/// The history of life cycle states that the Project has been through..
/// </summary>
public class SeismicProcessingProject_1_3_0_Data_ProjectStates
{
    /// <summary>
