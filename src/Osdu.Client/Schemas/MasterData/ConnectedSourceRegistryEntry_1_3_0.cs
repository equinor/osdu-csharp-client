...
public class ConnectedSourceRegistryEntry_1_3_0
{
    ...
    public ConnectedSourceRegistryEntry_1_3_0Data? Data { get; set; }

}

public class ConnectedSourceRegistryEntry_1_3_0Data : AbstractCommonResources100 // Also composes: AbstractMaster120, AbstractProject100, AbstractProjectActivity120
{
    /// <summary>
    ...
    public List<ConnectedSourceRegistryEntry_1_3_0DataSecuritySchemes> SecuritySchemes { get; set; }

    /// <summary>
    /// List of SMTP server schemes available for use in mailing the detailed EDS's report.
    /// </summary>
    [JsonPropertyName("SmtpSchemes")]
    public List<ConnectedSourceRegistryEntry_1_3_0DataSmtpSchemes> SmtpSchemes { get; set; }
...
/// </summary>
public class ConnectedSourceRegistryEntry_1_3_0DataSecuritySchemes
{
    /// <summary>
...
/// </summary>
public class ConnectedSourceRegistryEntry_1_3_0DataSmtpSchemes
{
    /// <summary>
