...
/// <summary>
/// A facility is a grouping of equipment that is located within a specific geographic boundary or site and that is used in the context of energy-related activities such as exploration, extraction, generation, storage, processing, disposal, supply, or transfer. A generic facility identifies a facility that is not defined by a specialized data schema such as Well, Wellbore, StorageFacility , IsolatedInterval, Rig, etc.
/// </summary>
public class GenericFacility_1_0_1
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:master-data\-\-GenericFacility:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public GenericFacility_1_0_1Data? Data { get; set; }

}

public class GenericFacility_1_0_1Data : AbstractCommonResources100 // Also composes: AbstractMaster120, AbstractFacility110
{
