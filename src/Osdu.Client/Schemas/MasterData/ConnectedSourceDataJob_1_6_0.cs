...
public class ConnectedSourceDataJob_1_6_0
{
    ...
    public ConnectedSourceDataJob_1_6_0Data? Data { get; set; }

}

public class ConnectedSourceDataJob_1_6_0Data : AbstractCommonResources100 // Also composes: AbstractMaster120, AbstractProject100, AbstractProjectActivity120
{
    /// <summary>
    ...
    public List<ConnectedSourceDataJob_1_6_0DataWorkflows> Workflows { get; set; }
...
/// </summary>
public class ConnectedSourceDataJob_1_6_0DataWorkflows
{
    /// <summary>
    ...
    public List<ConnectedSourceDataJob_1_6_0DataWorkflowsParameters> Parameters { get; set; }
...
/// </summary>
public class ConnectedSourceDataJob_1_6_0DataWorkflowsParameters
{
    /// <summary>
