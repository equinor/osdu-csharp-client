...
public class BusinessAssociate_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractMaster120
{
    /// <summary>
    ...
    public List<AbstractContactUserProfile100> Contacts { get; set; }
    ...
    public AbstractContactUserProfile100? Person { get; set; }
...
public class BusinessAssociate_1_0_0DataAddresses
{
    ...
    public AbstractGeoPoliticalContext100? City { get; set; }

    [JsonPropertyName("ProvinceState")]
    public AbstractGeoPoliticalContext100? ProvinceState { get; set; }

    [JsonPropertyName("Country")]
    public AbstractGeoPoliticalContext100? Country { get; set; }
    ...
    public AbstractContactUserProfile100? PrimaryContact { get; set; }
