...
public class Wellbore_1_1_1
{
    ...
    public Wellbore_1_1_1Data? Data { get; set; }

}

public class Wellbore_1_1_1Data : AbstractCommonResources100 // Also composes: AbstractMaster110, AbstractFacility100
{
    ...
    public List<Wellbore_1_1_1DataVerticalMeasurements> VerticalMeasurements { get; set; }
    ...
    public List<Wellbore_1_1_1DataHistoricalInterests> HistoricalInterests { get; set; }
...
public class Wellbore_1_1_1DataVerticalMeasurements : AbstractFacilityVerticalMeasurement100
{
    /// <summary>
...
/// </summary>
public class Wellbore_1_1_1DataHistoricalInterests
{
    /// <summary>
