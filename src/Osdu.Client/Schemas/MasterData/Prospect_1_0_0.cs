...
/// <summary>
/// A named area or location, likely containing commercial deposits of a mineral, that is a candidate for extraction.  This normally means a candidate drilling location..
/// </summary>
public class Prospect_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:master-data\-\-Prospect:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public Prospect_1_0_0Data? Data { get; set; }

}

public class Prospect_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractMaster100
{
    /// <summary>
    ...
    /// </summary>
    [JsonPropertyName("ProspectName")]
    public string ProspectName { get; set; }

    /// <summary>
    /// DEPRECATED: please use data.NameAliases. Set of alternative names for a Prospect.
    /// </summary>
    [JsonPropertyName("ProspectNameAliases")]
    public List<AbstractAliasNames100> ProspectNameAliases { get; set; }

    /// <summary>
    /// Textual description about a Prospect.
    /// </summary>
    [JsonPropertyName("ProspectDescription")]
    ...
    [JsonPropertyName("ProspectTypeID")]
