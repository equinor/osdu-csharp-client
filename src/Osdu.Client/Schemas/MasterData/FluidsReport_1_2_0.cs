...
/// <summary>
/// Used to capture an analysis of the drilling mud, completion fluid or other fluids pumped during well construction. Printed snapshots, e.g. PDF files, are captured as work-product-component--Document, which relate via data.LineageAssertions.
/// </summary>
public class FluidsReport_1_2_0
{
    /// <summary>
...
public class FluidsReport_1_2_0Data : AbstractCommonResources100 // Also composes: AbstractMaster120
{
    /// <summary>
