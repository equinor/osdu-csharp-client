...
public class Risk_1_1_0
{
    ...
    public Risk_1_1_0Data? Data { get; set; }

}

public class Risk_1_1_0Data : AbstractCommonResources100 // Also composes: AbstractMaster120
{
    /// <summary>
    /// A textual description of the steps to prevent this risk
    /// </summary>
    [JsonPropertyName("Preventions")]
    public List<Risk_1_1_0DataPreventions> Preventions { get; set; }
    ...
    public List<Risk_1_1_0DataMitigations> Mitigations { get; set; }
...
/// </summary>
public class Risk_1_1_0DataPreventions
{
    /// <summary>
...
/// Describe a set of action to prevent for a risk or to mitigate its consequences
/// </summary>
public class Risk_1_1_0DataMitigations
{
    /// <summary>
    /// Name of the response
    /// </summary>
