...
public class WellBarrierElementTest_1_0_0
{
    ...
    public WellBarrierElementTest_1_0_0Data? Data { get; set; }

}

public class WellBarrierElementTest_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractMaster100, AbstractProject100
{
    /// <summary>
    ...
    public List<WellBarrierElementTest_1_0_0DataTestSteps> TestSteps { get; set; }
...
/// </summary>
public class WellBarrierElementTest_1_0_0DataTestSteps
{
    /// <summary>
    ...
    public List<WellBarrierElementTest_1_0_0DataTestStepsHighPressureCriteria> HighPressureCriteria { get; set; }

    /// <summary>
    /// Link to the object containing the low pressure criteria .
    /// </summary>
    [JsonPropertyName("LowPressureCriteria")]
    public List<WellBarrierElementTest_1_0_0DataTestStepsLowPressureCriteria> LowPressureCriteria { get; set; }
    ...
    public List<WellBarrierElementTest_1_0_0DataTestStepsComponentVolumesTestSystem> ComponentVolumesTestSystem { get; set; }

    /// <summary>
    /// A list of pressures and the expected volume pumped at the given pressure.
    /// </summary>
    [JsonPropertyName("ExpectedVolumesPumped")]
    public List<WellBarrierElementTest_1_0_0DataTestStepsExpectedVolumesPumped> ExpectedVolumesPumped { get; set; }

    /// <summary>
    /// A list of pressures and the expected volume bled back at the given pressure.
    /// </summary>
    [JsonPropertyName("ExpectedVolumesBledBack")]
    public List<WellBarrierElementTest_1_0_0DataTestStepsExpectedVolumesBledBack> ExpectedVolumesBledBack { get; set; }

    /// <summary>
    /// A list of test fluids and their properties.
    /// </summary>
    [JsonPropertyName("TestFluids")]
    public List<WellBarrierElementTest_1_0_0DataTestStepsTestFluids> TestFluids { get; set; }
...
/// </summary>
public class WellBarrierElementTest_1_0_0DataTestStepsHighPressureCriteria
{
    /// <summary>
...
/// Generic description of an individual pressure criterion for a single step of the test
/// </summary>
public class WellBarrierElementTest_1_0_0DataTestStepsLowPressureCriteria
{
    /// <summary>
    /// A successful positive pressure test requires the pressure to remain above the minimum allowable target test pressure.
    /// </summary>
...
/// </summary>
public class WellBarrierElementTest_1_0_0DataTestStepsComponentVolumesTestSystem
{
    /// <summary>
...
/// </summary>
public class WellBarrierElementTest_1_0_0DataTestStepsExpectedVolumesPumped
{
    /// <summary>
...
/// Individual description, for a given pressure, of the Volume Pumped expectations for a single step of the test.
/// </summary>
public class WellBarrierElementTest_1_0_0DataTestStepsExpectedVolumesBledBack
{
    /// <summary>
    /// Value for planned pressure
    /// </summary>
...
/// </summary>
public class WellBarrierElementTest_1_0_0DataTestStepsTestFluids
{
    /// <summary>
