...
public class ActivityPlan_1_2_0
{
    ...
    public ActivityPlan_1_2_0Data? Data { get; set; }

}

public class ActivityPlan_1_2_0Data : AbstractCommonResources100 // Also composes: AbstractMaster120, AbstractProject100
{
    /// <summary>
    ...
    public List<ActivityPlan_1_2_0DataWellPlanningActivities> WellPlanningActivities { get; set; }
...
/// </summary>
public class ActivityPlan_1_2_0DataWellPlanningActivities
{
    /// <summary>
    ...
    public ActivityPlan_1_2_0DataWellPlanningActivitiesDepthRange? DepthRange { get; set; }
    ...
    public List<ActivityPlan_1_2_0DataWellPlanningActivitiesProductiveTimeStatistics> ProductiveTimeStatistics { get; set; }

    /// <summary>
    /// Statistics that define the non productive time of this activity
    /// </summary>
    [JsonPropertyName("NonProductiveTimeStatistics")]
    public List<ActivityPlan_1_2_0DataWellPlanningActivitiesNonProductiveTimeStatistics> NonProductiveTimeStatistics { get; set; }

    /// <summary>
    /// Statistics that define the rate of penetration of this activity
    /// </summary>
    [JsonPropertyName("RateOfPenetrationStatistics")]
    public List<ActivityPlan_1_2_0DataWellPlanningActivitiesRateOfPenetrationStatistics> RateOfPenetrationStatistics { get; set; }
...
/// The depth range over which the the activity takes place
/// </summary>
public class ActivityPlan_1_2_0DataWellPlanningActivitiesDepthRange
{
    /// <summary>
...
/// </summary>
public class ActivityPlan_1_2_0DataWellPlanningActivitiesProductiveTimeStatistics
{
    /// <summary>
...
/// Structure that describes a individual statistic record of the operations from an activity.
/// </summary>
public class ActivityPlan_1_2_0DataWellPlanningActivitiesNonProductiveTimeStatistics
{
    /// <summary>
    /// Record of the statistic estimation
    /// </summary>
...
/// </summary>
public class ActivityPlan_1_2_0DataWellPlanningActivitiesRateOfPenetrationStatistics
{
    /// <summary>
    /// Record of the statistic estimation
    /// </summary>
