...
public class OperationsReport_1_1_0
{
    ...
    public OperationsReport_1_1_0Data? Data { get; set; }

}

public class OperationsReport_1_1_0Data : AbstractCommonResources100 // Also composes: AbstractMaster110
{
    /// <summary>
    ...
    public List<OperationsReport_1_1_0DataBitRecord> BitRecord { get; set; }
    ...
    public List<OperationsReport_1_1_0DataDrillActivity> DrillActivity { get; set; }
    ...
    public List<OperationsReport_1_1_0DataOperationsActivity> OperationsActivity { get; set; }
    ...
    public OperationsReport_1_1_0DataWellAlias? WellAlias { get; set; }

    /// <summary>
    /// Local name defined for the wellbore
    /// </summary>
    [JsonPropertyName("WellboreAlias")]
    public List<OperationsReport_1_1_0DataWellboreAlias> WellboreAlias { get; set; }

    /// <summary>
    /// Information regarding the status of the wellbore during this reporting period
    /// </summary>
    [JsonPropertyName("StatusInfo")]
    public List<OperationsReport_1_1_0DataStatusInfo> StatusInfo { get; set; }
    ...
    public List<OperationsReport_1_1_0DataTimedComments> TimedComments { get; set; }
    ...
    public List<OperationsReport_1_1_0DataWeather> Weather { get; set; }
    ...
    public List<OperationsReport_1_1_0DataGasReading> GasReading { get; set; }
...
/// </summary>
public class OperationsReport_1_1_0DataBitRecord
{
    /// <summary>
...
/// </summary>
public class OperationsReport_1_1_0DataDrillActivity
{
    /// <summary>
    ...
    public List<OperationsReport_1_1_0DataDrillActivityProprietaryActivityCode> ProprietaryActivityCode { get; set; }
...
/// </summary>
public class OperationsReport_1_1_0DataDrillActivityProprietaryActivityCode
{
    /// <summary>
    /// Identifier property
    /// </summary>
...
/// </summary>
public class OperationsReport_1_1_0DataOperationsActivity
{
    /// <summary>
    ...
    /// </summary>
    [JsonPropertyName("ProprietaryActivityCode")]
    public List<OperationsReport_1_1_0DataOperationsActivityProprietaryActivityCode> ProprietaryActivityCode { get; set; }
...
/// Definition of an alias
/// </summary>
public class OperationsReport_1_1_0DataOperationsActivityProprietaryActivityCode
{
    /// <summary>
    /// Identifier property
    /// </summary>
...
/// Local name defined for the Well
/// </summary>
public class OperationsReport_1_1_0DataWellAlias
{
    /// <summary>
    /// Identifier property
    /// </summary>
...
/// Definition of an alias
/// </summary>
public class OperationsReport_1_1_0DataWellboreAlias
{
    /// <summary>
    /// Identifier property
    /// </summary>
...
/// </summary>
public class OperationsReport_1_1_0DataStatusInfo
{
    /// <summary>
...
/// </summary>
public class OperationsReport_1_1_0DataTimedComments
{
    /// <summary>
...
/// Meteorological readings for the defined time period on an operations report
/// </summary>
public class OperationsReport_1_1_0DataWeather
{
    /// <summary>
...
/// Snapshot of operations personnel broken down by each company on the rig at the time of the report.
/// </summary>
public class OperationsReport_1_1_0DataPersonnel
{
    /// <summary>
...
/// Information related to pump operations on a drilling/operations report
/// </summary>
public class OperationsReport_1_1_0DataPumpOp
{
    /// <summary>
...
/// Information related to mud volumes for drilling/operations report
/// </summary>
public class OperationsReport_1_1_0DataMudVolume
{
    /// <summary>
...
/// Quantity of items inventoried during drilling and/or operations
/// </summary>
public class OperationsReport_1_1_0DataInventory
{
    /// <summary>
...
/// Cost information captured for a defined time period during operations and/or drilling
/// </summary>
public class OperationsReport_1_1_0DataCost
{
    /// <summary>
    /// Comments and remarks
    /// </summary>
...
/// Health Safety or Environment events that occurred since the last drilling/operation report. Captures data related to HSE events (e.g., tests, inspections, meetings, and drills), test values (e.g., pressure tested to), and/or incidents (e.g., discharges, non-compliance notices received, etc.).
/// </summary>
public class OperationsReport_1_1_0DataHSE
{
    /// <summary>
    /// Comments and remarks
    /// </summary>
...
/// Description of incidents that have occurred during the last drilling/operations report
/// </summary>
public class OperationsReport_1_1_0DataIncident
{
    /// <summary>
    /// Comments and remarks
    /// </summary>
...
/// Mud that has been lost during drilling / operations
/// </summary>
public class OperationsReport_1_1_0DataMudLosses
{
    /// <summary>
    /// Comments and remarks
    /// </summary>
...
/// General information about a gas reading taken during the drill report period
/// </summary>
public class OperationsReport_1_1_0DataGasReading
{
    /// <summary>
