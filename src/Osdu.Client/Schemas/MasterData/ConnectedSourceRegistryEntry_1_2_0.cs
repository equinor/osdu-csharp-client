...
public class ConnectedSourceRegistryEntry_1_2_0
{
    ...
    public ConnectedSourceRegistryEntry_1_2_0Data? Data { get; set; }

}

public class ConnectedSourceRegistryEntry_1_2_0Data : AbstractCommonResources100 // Also composes: AbstractMaster110, AbstractProjectActivity110
{
    /// <summary>
    ...
    public List<ConnectedSourceRegistryEntry_1_2_0DataSecuritySchemes> SecuritySchemes { get; set; }

    /// <summary>
    /// List of SMTP server schemes available for use in mailing the detailed EDS's report.
    /// </summary>
    [JsonPropertyName("SmtpSchemes")]
    public List<ConnectedSourceRegistryEntry_1_2_0DataSmtpSchemes> SmtpSchemes { get; set; }
...
/// </summary>
public class ConnectedSourceRegistryEntry_1_2_0DataSecuritySchemes
{
    /// <summary>
...
/// </summary>
public class ConnectedSourceRegistryEntry_1_2_0DataSmtpSchemes
{
    /// <summary>
