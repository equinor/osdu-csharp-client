...
/// </summary>
public class SeismicAcquisitionSurvey_1_4_0
{
    /// <summary>
    ...
    public SeismicAcquisitionSurvey_1_4_0_Data? Data { get; set; }

}

public class SeismicAcquisitionSurvey_1_4_0_Data : AbstractCommonResources_1_0_0 // Also composes: AbstractMaster_1_2_0, AbstractProject_1_0_0, AbstractProjectActivity_1_2_0
{
    /// <summary>
    ...
    public List<SeismicAcquisitionSurvey_1_4_0_Data_FundsAuthorizations> FundsAuthorizations { get; set; }
    ...
    public List<SeismicAcquisitionSurvey_1_4_0_Data_Contractors> Contractors { get; set; }
    ...
    public List<SeismicAcquisitionSurvey_1_4_0_Data_Personnel> Personnel { get; set; }
    ...
    public List<SeismicAcquisitionSurvey_1_4_0_Data_ProjectSpecifications> ProjectSpecifications { get; set; }

    /// <summary>
    /// The history of life cycle states that the Project has been through..
    /// </summary>
    [JsonPropertyName("ProjectStates")]
    public List<SeismicAcquisitionSurvey_1_4_0_Data_ProjectStates> ProjectStates { get; set; }
    ...
    public List<SeismicAcquisitionSurvey_1_4_0_Data_SourceConfigurations> SourceConfigurations { get; set; }

    /// <summary>
    /// The seismic receiver configurations used for this acquisition project.
    /// </summary>
    [JsonPropertyName("ReceiverConfigurations")]
    public List<SeismicAcquisitionSurvey_1_4_0_Data_ReceiverConfigurations> ReceiverConfigurations { get; set; }

    [JsonPropertyName("VerticalMeasurement")]
    public AbstractFacilityVerticalMeasurement_1_0_0? VerticalMeasurement { get; set; }

    /// <summary>
    /// If populated, this survey is part of a time-lapse survey sequence. It identifies the preceding SeismicAcquisitionSurvey. The first survey in the sequence has an empty or absent PrecedingTimeLapseSurveyID.
    /// </summary>
...
/// The history of expenditure approvals.
/// </summary>
public class SeismicAcquisitionSurvey_1_4_0_Data_FundsAuthorizations
{
    /// <summary>
...
/// References to organisations which supplied services to the Project.
/// </summary>
public class SeismicAcquisitionSurvey_1_4_0_Data_Contractors
{
    /// <summary>
...
/// List of key individuals supporting the Project.  This could be Abstracted for re-use, and could reference a separate Persons master data object.
/// </summary>
public class SeismicAcquisitionSurvey_1_4_0_Data_Personnel
{
    /// <summary>
...
/// General parameters defining the configuration of the Project.  In the case of a seismic acquisition project it is like receiver interval, source depth, source type.  In the case of a processing project, it is like replacement velocity, reference datum above mean sea level.
/// </summary>
public class SeismicAcquisitionSurvey_1_4_0_Data_ProjectSpecifications
{
    /// <summary>
...
/// The history of life cycle states that the Project has been through..
/// </summary>
public class SeismicAcquisitionSurvey_1_4_0_Data_ProjectStates
{
    /// <summary>
...
/// </summary>
public class SeismicAcquisitionSurvey_1_4_0_Data_SourceConfigurations
{
    /// <summary>
...
/// </summary>
public class SeismicAcquisitionSurvey_1_4_0_Data_ReceiverConfigurations
{
    /// <summary>
