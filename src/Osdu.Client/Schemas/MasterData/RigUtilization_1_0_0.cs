...
public class RigUtilization_1_0_0
{
    ...
    public RigUtilization_1_0_0Data? Data { get; set; }

}

public class RigUtilization_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractMaster100, AbstractProject100
{
    /// <summary>
    ...
    public List<RigUtilization_1_0_0DataMudPumps> MudPumps { get; set; }
...
/// </summary>
public class RigUtilization_1_0_0DataMudPumps
{
    /// <summary>
