...
/// <summary>
/// This object captures attributes of a sample/ specimen (rocks, fluids, or other materials) acquired either through an original acquisition event, sub-sampling event, generated from recombination of other samples /specimens or derived through the application of some laboratory process on the parent sample.
/// </summary>
public class Sample_3_0_0
{
    /// <summary>
    ...
    public Sample_3_0_0Data? Data { get; set; }

}

public class Sample_3_0_0Data : AbstractCommonResources100 // Also composes: AbstractMaster120
{
    /// <summary>
    ...
    public Sample_3_0_0DataSampleAcquisition? SampleAcquisition { get; set; }
    ...
    public Sample_3_0_0DataRecombinationSpecification? RecombinationSpecification { get; set; }
    ...
    public List<Sample_3_0_0DataSamplePreparation> SamplePreparation { get; set; }
...
/// This captures the acquisition parameters obtained during  the sample acquisition event associated with this sample. Note that this attribute should only be used when associating the sample with an acquisition event from its original source and not for sub-sampling or derivative sources.
/// </summary>
public class Sample_3_0_0DataSampleAcquisition
{
    /// <summary>
    ...
    public Sample_3_0_0DataSampleAcquisitionSampleAcquisitionDetail? SampleAcquisitionDetail { get; set; }
...
/// This attribute provides information about the acquisition parameters and process used in acquiring the target sample. Other information about the sample itself can be found in the Sample object.
/// </summary>
public class Sample_3_0_0DataSampleAcquisitionSampleAcquisitionDetail
{
    ...
    public Sample_3_0_0DataSampleAcquisitionSampleAcquisitionDetailSamplingPoint? SamplingPoint { get; set; }
...
/// SamplingPoint= [ PRODML:2.1:FluidSampleAcquisitionJob.FluidSampleAcquisition&lt;SeparatorSampleAcquisition | FacilitySampleAcquisition | SeparatorSampleAcquisition&gt;[].Item.SamplingPoint
/// </summary>
public class Sample_3_0_0DataSampleAcquisitionSampleAcquisitionDetailSamplingPoint
{
    /// <summary>
...
/// For a sample that has been recombined from separate samples, e.g. liquid sample and vapor sample, this object records the specified: recombination conditions (pressure and temperature), recombination ratio, the saturation pressure and  target recombined sample composition, whichever of these are appropriate for this recombination effort.
/// </summary>
public class Sample_3_0_0DataRecombinationSpecification
{
    [Required]
    ...
    public Sample_3_0_0DataRecombinationSpecificationRecombinationGasOilRatio? RecombinationGasOilRatio { get; set; }
    ...
    public List<Sample_3_0_0DataRecombinationSpecificationTargetSampleComposition> TargetSampleComposition { get; set; }
    ...
    public List<Sample_3_0_0DataRecombinationSpecificationRecombinedSampleFraction> RecombinedSampleFraction { get; set; }
...
/// The gas-oil ratio recorded for this sample recombination process as well as the volumetric reference conditions for both the oil and gas phases. This is typically required for fluid sample types.
/// </summary>
public class Sample_3_0_0DataRecombinationSpecificationRecombinationGasOilRatio
{
    /// <summary>
...
/// </summary>
public class Sample_3_0_0DataRecombinationSpecificationTargetSampleComposition
{
    /// <summary>
...
/// This object holds information about a sample or component of a sample and its contribution to a target sample created through the recombination process.
/// </summary>
public class Sample_3_0_0DataRecombinationSpecificationRecombinedSampleFraction
{
    /// <summary>
    /// This is the OSDU Record ID of an item in the list of  sample components. This attribute references the components that make up a sample.
    /// </summary>
...
/// This captures information about the preparation process executed after the sample acquisition event.
/// </summary>
public class Sample_3_0_0DataSamplePreparation
{
    /// <summary>
