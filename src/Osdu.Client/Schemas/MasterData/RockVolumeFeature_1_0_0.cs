...
/// <summary>
/// A volume of rock that is identified based on some specific attribute, like its mineral content or other physical characteristic. It exists typically in the scope of a model.
/// </summary>
public class RockVolumeFeature_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:master-data\-\-RockVolumeFeature:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public RockVolumeFeature_1_0_0Data? Data { get; set; }

}

public class RockVolumeFeature_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractMaster100
{
    /// <summary>
