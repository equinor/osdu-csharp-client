...
/// </summary>
public class TubularComponent_2_5_0
{
    /// <summary>
    ...
    public TubularComponent_2_5_0Data? Data { get; set; }

}

public class TubularComponent_2_5_0Data : AbstractCommonResources101 // Also composes: AbstractMaster120
{
    /// <summary>
    ...
    public List<TubularComponent_2_5_0DataNozzles> Nozzles { get; set; }

    /// <summary>
    /// Description of the type of Sensor(s) for the Tubular Components e.g. for MWD/LWD tools
    /// </summary>
    [JsonPropertyName("Sensors")]
    public List<TubularComponent_2_5_0DataSensors> Sensors { get; set; }

    /// <summary>
    /// Top and/or Bottom Connection information
    /// </summary>
    [JsonPropertyName("Connections")]
    public List<AbstractTubularComponentConnection100> Connections { get; set; }
    ...
    public AbstractTubularComponentBend100? Bend { get; set; }

    [JsonPropertyName("BitRecord")]
    public AbstractTubularComponentBitRecord110? BitRecord { get; set; }

    [JsonPropertyName("HoleOpener")]
    public AbstractTubularComponentHoleOpener100? HoleOpener { get; set; }

    [JsonPropertyName("Jar")]
    public AbstractTubularComponentJar100? Jar { get; set; }

    [JsonPropertyName("Motor")]
    public AbstractTubularComponentMotor100? Motor { get; set; }

    [JsonPropertyName("MWDTool")]
    public AbstractTubularComponentJar100? MWDTool { get; set; }

    [JsonPropertyName("PressureLoss")]
    public AbstractTubularComponentPressureLoss100? PressureLoss { get; set; }

    [JsonPropertyName("RotarySteerableSystem")]
    public AbstractTubularComponentRSS100? RotarySteerableSystem { get; set; }

    [JsonPropertyName("Stabiliser")]
    public AbstractTubularComponentStabiliser100? Stabiliser { get; set; }

    /// <summary>
    /// Identifier to a Product Component Catalogue reference list item.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-CasingComponentCatalog:[\w\-\.\:\%]+:[0-9]*$")]
    [JsonPropertyName("ComponentCatalogueID")]
    public string ComponentCatalogueID { get; set; }
...
/// </summary>
public class TubularComponent_2_5_0DataNozzles
{
    /// <summary>
...
/// </summary>
public class TubularComponent_2_5_0DataSensors
{
    /// <summary>
