...
/// </summary>
public class PlannedCementJob_1_2_0
{
    /// <summary>
    ...
    public PlannedCementJob_1_2_0Data? Data { get; set; }

}

public class PlannedCementJob_1_2_0Data : AbstractCommonResources100 // Also composes: AbstractMaster120
{
    /// <summary>
    ...
    public List<PlannedCementJob_1_2_0DataCementStages> CementStages { get; set; }
...
/// A single cement job.
/// </summary>
public class PlannedCementJob_1_2_0DataCementStages
{
    /// <summary>
    /// Stage number.
    /// </summary>
    ...
    public PlannedCementJob_1_2_0DataCementStagesCementingFluid? CementingFluid { get; set; }
...
/// Displaced Mud, washes and spacers, cements, displacement mud.
/// </summary>
public class PlannedCementJob_1_2_0DataCementStagesCementingFluid
{
    /// <summary>
    ...
    public PlannedCementJob_1_2_0DataCementStagesCementingFluidCementPumpSchedule? CementPumpSchedule { get; set; }
    ...
    public List<PlannedCementJob_1_2_0DataCementStagesCementingFluidCementAdditives> CementAdditives { get; set; }
...
/// Set of (Time / Rate / Back Pressure).
/// </summary>
public class PlannedCementJob_1_2_0DataCementStagesCementingFluidCementPumpSchedule
{
    /// <summary>
...
/// </summary>
public class PlannedCementJob_1_2_0DataCementStagesCementingFluidCementAdditives
{
    /// <summary>
    /// Additive name.
    /// </summary>
