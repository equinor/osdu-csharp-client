...
/// <summary>
/// A collection of data references used in context of a CollaborationProject, often describing the content of a "system of engagement".
/// </summary>
public class CollaborationProjectCollection_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:work-product-component\-\-CollaborationProjectCollection:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public CollaborationProjectCollection_1_0_0_Data? Data { get; set; }

}

public class CollaborationProjectCollection_1_0_0_Data : AbstractCommonResources_1_0_0 // Also composes: AbstractWPCGroupType_1_2_0, AbstractWorkProductComponent_1_1_0
{
    /// <summary>
    ...
    public List<CollaborationProjectCollection_1_0_0_Data_Artefacts> Artefacts { get; set; }
    ...
    public List<CollaborationProjectCollection_1_0_0_Data_LineageAssertions> LineageAssertions { get; set; }
...
/// An array of Artefacts - each artefact has a Role, Resource tuple. An artefact is distinct from the file, in the sense certain valuable information is generated during loading process (Artefact generation process). Examples include retrieving location data, performing an OCR which may result in the generation of artefacts which need to be preserved distinctly
/// </summary>
public class CollaborationProjectCollection_1_0_0_Data_Artefacts
{
    /// <summary>
...
/// Defines relationships with other objects (any kind of Resource) upon which this work product component depends.  The assertion is directed only from the asserting WPC to ancestor objects, not children.  It should not be used to refer to files or artefacts within the WPC -- the association within the WPC is sufficient and Artefacts are actually children of the main WPC file. They should be recorded in the data.Artefacts[] array.
/// </summary>
public class CollaborationProjectCollection_1_0_0_Data_LineageAssertions
{
    /// <summary>
