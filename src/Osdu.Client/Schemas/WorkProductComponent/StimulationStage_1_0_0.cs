...
public class StimulationStage_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractWPCGroupType120, AbstractWorkProductComponent110
{
    /// <summary>
    ...
    public List<AbstractStimMaterialQuantity100> MaterialUsageRateMax { get; set; }

    /// <summary>
    /// Material used during this job stage. For example, proppant or gel (additive).
    /// </summary>
    [JsonPropertyName("MaterialUsage")]
    public List<AbstractStimMaterialQuantity100> MaterialUsage { get; set; }
...
public class StimulationStage_1_0_0DataJobStepFluid
{
    ...
    public List<AbstractStimMaterialQuantity100> AdditiveConcentration { get; set; }
