...
public class WellboreMarkerSet_1_2_0
{
    ...
    public WellboreMarkerSet_1_2_0Data? Data { get; set; }

}

public class WellboreMarkerSet_1_2_0Data : AbstractCommonResources100 // Also composes: AbstractWPCGroupType100, AbstractWorkProductComponent100
{
    /// <summary>
    ...
    public List<WellboreMarkerSet_1_2_0DataAvailableMarkerProperties> AvailableMarkerProperties { get; set; }
    ...
    public List<WellboreMarkerSet_1_2_0DataMarkers> Markers { get; set; }
...
/// </summary>
public class WellboreMarkerSet_1_2_0DataAvailableMarkerProperties
{
    /// <summary>
...
/// </summary>
public class WellboreMarkerSet_1_2_0DataMarkers
{
    /// <summary>
    /// Name of the Marker
    /// </summary>
