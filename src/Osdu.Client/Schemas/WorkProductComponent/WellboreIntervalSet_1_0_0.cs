...
public class WellboreIntervalSet_1_0_0
{
    ...
    public WellboreIntervalSet_1_0_0Data? Data { get; set; }

}

public class WellboreIntervalSet_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractWPCGroupType100, AbstractWorkProductComponent100
{
    /// <summary>
    ...
    public List<WellboreIntervalSet_1_0_0DataIntervals> Intervals { get; set; }

    [JsonPropertyName("IntervalProperties")]
    public AbstractColumnBasedTable100? IntervalProperties { get; set; }
...
/// </summary>
public class WellboreIntervalSet_1_0_0DataIntervals
{
    /// <summary>
