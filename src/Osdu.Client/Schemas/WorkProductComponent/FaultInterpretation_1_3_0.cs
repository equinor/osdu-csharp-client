...
/// </summary>
public class FaultInterpretation_1_3_0
{
    /// <summary>
...
public class FaultInterpretation_1_3_0_Data : AbstractCommonResources_1_0_0 // Also composes: AbstractWPCGroupType_1_2_0, AbstractWorkProductComponent_1_1_0, AbstractInterpretation_1_1_0
{
    ...
    /// </summary>
    [JsonPropertyName("FaultLength")]
    public double? FaultLength { get; set; }

    /// <summary>
    /// The maximum horizontal displacement measured along the strike of the slip surface of the fault plane
    /// </summary>
    [JsonPropertyName("MaximumFaultStrikeSlip")]
    public double? MaximumFaultStrikeSlip { get; set; }
