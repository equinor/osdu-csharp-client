...
/// </summary>
public class TubularAssembly_1_2_0
{
    /// <summary>
    ...
    public TubularAssembly_1_2_0Data? Data { get; set; }

}

public class TubularAssembly_1_2_0Data : AbstractCommonResources100 // Also composes: AbstractWPCGroupType110, AbstractWorkProductComponent110
{
    /// <summary>
    ...
    public TubularAssembly_1_2_0DataTubularAssemblyStatus? TubularAssemblyStatus { get; set; }
    ...
    public List<TubularAssembly_1_2_0DataTubularAssemblyStates> TubularAssemblyStates { get; set; }
...
/// Reflects the current status of the Assembly - as 'installed', 'pulled', 'planned',... - Applicable to tubing/completions as opposed to drillstrings. Historical states are recorded in TubularAssemblyStates.
/// </summary>
public class TubularAssembly_1_2_0DataTubularAssemblyStatus
{
    /// <summary>
...
/// </summary>
public class TubularAssembly_1_2_0DataTubularAssemblyStates
{
    /// <summary>
    /// SRN of a reference value status type
    /// </summary>
