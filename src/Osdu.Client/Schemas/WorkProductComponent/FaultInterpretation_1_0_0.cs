...
public class FaultInterpretation_1_0_0
{
    ...
    public FaultInterpretation_1_0_0Data? Data { get; set; }

}

public class FaultInterpretation_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractWPCGroupType100, AbstractWorkProductComponent100, AbstractInterpretation100
{
    /// <summary>
    ...
    public List<FaultInterpretation_1_0_0DataFaultThrowDescriptions> FaultThrowDescriptions { get; set; }
    ...
    public FaultInterpretation_1_0_0DataRepresentativeDipDirection? RepresentativeDipDirection { get; set; }
...
/// </summary>
public class FaultInterpretation_1_0_0DataFaultThrowDescriptions
{
    /// <summary>
...
/// Indicates the representative azimuth value of the fault plane
/// </summary>
public class FaultInterpretation_1_0_0DataRepresentativeDipDirection
{
    /// <summary>
    /// The azimuth value
    /// </summary>
