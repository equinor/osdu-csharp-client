...
public class WellLog_1_4_0
{
    ...
    public WellLog_1_4_0Data? Data { get; set; }

}

public class WellLog_1_4_0Data : AbstractCommonResources100 // Also composes: AbstractWPCGroupType120, AbstractWorkProductComponent110
{
    /// <summary>
    ...
    public WellLog_1_4_0DataLogServiceDateInterval? LogServiceDateInterval { get; set; }
    ...
    public List<WellLog_1_4_0DataCurves> Curves { get; set; }
...
/// An interval built from two nested values : StartDate and EndDate. It applies to the whole log services and may apply to composite logs as [start of the first run job] and [end of the last run job]Log Service Date
/// </summary>
public class WellLog_1_4_0DataLogServiceDateInterval
{
...
public class WellLog_1_4_0DataCurves
{
    /// <summary>
