...
/// </summary>
public class GridConnectionSetRepresentation_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:work-product-component\-\-GridConnectionSetRepresentation:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public GridConnectionSetRepresentation_1_0_0_Data? Data { get; set; }

}

public class GridConnectionSetRepresentation_1_0_0_Data : AbstractCommonResources_1_0_0 // Also composes: AbstractWPCGroupType_1_0_0, AbstractWorkProductComponent_1_0_0, AbstractRepresentation_1_0_0
{
    /// <summary>
    ...
    public List<GridConnectionSetRepresentation_1_0_0_Data_Artefacts> Artefacts { get; set; }
    ...
    public List<GridConnectionSetRepresentation_1_0_0_Data_LineageAssertions> LineageAssertions { get; set; }
    ...
    public GridConnectionSetRepresentation_1_0_0_Data_TimeSeries? TimeSeries { get; set; }
    ...
    public List<GridConnectionSetRepresentation_1_0_0_Data_IndexableElementCount> IndexableElementCount { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("GridRepresentationIDs")]
    public List<string> GridRepresentationIDs { get; set; }

    /// <summary>
    /// References to the interpretations which some (or all) of the connections represent.
    /// </summary>
    [JsonPropertyName("InterpretationIDs")]
    public List<string> InterpretationIDs { get; set; }
...
/// An array of Artefacts - each artefact has a Role, Resource tuple. An artefact is distinct from the file, in the sense certain valuable information is generated during loading process (Artefact generation process). Examples include retrieving location data, performing an OCR which may result in the generation of artefacts which need to be preserved distinctly
/// </summary>
public class GridConnectionSetRepresentation_1_0_0_Data_Artefacts
{
    /// <summary>
...
/// Defines relationships with other objects (any kind of Resource) upon which this work product component depends.  The assertion is directed only from the asserting WPC to ancestor objects, not children.  It should not be used to refer to files or artefacts within the WPC -- the association within the WPC is sufficient and Artefacts are actually children of the main WPC file. They should be recorded in the data.Artefacts[] array.
/// </summary>
public class GridConnectionSetRepresentation_1_0_0_Data_LineageAssertions
{
    /// <summary>
...
/// Allow to link the geometry of the representation to a particular index of a time series. This is particularly useful for IJK grids used in geomechanical or basin context where the topology and geometry varies against the time.
/// </summary>
public class GridConnectionSetRepresentation_1_0_0_Data_TimeSeries
{
    /// <summary>
...
/// </summary>
public class GridConnectionSetRepresentation_1_0_0_Data_IndexableElementCount
{
    /// <summary>
