...
public class WellboreMarkerSet_1_3_0
{
    ...
    public WellboreMarkerSet_1_3_0Data? Data { get; set; }

}

public class WellboreMarkerSet_1_3_0Data : AbstractCommonResources100 // Also composes: AbstractWPCGroupType110, AbstractWorkProductComponent110
{
    /// <summary>
    ...
    public List<WellboreMarkerSet_1_3_0DataAvailableMarkerProperties> AvailableMarkerProperties { get; set; }
    ...
    public List<WellboreMarkerSet_1_3_0DataMarkers> Markers { get; set; }
...
/// </summary>
public class WellboreMarkerSet_1_3_0DataAvailableMarkerProperties
{
    /// <summary>
...
/// </summary>
public class WellboreMarkerSet_1_3_0DataMarkers
{
    /// <summary>
    /// Name of the Marker
    /// </summary>
