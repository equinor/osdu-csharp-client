...
/// <summary>
/// A volume of rock that is identified based on some specific attribute, like its mineral content or other physical characteristic. It exists typically in the scope of a model, can be associated with a master-data--RockVolumeFeature for regional correlations.
/// </summary>
public class LocalRockVolumeFeature_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:work-product-component\-\-LocalRockVolumeFeature:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public LocalRockVolumeFeature_1_0_0_Data? Data { get; set; }

}

public class LocalRockVolumeFeature_1_0_0_Data : AbstractCommonResources_1_0_0 // Also composes: AbstractWPCGroupType_1_0_0, AbstractWorkProductComponent_1_0_0
{
    /// <summary>
    ...
    public List<LocalRockVolumeFeature_1_0_0_Data_Artefacts> Artefacts { get; set; }
    ...
    public List<LocalRockVolumeFeature_1_0_0_Data_LineageAssertions> LineageAssertions { get; set; }

    /// <summary>
    /// When populated, the rock volume feature has a wider scope and allows rock volume feature correlations across models.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:master-data\-\-RockVolumeFeature:[\w\-\.\:\%]+:[0-9]*$")]
    [JsonPropertyName("RockVolumeFeatureID")]
    public string RockVolumeFeatureID { get; set; }
...
/// An array of Artefacts - each artefact has a Role, Resource tuple. An artefact is distinct from the file, in the sense certain valuable information is generated during loading process (Artefact generation process). Examples include retrieving location data, performing an OCR which may result in the generation of artefacts which need to be preserved distinctly
/// </summary>
public class LocalRockVolumeFeature_1_0_0_Data_Artefacts
{
    /// <summary>
...
/// Defines relationships with other objects (any kind of Resource) upon which this work product component depends.  The assertion is directed only from the asserting WPC to ancestor objects, not children.  It should not be used to refer to files or artefacts within the WPC -- the association within the WPC is sufficient and Artefacts are actually children of the main WPC file. They should be recorded in the data.Artefacts[] array.
/// </summary>
public class LocalRockVolumeFeature_1_0_0_Data_LineageAssertions
{
    /// <summary>
