...
/// </summary>
public class UnsealedSurfaceFramework_1_3_1
{
    /// <summary>
    ...
    public UnsealedSurfaceFramework_1_3_1_Data? Data { get; set; }

}

public class UnsealedSurfaceFramework_1_3_1_Data : AbstractCommonResources_1_0_0 // Also composes: AbstractWPCGroupType_1_2_0, AbstractWorkProductComponent_1_1_0, AbstractRepresentation_1_0_0
{
    /// <summary>
    ...
    public List<UnsealedSurfaceFramework_1_3_1_Data_Artefacts> Artefacts { get; set; }
    ...
    public List<UnsealedSurfaceFramework_1_3_1_Data_LineageAssertions> LineageAssertions { get; set; }
    ...
    public UnsealedSurfaceFramework_1_3_1_Data_TimeSeries? TimeSeries { get; set; }
    ...
    public List<UnsealedSurfaceFramework_1_3_1_Data_IndexableElementCount> IndexableElementCount { get; set; }
    ...
    /// <summary>
    /// List of individual SeismicFault representations contributing to this structural model. Alternatively FaultSystem can be used as single coherent set of fault representation. Only one property is expected to be populated, either SeismicFaultIDs or FaultSystem.
    /// </summary>
    [JsonPropertyName("SeismicFaultIDs")]
    public List<string> SeismicFaultIDs { get; set; }

    /// <summary>
    /// DEPRECATED: use the SeismicFaultIDs or GenericRepresentationIDs instead. The FaultSystem WPC has been deprecated. ~~An alternative, coherent set of fault representations under one work-product-component. Only one property is expected to be populated, either FaultSystem or SeismicFaultIDs.~~
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:work-product-component\-\-FaultSystem:[\w\-\.\:\%]+:[0-9]*$")]
    [JsonPropertyName("FaultSystemID")]
    public string FaultSystemID { get; set; }
...
/// An array of Artefacts - each artefact has a Role, Resource tuple. An artefact is distinct from the file, in the sense certain valuable information is generated during loading process (Artefact generation process). Examples include retrieving location data, performing an OCR which may result in the generation of artefacts which need to be preserved distinctly
/// </summary>
public class UnsealedSurfaceFramework_1_3_1_Data_Artefacts
{
    /// <summary>
...
/// Defines relationships with other objects (any kind of Resource) upon which this work product component depends.  The assertion is directed only from the asserting WPC to ancestor objects, not children.  It should not be used to refer to files or artefacts within the WPC -- the association within the WPC is sufficient and Artefacts are actually children of the main WPC file. They should be recorded in the data.Artefacts[] array.
/// </summary>
public class UnsealedSurfaceFramework_1_3_1_Data_LineageAssertions
{
    /// <summary>
...
/// Allow to link the geometry of the representation to a particular index of a time series. This is particularly useful for IJK grids used in geomechanical or basin context where the topology and geometry varies against the time.
/// </summary>
public class UnsealedSurfaceFramework_1_3_1_Data_TimeSeries
{
    /// <summary>
...
/// </summary>
public class UnsealedSurfaceFramework_1_3_1_Data_IndexableElementCount
{
    /// <summary>
