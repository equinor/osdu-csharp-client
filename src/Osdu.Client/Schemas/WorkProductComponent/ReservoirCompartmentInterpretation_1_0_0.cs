...
/// </summary>
public class ReservoirCompartmentInterpretation_1_0_0
{
    /// <summary>
    ...
    public ReservoirCompartmentInterpretation_1_0_0_Data? Data { get; set; }

}

public class ReservoirCompartmentInterpretation_1_0_0_Data : AbstractCommonResources_1_0_0 // Also composes: AbstractWPCGroupType_1_0_0, AbstractWorkProductComponent_1_0_0, AbstractInterpretation_1_0_0
{
    /// <summary>
    ...
    public List<ReservoirCompartmentInterpretation_1_0_0_Data_Artefacts> Artefacts { get; set; }
    ...
    public List<ReservoirCompartmentInterpretation_1_0_0_Data_LineageAssertions> LineageAssertions { get; set; }
    ...
    public List<ReservoirCompartmentInterpretation_1_0_0_Data_ReservoirCompartmentUnits> ReservoirCompartmentUnits { get; set; }
...
/// An array of Artefacts - each artefact has a Role, Resource tuple. An artefact is distinct from the file, in the sense certain valuable information is generated during loading process (Artefact generation process). Examples include retrieving location data, performing an OCR which may result in the generation of artefacts which need to be preserved distinctly
/// </summary>
public class ReservoirCompartmentInterpretation_1_0_0_Data_Artefacts
{
    /// <summary>
...
/// Defines relationships with other objects (any kind of Resource) upon which this work product component depends.  The assertion is directed only from the asserting WPC to ancestor objects, not children.  It should not be used to refer to files or artefacts within the WPC -- the association within the WPC is sufficient and Artefacts are actually children of the main WPC file. They should be recorded in the data.Artefacts[] array.
/// </summary>
public class ReservoirCompartmentInterpretation_1_0_0_Data_LineageAssertions
{
    /// <summary>
...
/// </summary>
public class ReservoirCompartmentInterpretation_1_0_0_Data_ReservoirCompartmentUnits
{
    /// <summary>
