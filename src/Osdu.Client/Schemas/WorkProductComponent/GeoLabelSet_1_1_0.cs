...
/// <summary>
/// The GeoLabelSet acts as an object for collecting consolidated geological properties or information related to a labelled master entity, which could be a Reservoir, Reservoir Segment, Field, Prospect, etc. Individual labels are name-value pairs categorised by a GeoLabelType which allows for specifying characteristics such as: the average porosity of a Reservoir as 20%, the average initial reservoir pressure for Reservoir Segment as at 8000 psi, or identifying the predominant depositional environment of a Field as “marine shallow”. The content may have been identified through various methods, including measurement, interpretation, estimation, data collection from reports, delivered data packages, data mining etc.
/// </summary>
public class GeoLabelSet_1_1_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:work-product-component\-\-GeoLabelSet:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public GeoLabelSet_1_1_0_Data? Data { get; set; }

}

public class GeoLabelSet_1_1_0_Data : AbstractCommonResources_1_0_0 // Also composes: AbstractWPCGroupType_1_2_0, AbstractWorkProductComponent_1_1_0
{
    /// <summary>
    ...
    public List<GeoLabelSet_1_1_0_Data_Artefacts> Artefacts { get; set; }
    ...
    public List<GeoLabelSet_1_1_0_Data_LineageAssertions> LineageAssertions { get; set; }

    /// <summary>
    /// The entity, e.g., Basin, Prospect, Field, Well, Wellbore, Reservoir, ReservoirSegment, which is labelled by the LabelSet.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:(master-data\-\-Basin|master-data\-\-Field|master-data\-\-Prospect|master-data\-\-Reservoir|master-data\-\-ReservoirSegment|master-data\-\-Well|master-data\-\-Wellbore):[\w\-\.\:\%]+:[0-9]*$")]
    [JsonPropertyName("LabelledEntityID")]
    public string LabelledEntityID { get; set; }

    /// <summary>
    /// The array of GeoLabelTypeIDs associated with a specific type dependent value. It is expected that each GeoLabelTypeID value is unique in the LabelAndValues list, such that it is possible to convert the array into a dictionary where the GeoLabelTypeID is the key.
    /// </summary>
    [JsonPropertyName("LabelAndValues")]
    public List<AbstractLabelAndValue_1_0_0> LabelAndValues { get; set; }

    /// <summary>
    /// If populated, the GeoLabelSet data.LabelAndValues[] only describe the state after the StartDate. Often also the EndDate is populated defining an interval of validity for data.LabelAndValues[].
    /// </summary>
    [JsonPropertyName("StartDate")]
    public DateOnly StartDate { get; set; }

    /// <summary>
    /// If populated, the GeoLabelSet data.LabelAndValues[] only describe the state before the EndDate. Often also the StartDate is populated defining an interval of validity for data.LabelAndValues[].
    /// </summary>
...
/// An array of Artefacts - each artefact has a Role, Resource tuple. An artefact is distinct from the file, in the sense certain valuable information is generated during loading process (Artefact generation process). Examples include retrieving location data, performing an OCR which may result in the generation of artefacts which need to be preserved distinctly
/// </summary>
public class GeoLabelSet_1_1_0_Data_Artefacts
{
    /// <summary>
...
/// Defines relationships with other objects (any kind of Resource) upon which this work product component depends.  The assertion is directed only from the asserting WPC to ancestor objects, not children.  It should not be used to refer to files or artefacts within the WPC -- the association within the WPC is sufficient and Artefacts are actually children of the main WPC file. They should be recorded in the data.Artefacts[] array.
/// </summary>
public class GeoLabelSet_1_1_0_Data_LineageAssertions
{
    /// <summary>
