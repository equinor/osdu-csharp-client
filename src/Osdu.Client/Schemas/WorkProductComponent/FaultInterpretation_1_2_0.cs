...
public class FaultInterpretation_1_2_0
{
    ...
    public FaultInterpretation_1_2_0Data? Data { get; set; }

}

public class FaultInterpretation_1_2_0Data : AbstractCommonResources100 // Also composes: AbstractWPCGroupType120, AbstractWorkProductComponent110, AbstractInterpretation110
{
    /// <summary>
    ...
    public List<FaultInterpretation_1_2_0DataFaultThrowDescriptions> FaultThrowDescriptions { get; set; }
    ...
    public FaultInterpretation_1_2_0DataRepresentativeDipDirection? RepresentativeDipDirection { get; set; }
...
/// </summary>
public class FaultInterpretation_1_2_0DataFaultThrowDescriptions
{
    /// <summary>
...
/// Indicates the representative azimuth value of the fault plane
/// </summary>
public class FaultInterpretation_1_2_0DataRepresentativeDipDirection
{
    /// <summary>
    /// The azimuth value
    /// </summary>
