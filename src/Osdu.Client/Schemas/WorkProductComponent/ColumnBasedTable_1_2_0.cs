...
public class ColumnBasedTable_1_2_0Data : AbstractCommonResources100 // Also composes: AbstractWPCGroupType120, AbstractWorkProductComponent110
{
    /// <summary>
    ...
    public List<AbstractReferencePropertyType120> KeyColumns { get; set; }
    ...
    public List<AbstractReferencePropertyType120> Columns { get; set; }
