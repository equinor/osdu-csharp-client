...
/// <summary>
/// DEPRECATED: use the SeismicFault or GenericRepresentation WPCs instead. These are representations of an individual fault. The grouping of individual faults can be achieved through the UnsealedSurfaceFramework or Persisted Collection WPCs. ~~A set of picked faults. In the earth modeling domain this entity corresponds to a PersistedCollection containing GenericRepresentation or SeismicFault items.~~
/// </summary>
public class FaultSystem_1_4_1
{
    /// <summary>
    ...
    public FaultSystem_1_4_1_Data? Data { get; set; }

}

public class FaultSystem_1_4_1_Data : AbstractCommonResources_1_0_0 // Also composes: AbstractWPCGroupType_1_2_0, AbstractWorkProductComponent_1_1_0
{
    /// <summary>
    ...
    public List<FaultSystem_1_4_1_Data_Artefacts> Artefacts { get; set; }
    ...
    public List<FaultSystem_1_4_1_Data_LineageAssertions> LineageAssertions { get; set; }
    ...
    /// <summary>
    /// The Bin Grid of the Fault System when coordinates are specified in seismic bin inline/crossline. Not populated for 2D based FaultSystem records.
    /// </summary>
    ...
    /// <summary>
    /// The list of seismic line geometries holding the trace to 'world' coordinate mappings for the 2D seismic lines. Only populated if the Fault System is based on 2D fault interpretations.
    /// </summary>
    ...
    public List<FaultSystem_1_4_1_Data_Faults> Faults { get; set; }
...
/// An array of Artefacts - each artefact has a Role, Resource tuple. An artefact is distinct from the file, in the sense certain valuable information is generated during loading process (Artefact generation process). Examples include retrieving location data, performing an OCR which may result in the generation of artefacts which need to be preserved distinctly
/// </summary>
public class FaultSystem_1_4_1_Data_Artefacts
{
    /// <summary>
...
/// Defines relationships with other objects (any kind of Resource) upon which this work product component depends.  The assertion is directed only from the asserting WPC to ancestor objects, not children.  It should not be used to refer to files or artefacts within the WPC -- the association within the WPC is sufficient and Artefacts are actually children of the main WPC file. They should be recorded in the data.Artefacts[] array.
/// </summary>
public class FaultSystem_1_4_1_Data_LineageAssertions
{
    /// <summary>
...
/// Array of Faults that comprise the Fault System
/// </summary>
public class FaultSystem_1_4_1_Data_Faults
{
    /// <summary>
