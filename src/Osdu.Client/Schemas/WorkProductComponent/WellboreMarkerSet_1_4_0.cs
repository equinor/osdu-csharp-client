...
public class WellboreMarkerSet_1_4_0
{
    ...
    public WellboreMarkerSet_1_4_0Data? Data { get; set; }

}

public class WellboreMarkerSet_1_4_0Data : AbstractCommonResources100 // Also composes: AbstractWPCGroupType120, AbstractWorkProductComponent110
{
    /// <summary>
    ...
    public List<WellboreMarkerSet_1_4_0DataAvailableMarkerProperties> AvailableMarkerProperties { get; set; }
    ...
    public List<WellboreMarkerSet_1_4_0DataMarkers> Markers { get; set; }
...
/// </summary>
public class WellboreMarkerSet_1_4_0DataAvailableMarkerProperties
{
    /// <summary>
...
/// </summary>
public class WellboreMarkerSet_1_4_0DataMarkers
{
    /// <summary>
    /// Name of the Marker
    /// </summary>
