...
/// </summary>
public class SeismicTraceData_1_6_0
{
    /// <summary>
    ...
    public SeismicTraceData_1_6_0_Data? Data { get; set; }

}

public class SeismicTraceData_1_6_0_Data : AbstractCommonResources_1_0_0 // Also composes: AbstractWPCGroupType_1_2_0, AbstractWorkProductComponent_1_1_0
{
    /// <summary>
    ...
    public List<SeismicTraceData_1_6_0_Data_Artefacts> Artefacts { get; set; }
    ...
    public List<SeismicTraceData_1_6_0_Data_LineageAssertions> LineageAssertions { get; set; }
    ...
    public SeismicTraceData_1_6_0_Data_Precision? Precision { get; set; }
    ...
    public List<SeismicTraceData_1_6_0_Data_ProcessingParameters> ProcessingParameters { get; set; }
    ...
    /// <summary>
    /// Post-stack: The stacking angle range maximum used during processing of this trace data set.
    /// </summary>
    [JsonPropertyName("StackAngleRangeMax")]
    public double? StackAngleRangeMax { get; set; }

    /// <summary>
    /// Post-stack: The stacking angle range minimum used during processing of this trace data set.
    /// </summary>
    [JsonPropertyName("StackAngleRangeMin")]
    public double? StackAngleRangeMin { get; set; }

    /// <summary>
    /// Post-stack: The stacking azimuth range maximum used during processing of this trace data set.
    /// </summary>
    [JsonPropertyName("StackAzimuthRangeMax")]
    public double? StackAzimuthRangeMax { get; set; }

    /// <summary>
    /// Post-stack: The stacking azimuth range minimum used during processing of this trace data set.
    /// </summary>
    [JsonPropertyName("StackAzimuthRangeMin")]
    public double? StackAzimuthRangeMin { get; set; }

    /// <summary>
    /// Post-stack: The stacking offset range maximum used during processing of this trace data set.
    /// </summary>
    [JsonPropertyName("StackOffsetRangeMax")]
    public double? StackOffsetRangeMax { get; set; }

    /// <summary>
    /// Post-stack: The stacking offset range minimum used during processing of this trace data set.
    /// </summary>
    ...
    public List<SeismicTraceData_1_6_0_Data_StackAngleRanges> StackAngleRanges { get; set; }

    /// <summary>
    /// Pre-stack: Sets of trace azimuth ranges contained within this data set.
    /// </summary>
    [JsonPropertyName("StackAzimuthRanges")]
    public List<SeismicTraceData_1_6_0_Data_StackAzimuthRanges> StackAzimuthRanges { get; set; }

    /// <summary>
    /// Pre-stack: Sets of trace offset ranges contained within this data set.
    /// </summary>
    [JsonPropertyName("StackOffsetRanges")]
    public List<SeismicTraceData_1_6_0_Data_StackOffsetRanges> StackOffsetRanges { get; set; }
    ...
    /// <summary>
    /// DEPRECATED: Please use `Time Lapse Associations` property instead. The contents positions the SeismicTraceData record in context of a time series. This is to be used for time lapse or 4D SeismicTraceData. This structure is optional and absent for SeismicTraceData not part of a time series.
    /// </summary>
    [JsonPropertyName("TimeLapse")]
    public SeismicTraceData_1_6_0_Data_TimeLapse? TimeLapse { get; set; }
...
/// An array of Artefacts - each artefact has a Role, Resource tuple. An artefact is distinct from the file, in the sense certain valuable information is generated during loading process (Artefact generation process). Examples include retrieving location data, performing an OCR which may result in the generation of artefacts which need to be preserved distinctly
/// </summary>
public class SeismicTraceData_1_6_0_Data_Artefacts
{
    /// <summary>
...
/// Defines relationships with other objects (any kind of Resource) upon which this work product component depends.  The assertion is directed only from the asserting WPC to ancestor objects, not children.  It should not be used to refer to files or artefacts within the WPC -- the association within the WPC is sufficient and Artefacts are actually children of the main WPC file. They should be recorded in the data.Artefacts[] array.
/// </summary>
public class SeismicTraceData_1_6_0_Data_LineageAssertions
{
    /// <summary>
...
/// Sample data format in terms of sample value precision 8bit Integer, 16bit Floating Point etc.
/// </summary>
public class SeismicTraceData_1_6_0_Data_Precision
{
    /// <summary>
...
/// Processing Parameters to simply capture process history until full provenance model can be implemented.
/// </summary>
public class SeismicTraceData_1_6_0_Data_ProcessingParameters
{
    /// <summary>
...
/// </summary>
public class SeismicTraceData_1_6_0_Data_StackAngleRanges
{
    /// <summary>
...
/// A range container carrying minimum/maximum angle values.
/// </summary>
public class SeismicTraceData_1_6_0_Data_StackAzimuthRanges
{
    /// <summary>
    /// The minimum angle value.
    /// </summary>
...
/// A range container carrying minimum/maximum angle values.
/// </summary>
public class SeismicTraceData_1_6_0_Data_StackOffsetRanges
{
    /// <summary>
...
/// DEPRECATED: Please use `Time Lapse Associations` property instead. The contents positions the SeismicTraceData record in context of a time series. This is to be used for time lapse or 4D SeismicTraceData. This structure is optional and absent for SeismicTraceData not part of a time series.
/// </summary>
public class SeismicTraceData_1_6_0_Data_TimeLapse
{
    /// <summary>
