...
public class ColumnBasedTable_1_0_0
{
    ...
    public ColumnBasedTable_1_0_0Data? Data { get; set; }

}

public class ColumnBasedTable_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractWPCGroupType100, AbstractWorkProductComponent100
{
    /// <summary>
    ...
    public List<AbstractReferencePropertyType110> KeyColumns { get; set; }
    ...
    public List<AbstractReferencePropertyType110> Columns { get; set; }
    ...
    public List<ColumnBasedTable_1_0_0DataColumnValues> ColumnValues { get; set; }
...
/// </summary>
public class ColumnBasedTable_1_0_0DataColumnValues
{
    /// <summary>
