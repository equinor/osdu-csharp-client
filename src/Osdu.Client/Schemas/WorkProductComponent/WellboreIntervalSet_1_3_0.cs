...
public class WellboreIntervalSet_1_3_0
{
    ...
    public WellboreIntervalSet_1_3_0Data? Data { get; set; }

}

public class WellboreIntervalSet_1_3_0Data : AbstractCommonResources100 // Also composes: AbstractWPCGroupType120, AbstractWorkProductComponent110
{
    /// <summary>
    ...
    public List<WellboreIntervalSet_1_3_0DataIntervals> Intervals { get; set; }

    [JsonPropertyName("IntervalProperties")]
    public AbstractColumnBasedTable120? IntervalProperties { get; set; }
...
/// </summary>
public class WellboreIntervalSet_1_3_0DataIntervals
{
    /// <summary>
