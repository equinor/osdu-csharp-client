...
public class SeismicLineGeometry_1_0_0
{
    ...
    public SeismicLineGeometry_1_0_0Data? Data { get; set; }

}

public class SeismicLineGeometry_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractWPCGroupType100, AbstractWorkProductComponent100
{
    /// <summary>
    ...
    public AbstractSpatialLocation100? FirstLocation { get; set; }

    [JsonPropertyName("LastLocation")]
    public AbstractSpatialLocation100? LastLocation { get; set; }
