...
/// <summary>
/// A standard report of all drilling, completion or well work events conducted on a well during a given period, usually a 24-hour day, not necessarily aligned with the local time zone.
/// </summary>
public class WellOperationsReport_2_0_0
{
    /// <summary>
    ...
    public WellOperationsReport_2_0_0Data? Data { get; set; }

}

public class WellOperationsReport_2_0_0Data : AbstractCommonResources100 // Also composes: AbstractWPCGroupType120, AbstractWorkProductComponent110
{
    /// <summary>
    ...
    public List<WellOperationsReport_2_0_0DataBitRecord> BitRecord { get; set; }
    ...
    public List<WellOperationsReport_2_0_0DataOperationsActivity> OperationsActivity { get; set; }
    ...
    public WellOperationsReport_2_0_0DataWellAlias? WellAlias { get; set; }

    /// <summary>
    /// Local name defined for the wellbore
    /// </summary>
    [JsonPropertyName("WellboreAlias")]
    public List<WellOperationsReport_2_0_0DataWellboreAlias> WellboreAlias { get; set; }

    /// <summary>
    /// Information regarding the status of the wellbore during this reporting period
    /// </summary>
    [JsonPropertyName("StatusInfo")]
    public List<WellOperationsReport_2_0_0DataStatusInfo> StatusInfo { get; set; }
    ...
    public List<WellOperationsReport_2_0_0DataTimedComments> TimedComments { get; set; }

    /// <summary>
    /// Meteorological readings for the defined time period on an operations report
    /// </summary>
    [JsonPropertyName("Weather")]
    public List<WellOperationsReport_2_0_0DataWeather> Weather { get; set; }
    ...
    public List<WellOperationsReport_2_0_0DataHSE> HSE { get; set; }

    /// <summary>
    /// Description of incidents that have occurred during the last drilling/operations report
    /// </summary>
    [JsonPropertyName("Incident")]
    public List<WellOperationsReport_2_0_0DataIncident> Incident { get; set; }

    /// <summary>
    /// Mud that has been lost during drilling / operations
    /// </summary>
    [JsonPropertyName("MudLosses")]
    public List<WellOperationsReport_2_0_0DataMudLosses> MudLosses { get; set; }
    ...
    public List<WellOperationsReport_2_0_0DataGasReading> GasReading { get; set; }
...
/// </summary>
public class WellOperationsReport_2_0_0DataBitRecord
{
    /// <summary>
...
/// </summary>
public class WellOperationsReport_2_0_0DataOperationsActivity
{
    /// <summary>
    ...
    public List<WellOperationsReport_2_0_0DataOperationsActivityProprietaryActivityCode> ProprietaryActivityCode { get; set; }
...
/// </summary>
public class WellOperationsReport_2_0_0DataOperationsActivityProprietaryActivityCode
{
    /// <summary>
    /// Identifier property
    /// </summary>
...
/// Local name defined for the Well
/// </summary>
public class WellOperationsReport_2_0_0DataWellAlias
{
    /// <summary>
    /// Identifier property
    /// </summary>
...
/// </summary>
public class WellOperationsReport_2_0_0DataWellboreAlias
{
    /// <summary>
    /// Identifier property
    /// </summary>
...
/// </summary>
public class WellOperationsReport_2_0_0DataStatusInfo
{
    /// <summary>
...
/// </summary>
public class WellOperationsReport_2_0_0DataTimedComments
{
    /// <summary>
...
/// Meteorological readings for the defined time period on an operations report
/// </summary>
public class WellOperationsReport_2_0_0DataWeather
{
    /// <summary>
...
/// Snapshot of operations personnel broken down by each company on the rig at the time of the report.
/// </summary>
public class WellOperationsReport_2_0_0DataPersonnel
{
    /// <summary>
...
/// Information related to pump operations on a drilling/operations report
/// </summary>
public class WellOperationsReport_2_0_0DataPumpOp
{
    /// <summary>
...
/// Information related to mud volumes for drilling/operations report
/// </summary>
public class WellOperationsReport_2_0_0DataMudVolume
{
    /// <summary>
...
/// Quantity of items inventoried during drilling and/or operations
/// </summary>
public class WellOperationsReport_2_0_0DataInventory
{
    /// <summary>
...
/// Cost information captured for a defined time period during operations and/or drilling
/// </summary>
public class WellOperationsReport_2_0_0DataCost
{
    /// <summary>
    /// Comments and remarks
    /// </summary>
...
/// Health Safety or Environment events that occurred since the last drilling/operation report. Captures data related to HSE events (e.g., tests, inspections, meetings, and drills), test values (e.g., pressure tested to), and/or incidents (e.g., discharges, non-compliance notices received, etc.).
/// </summary>
public class WellOperationsReport_2_0_0DataHSE
{
    /// <summary>
    /// Comments and remarks
    /// </summary>
...
/// Description of incidents that have occurred during the last drilling/operations report
/// </summary>
public class WellOperationsReport_2_0_0DataIncident
{
    /// <summary>
    /// Comments and remarks
    /// </summary>
...
/// Mud that has been lost during drilling / operations
/// </summary>
public class WellOperationsReport_2_0_0DataMudLosses
{
    /// <summary>
    /// Comments and remarks
    /// </summary>
...
/// General information about a gas reading taken during the drill report period
/// </summary>
public class WellOperationsReport_2_0_0DataGasReading
{
    /// <summary>
