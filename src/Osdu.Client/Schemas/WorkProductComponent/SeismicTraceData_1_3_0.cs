...
public class SeismicTraceData_1_3_0
{
    ...
    public SeismicTraceData_1_3_0Data? Data { get; set; }

}

public class SeismicTraceData_1_3_0Data : AbstractCommonResources100 // Also composes: AbstractWPCGroupType100, AbstractWorkProductComponent110
{
    ...
    public SeismicTraceData_1_3_0DataPrecision? Precision { get; set; }
    ...
    public List<SeismicTraceData_1_3_0DataProcessingParameters> ProcessingParameters { get; set; }
    ...
    public List<SeismicTraceData_1_3_0DataStackAngleRanges> StackAngleRanges { get; set; }

    /// <summary>
    /// Pre-stack: Sets of trace azimuth ranges contained within this data set.
    /// </summary>
    [JsonPropertyName("StackAzimuthRanges")]
    public List<SeismicTraceData_1_3_0DataStackAzimuthRanges> StackAzimuthRanges { get; set; }

    /// <summary>
    /// Pre-stack: Sets of trace offset ranges contained within this data set.
    /// </summary>
    [JsonPropertyName("StackOffsetRanges")]
    public List<SeismicTraceData_1_3_0DataStackOffsetRanges> StackOffsetRanges { get; set; }
    ...
    public SeismicTraceData_1_3_0DataTimeLapse? TimeLapse { get; set; }
...
/// Sample data format in terms of sample value precision 8bit Integer, 16bit Floating Point etc.
/// </summary>
public class SeismicTraceData_1_3_0DataPrecision
{
    /// <summary>
...
/// Processing Parameters to simply capture process history until full provenance model can be implemented.
/// </summary>
public class SeismicTraceData_1_3_0DataProcessingParameters
{
    /// <summary>
...
/// </summary>
public class SeismicTraceData_1_3_0DataStackAngleRanges
{
    /// <summary>
...
/// A range container carrying minimum/maximum angle values.
/// </summary>
public class SeismicTraceData_1_3_0DataStackAzimuthRanges
{
    /// <summary>
    /// The minimum angle value.
    /// </summary>
...
/// A range container carrying minimum/maximum angle values.
/// </summary>
public class SeismicTraceData_1_3_0DataStackOffsetRanges
{
    /// <summary>
...
/// The contents positions the SeismicTraceData record in context of a time series. This is to be used for time lapse or 4D SeismicTraceData. This structure is optional and absent for SeismicTraceData not part of a time series.
/// </summary>
public class SeismicTraceData_1_3_0DataTimeLapse
{
    /// <summary>
