...
/// </summary>
public class WellboreIntervalSet_1_2_0
{
    /// <summary>
    ...
    public WellboreIntervalSet_1_2_0Data? Data { get; set; }

}

public class WellboreIntervalSet_1_2_0Data : AbstractCommonResources100 // Also composes: AbstractWPCGroupType120, AbstractWorkProductComponent110
{
    /// <summary>
    ...
    public List<WellboreIntervalSet_1_2_0DataIntervals> Intervals { get; set; }

    [JsonPropertyName("IntervalProperties")]
    public AbstractColumnBasedTable110? IntervalProperties { get; set; }
...
/// </summary>
public class WellboreIntervalSet_1_2_0DataIntervals
{
    /// <summary>
