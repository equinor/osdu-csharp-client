...
/// </summary>
public class SeismicAcquisitionDocuments_1_1_0
{
    /// <summary>
    ...
    public SeismicAcquisitionDocuments_1_1_0_Data? Data { get; set; }

}

public class SeismicAcquisitionDocuments_1_1_0_Data : AbstractCommonResources_1_0_0 // Also composes: AbstractWPCGroupType_1_2_0, AbstractWorkProductComponent_1_1_0
{
    /// <summary>
    ...
    public List<SeismicAcquisitionDocuments_1_1_0_Data_Artefacts> Artefacts { get; set; }
    ...
    public List<SeismicAcquisitionDocuments_1_1_0_Data_LineageAssertions> LineageAssertions { get; set; }
    ...
    /// <summary>
    /// Documents produced during acquisition, containing reports on acquisition activities and progress. The array consists of record IDs, which identify a OSDU file or dataset resource.
    /// </summary>
    [JsonPropertyName("ObserverLogIDs")]
    public List<string> ObserverLogIDs { get; set; }

    /// <summary>
    /// Documents produced at end of each line, including information on shotpoint ranges, tapes, and files. The array consists of record IDs, which identify a OSDU file or dataset resource.
    /// </summary>
    [JsonPropertyName("LineLogIDs")]
    public List<string> LineLogIDs { get; set; }

    /// <summary>
    /// Documents produced during acquisition, including parameters , along with recording QC for each shot. The array consists of record IDs, which identify a OSDU file or dataset resource.
    /// </summary>
    [JsonPropertyName("ReceiverLogIDs")]
    public List<string> ReceiverLogIDs { get; set; }

    /// <summary>
    /// Document collected during acquisition which includes a format description and attribute properties.  Typically rows are collected for each line and shotpoint, with information on receivers. The array consists of record IDs, which identify a OSDU file or dataset resource.
    /// </summary>
    [JsonPropertyName("ReceiverInformationTableIDs")]
    public List<string> ReceiverInformationTableIDs { get; set; }

    /// <summary>
    /// Receiver response collected during acquisition.  May include response to differing receiver group orientations. The array consists of record IDs, which identify a OSDU file or dataset resource.
    /// </summary>
    ...
    /// <summary>
    /// Document collected during acquisition which includes a format description and attribute properties.  Typically rows are collected for each line and shotpoint, with information on sources, like volume, depth, and timing errors. The array consists of record IDs, which identify a OSDU file or dataset resource.
    /// </summary>
    ...
    /// <summary>
    /// Reference to a dataset containing the seismic acquisition report.
    /// </summary>
...
/// An array of Artefacts - each artefact has a Role, Resource tuple. An artefact is distinct from the file, in the sense certain valuable information is generated during loading process (Artefact generation process). Examples include retrieving location data, performing an OCR which may result in the generation of artefacts which need to be preserved distinctly
/// </summary>
public class SeismicAcquisitionDocuments_1_1_0_Data_Artefacts
{
    /// <summary>
...
/// Defines relationships with other objects (any kind of Resource) upon which this work product component depends.  The assertion is directed only from the asserting WPC to ancestor objects, not children.  It should not be used to refer to files or artefacts within the WPC -- the association within the WPC is sufficient and Artefacts are actually children of the main WPC file. They should be recorded in the data.Artefacts[] array.
/// </summary>
public class SeismicAcquisitionDocuments_1_1_0_Data_LineageAssertions
{
    /// <summary>
