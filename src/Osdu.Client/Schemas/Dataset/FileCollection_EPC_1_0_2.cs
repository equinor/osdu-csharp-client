...
public class FileCollection_EPC_1_0_2
{
    ...
    public FileCollection_EPC_1_0_2_Data? Data { get; set; }

}

public class FileCollection_EPC_1_0_2_Data : AbstractCommonResources_1_0_0 // Also composes: AbstractDataset_1_0_1
{
    /// <summary>
    /// The standard dataset schema for FileCollection.EPC.
    /// </summary>
    [JsonPropertyName("DatasetProperties")]
    public FileCollection_EPC_1_0_2_Data_DatasetProperties? DatasetProperties { get; set; }
...
/// The standard dataset schema for FileCollection.EPC.
/// </summary>
public class FileCollection_EPC_1_0_2_Data_DatasetProperties
{
    [Required]
