...
/// <summary>
/// A representation for a SEG Format B dataset represented as a set of files or tape reels containing seismic field trace recordings or processed traces. The format description is provided by the 1967 paper  https://seg.org/Portals/0/SEG/News%20and%20Resources/Technical%20Standards/seg_a_b_ex.pdf.
/// </summary>
public class FileCollection_SEGB_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:dataset\-\-FileCollection.SEGB:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public FileCollection_SEGB_1_0_0_Data? Data { get; set; }

}

public class FileCollection_SEGB_1_0_0_Data : AbstractCommonResources_1_0_0 // Also composes: AbstractDataset_1_0_0, AbstractFileCollection_1_0_0, AbstractVectorHeaderMapping_1_0_0
{
    /// <summary>
    ...
    public FileCollection_SEGB_1_0_0_Data_Endian Endian { get; set; }
    ...
    public List<FileCollection_SEGB_1_0_0_Data_VectorHeaderMapping> VectorHeaderMapping { get; set; }
...
public enum FileCollection_SEGB_1_0_0_Data_Endian
{
...
/// Array of objects which define the meaning and format of a tabular structure used in a binary file as a header.  The initial use case is the trace headers of a SEG-Y file.  Note that some of this information may be repeated in the SEG-Y EBCDIC header.
/// </summary>
public class FileCollection_SEGB_1_0_0_Data_VectorHeaderMapping
{
    /// <summary>
    ...
    public FileCollection_SEGB_1_0_0_Data_VectorHeaderMapping_ScalarIndicator ScalarIndicator { get; set; }
...
/// </summary>
[JsonConverter(typeof(JsonStringEnumConverter))]
public enum FileCollection_SEGB_1_0_0_Data_VectorHeaderMapping_ScalarIndicator
{
