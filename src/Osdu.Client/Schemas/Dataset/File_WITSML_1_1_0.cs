...
/// <summary>
/// Schema describing a WITSML file resource.
/// </summary>
public class File_WITSML_1_1_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:dataset\-\-File.WITSML:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public File_WITSML_1_1_0Data? Data { get; set; }

}

public class File_WITSML_1_1_0Data : AbstractCommonResources100 // Also composes: AbstractDataset101, AbstractFile101
{
    /// <summary>
    /// The Version of the WITSML standard.
    /// </summary>
    [JsonPropertyName("WITSML_Version")]
    public string WITSMLVersion { get; set; }
