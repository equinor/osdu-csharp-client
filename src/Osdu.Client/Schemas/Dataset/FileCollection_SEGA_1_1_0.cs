...
/// <summary>
/// A representation for a SEG Format A dataset represented as a set of files or tape reels containing seismic field trace recordings or processed traces. The format description is provided by the 1967 paper  https://seg.org/Portals/0/SEG/News%20and%20Resources/Technical%20Standards/seg_a_b_ex.pdf.
/// </summary>
public class FileCollection_SEGA_1_1_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:dataset\-\-FileCollection.SEGA:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public FileCollection_SEGA_1_1_0_Data? Data { get; set; }

}

public class FileCollection_SEGA_1_1_0_Data : AbstractCommonResources_1_0_0 // Also composes: AbstractDataset_1_0_1, AbstractFileCollection_1_0_1, AbstractVectorHeaderMapping_1_1_0
{
    /// <summary>
    ...
    public FileCollection_SEGA_1_1_0_Data_Endian Endian { get; set; }
    ...
    public List<FileCollection_SEGA_1_1_0_Data_VectorHeaderMapping> VectorHeaderMapping { get; set; }

    /// <summary>
    /// Trace header override definitions.
    /// </summary>
    [JsonPropertyName("TraceHeaderOverrides")]
    public List<FileCollection_SEGA_1_1_0_Data_TraceHeaderOverrides> TraceHeaderOverrides { get; set; }

    /// <summary>
    /// Binary header override definitions.
    /// </summary>
    [JsonPropertyName("BinaryHeaderOverrides")]
    public List<FileCollection_SEGA_1_1_0_Data_BinaryHeaderOverrides> BinaryHeaderOverrides { get; set; }
...
public enum FileCollection_SEGA_1_1_0_Data_Endian
{
...
/// Array of objects which define the meaning and format of a tabular structure used in a binary file as a header.  The initial use case is the trace headers of a SEG-Y file.  Note that some of this information may be repeated in the SEG-Y EBCDIC header.
/// </summary>
public class FileCollection_SEGA_1_1_0_Data_VectorHeaderMapping
{
    /// <summary>
    ...
    public FileCollection_SEGA_1_1_0_Data_VectorHeaderMapping_ScalarIndicator ScalarIndicator { get; set; }
...
/// </summary>
[JsonConverter(typeof(JsonStringEnumConverter))]
public enum FileCollection_SEGA_1_1_0_Data_VectorHeaderMapping_ScalarIndicator
{
...
/// </summary>
public class FileCollection_SEGA_1_1_0_Data_TraceHeaderOverrides
{
    /// <summary>
    /// Relationship to a reference value for a name of a property header such as INLINE, CDPX.
    /// </summary>
    ...
    public List<FileCollection_SEGA_1_1_0_Data_TraceHeaderOverrides_OverrideByExpressions> OverrideByExpressions { get; set; }
...
/// </summary>
public class FileCollection_SEGA_1_1_0_Data_TraceHeaderOverrides_OverrideByExpressions
{
    /// <summary>
    ...
    public FileCollection_SEGA_1_1_0_Data_TraceHeaderOverrides_OverrideByExpressions_Operator1 Operator1 { get; set; }
    ...
    public FileCollection_SEGA_1_1_0_Data_TraceHeaderOverrides_OverrideByExpressions_Operator2 Operator2 { get; set; }
...
/// </summary>
[JsonConverter(typeof(JsonStringEnumConverter))]
public enum FileCollection_SEGA_1_1_0_Data_TraceHeaderOverrides_OverrideByExpressions_Operator1
{
...
/// </summary>
[JsonConverter(typeof(JsonStringEnumConverter))]
public enum FileCollection_SEGA_1_1_0_Data_TraceHeaderOverrides_OverrideByExpressions_Operator2
{
    [JsonStringEnumMemberName("Plus")]
    Plus,
...
/// </summary>
public class FileCollection_SEGA_1_1_0_Data_BinaryHeaderOverrides
{
    /// <summary>
