...
/// <summary>
/// A file accompanying a File.Image.JPEG, File.Image.PNG or File.Image.TIFF containing the original pixel to 'world' coordinate transformation instructions. Typical file extensions are .jgw, .j2w, .pgw, .tfw, depending on the image type in context.
/// </summary>
public class File_Image_WorldFile_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:dataset\-\-File.Image.WorldFile:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public File_Image_WorldFile_1_0_0_Data? Data { get; set; }

}

public class File_Image_WorldFile_1_0_0_Data : AbstractCommonResources_1_0_0 // Also composes: AbstractDataset_1_0_0, AbstractFile_1_0_0
{
    /// <summary>
    ...
    public File_Image_WorldFile_1_0_0_Data_Endian Endian { get; set; }
...
public enum File_Image_WorldFile_1_0_0_Data_Endian
{
