...
/// </summary>
public class FileCollection_Esri_Shape_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:dataset\-\-FileCollection.Esri.Shape:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public FileCollection_Esri_Shape_1_0_0_Data? Data { get; set; }

}

public class FileCollection_Esri_Shape_1_0_0_Data : AbstractCommonResources_1_0_0 // Also composes: AbstractDataset_1_0_0, AbstractFileCollection_1_0_0
{
    /// <summary>
    ...
    public FileCollection_Esri_Shape_1_0_0_Data_Endian Endian { get; set; }
...
public enum FileCollection_Esri_Shape_1_0_0_Data_Endian
{
