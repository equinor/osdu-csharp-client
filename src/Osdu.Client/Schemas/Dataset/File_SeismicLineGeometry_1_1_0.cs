...
/// <summary>
/// A dedicated dataset type referring to seismic 2D line geometry. The associated file format is content--TraceNavigation.
/// </summary>
public class File_SeismicLineGeometry_1_1_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:dataset\-\-File.SeismicLineGeometry:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public File_SeismicLineGeometry_1_1_0_Data? Data { get; set; }

}

public class File_SeismicLineGeometry_1_1_0_Data : AbstractCommonResources_1_0_0 // Also composes: AbstractDataset_1_0_1, AbstractFile_1_0_1
{
    /// <summary>
    ...
    public File_SeismicLineGeometry_1_1_0_Data_Endian Endian { get; set; }
    ...
    /// <summary>
    /// The schema version  of the associated content file (content--TraceNavigation).
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:[\w\-\.]+:[\w\-\.]+:[0-9]+.[0-9]+.[0-9]+$")]
    [JsonPropertyName("ContentSchemaKind")]
    public string ContentSchemaKind { get; set; }
...
public enum File_SeismicLineGeometry_1_1_0_Data_Endian
{
