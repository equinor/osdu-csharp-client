...
/// <summary>
/// The generic file collection template.
/// </summary>
public class FileCollection_Generic_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:dataset\-\-FileCollection.Generic:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public FileCollection_Generic_1_0_0_Data? Data { get; set; }

}

public class FileCollection_Generic_1_0_0_Data : AbstractCommonResources_1_0_0 // Also composes: AbstractDataset_1_0_0, AbstractFileCollection_1_0_0
{
    /// <summary>
    ...
    public FileCollection_Generic_1_0_0_Data_Endian Endian { get; set; }
...
public enum FileCollection_Generic_1_0_0_Data_Endian
{
