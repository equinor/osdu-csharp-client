...
/// </summary>
public class FileCollection_SEGY_1_3_0
{
    /// <summary>
...
public class FileCollection_SEGY_1_3_0_Data : AbstractCommonResources_1_0_0 // Also composes: AbstractDataset_1_0_1, AbstractFileCollection_1_0_1, AbstractVectorHeaderMapping_1_1_0
{
    ...
    public FileCollection_SEGY_1_3_0_Data_Endian Endian { get; set; }
    ...
    public List<FileCollection_SEGY_1_3_0_Data_VectorHeaderMapping> VectorHeaderMapping { get; set; }

    /// <summary>
    /// Trace header override definitions.
    /// </summary>
    [JsonPropertyName("TraceHeaderOverrides")]
    public List<FileCollection_SEGY_1_3_0_Data_TraceHeaderOverrides> TraceHeaderOverrides { get; set; }

    /// <summary>
    /// Binary header override definitions.
    /// </summary>
    [JsonPropertyName("BinaryHeaderOverrides")]
    public List<FileCollection_SEGY_1_3_0_Data_BinaryHeaderOverrides> BinaryHeaderOverrides { get; set; }
...
public enum FileCollection_SEGY_1_3_0_Data_Endian
{
...
/// Array of objects which define the meaning and format of a tabular structure used in a binary file as a header.  The initial use case is the trace headers of a SEG-Y file.  Note that some of this information may be repeated in the SEG-Y EBCDIC header.
/// </summary>
public class FileCollection_SEGY_1_3_0_Data_VectorHeaderMapping
{
    /// <summary>
    ...
    public FileCollection_SEGY_1_3_0_Data_VectorHeaderMapping_ScalarIndicator ScalarIndicator { get; set; }
...
/// </summary>
[JsonConverter(typeof(JsonStringEnumConverter))]
public enum FileCollection_SEGY_1_3_0_Data_VectorHeaderMapping_ScalarIndicator
{
...
/// </summary>
public class FileCollection_SEGY_1_3_0_Data_TraceHeaderOverrides
{
    /// <summary>
    /// Relationship to a reference value for a name of a property header such as INLINE, CDPX.
    /// </summary>
    ...
    public List<FileCollection_SEGY_1_3_0_Data_TraceHeaderOverrides_OverrideByExpressions> OverrideByExpressions { get; set; }
...
/// </summary>
public class FileCollection_SEGY_1_3_0_Data_TraceHeaderOverrides_OverrideByExpressions
{
    /// <summary>
    ...
    public FileCollection_SEGY_1_3_0_Data_TraceHeaderOverrides_OverrideByExpressions_Operator1 Operator1 { get; set; }
    ...
    public FileCollection_SEGY_1_3_0_Data_TraceHeaderOverrides_OverrideByExpressions_Operator2 Operator2 { get; set; }
...
/// </summary>
[JsonConverter(typeof(JsonStringEnumConverter))]
public enum FileCollection_SEGY_1_3_0_Data_TraceHeaderOverrides_OverrideByExpressions_Operator1
{
...
/// </summary>
[JsonConverter(typeof(JsonStringEnumConverter))]
public enum FileCollection_SEGY_1_3_0_Data_TraceHeaderOverrides_OverrideByExpressions_Operator2
{
    [JsonStringEnumMemberName("Plus")]
    Plus,
...
/// </summary>
public class FileCollection_SEGY_1_3_0_Data_BinaryHeaderOverrides
{
    /// <summary>
