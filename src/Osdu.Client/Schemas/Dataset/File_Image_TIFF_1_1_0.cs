...
/// <summary>
/// An image file in Tagged Image File Format (TIFF), https://en.wikipedia.org/wiki/TIFF.
/// </summary>
public class File_Image_TIFF_1_1_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:dataset\-\-File.Image.TIFF:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public File_Image_TIFF_1_1_0_Data? Data { get; set; }

}

public class File_Image_TIFF_1_1_0_Data : AbstractCommonResources_1_0_0 // Also composes: AbstractDataset_1_0_1, AbstractFile_1_0_1
{
    /// <summary>
    ...
    public File_Image_TIFF_1_1_0_Data_Endian Endian { get; set; }
...
public enum File_Image_TIFF_1_1_0_Data_Endian
{
