...
/// <summary>
/// An image file in JPEG format, https://en.wikipedia.org/wiki/JPEG.
/// </summary>
public class File_Image_JPEG_1_1_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:dataset\-\-File.Image.JPEG:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public File_Image_JPEG_1_1_0_Data? Data { get; set; }

}

public class File_Image_JPEG_1_1_0_Data : AbstractCommonResources_1_0_0 // Also composes: AbstractDataset_1_0_1, AbstractFile_1_0_1
{
    /// <summary>
    ...
    public File_Image_JPEG_1_1_0_Data_Endian Endian { get; set; }
...
public enum File_Image_JPEG_1_1_0_Data_Endian
{
