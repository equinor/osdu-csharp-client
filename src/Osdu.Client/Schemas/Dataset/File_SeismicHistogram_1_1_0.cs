...
/// <summary>
/// Typically an artefact of a SeismicTraceData or SeismicFieldTraceData record containing a statistical summary and one or more histograms.
/// </summary>
public class File_SeismicHistogram_1_1_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:dataset\-\-File.SeismicHistogram:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public File_SeismicHistogram_1_1_0_Data? Data { get; set; }

}

public class File_SeismicHistogram_1_1_0_Data : AbstractCommonResources_1_0_0 // Also composes: AbstractDataset_1_0_1, AbstractFile_1_0_1
{
    /// <summary>
    ...
    public File_SeismicHistogram_1_1_0_Data_Endian Endian { get; set; }
    ...
    /// <summary>
    /// The schema kind used for the content in the associated file.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:[\w\-\.]+:[\w\-\.]+:[0-9]+.[0-9]+.[0-9]+$")]
...
public enum File_SeismicHistogram_1_1_0_Data_Endian
{
