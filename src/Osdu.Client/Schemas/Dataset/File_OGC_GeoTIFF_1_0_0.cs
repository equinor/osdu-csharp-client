...
public class File_OGC_GeoTIFF_1_0_0
{
    ...
    public File_OGC_GeoTIFF_1_0_0_Data? Data { get; set; }

}

public class File_OGC_GeoTIFF_1_0_0_Data : AbstractCommonResources_1_0_0 // Also composes: AbstractDataset_1_0_0, AbstractFile_1_0_0
{
    /// <summary>
    ...
    public File_OGC_GeoTIFF_1_0_0_Data_Endian Endian { get; set; }
    ...
    /// <summary>
    /// The OSDU Platform CRS reference into the CoordinateReferenceSystem catalog matching the inlined geospatial definition. This CRS can also be a BoundCRS, which provides the transformation to WGS 84.
    /// </summary>
    ...
    /// <summary>
    /// The OSDU Platform CRS reference as persistableReference string. If populated, the CoordinateReferenceSystemID takes precedence. This CRS can also be a BoundCRS, which provides the transformation to WGS 84.
    /// </summary>
...
public enum File_OGC_GeoTIFF_1_0_0_Data_Endian
{
