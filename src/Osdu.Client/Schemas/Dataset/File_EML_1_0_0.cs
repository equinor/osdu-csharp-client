...
/// <summary>
/// An EML file is the XML expression of an EML Entity : EnergyML Common Technical Architecture (CTA) Entity like Activity Template, Activity, Graphical Attributes (Energistics industry-specific standard).
/// </summary>
public class File_EML_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:dataset\-\-File.EML:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public File_EML_1_0_0_Data? Data { get; set; }

}

public class File_EML_1_0_0_Data : AbstractCommonResources_1_0_0 // Also composes: AbstractDataset_1_0_0, AbstractFile_1_0_0
{
    /// <summary>
    ...
    public File_EML_1_0_0_Data_Endian Endian { get; set; }
...
public enum File_EML_1_0_0_Data_Endian
{
