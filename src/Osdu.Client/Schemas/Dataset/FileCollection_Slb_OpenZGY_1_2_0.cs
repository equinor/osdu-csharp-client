...
/// <summary>
/// The dataset representation for optimized seismic access to the OpenZGY framework developed by Schlumberger, storing seismic 3D data for seismic interpretation.
/// </summary>
public class FileCollection_Slb_OpenZGY_1_2_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:dataset\-\-FileCollection.Slb.OpenZGY:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public FileCollection_Slb_OpenZGY_1_2_0_Data? Data { get; set; }

}

public class FileCollection_Slb_OpenZGY_1_2_0_Data : AbstractCommonResources_1_0_0 // Also composes: AbstractDataset_1_0_1, AbstractFileCollection_1_0_1
{
    /// <summary>
    ...
    public FileCollection_Slb_OpenZGY_1_2_0_Data_Endian Endian { get; set; }
...
public enum FileCollection_Slb_OpenZGY_1_2_0_Data_Endian
{
