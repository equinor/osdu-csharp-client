...
/// <summary>
/// GeoJSON is an open standard format designed for representing simple geographical features, optionally along with their non-spatial attributes. It is based on the JSON format; the schema is available via https://geojson.org/schema/FeatureCollection.json. The features include points, line strings, polygons, and multi-part collections of these types. Coordinates are exclusively expressed in EPSG::4326.
/// </summary>
public class File_GeoJSON_1_1_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:dataset\-\-File.GeoJSON:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public File_GeoJSON_1_1_0_Data? Data { get; set; }

}

public class File_GeoJSON_1_1_0_Data : AbstractCommonResources_1_0_0 // Also composes: AbstractDataset_1_0_1, AbstractFile_1_0_1
{
    /// <summary>
    ...
    public File_GeoJSON_1_1_0_Data_Endian Endian { get; set; }
...
public enum File_GeoJSON_1_1_0_Data_Endian
{
