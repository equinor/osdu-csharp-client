...
/// </summary>
public class FileCollection_SEGY_1_1_0
{
    /// <summary>
    ...
    public FileCollection_SEGY_1_1_0_Data? Data { get; set; }

}

public class FileCollection_SEGY_1_1_0_Data : AbstractCommonResources_1_0_0 // Also composes: AbstractDataset_1_0_0, AbstractFileCollection_1_0_0, AbstractVectorHeaderMapping_1_0_0
{
    /// <summary>
    ...
    public FileCollection_SEGY_1_1_0_Data_Endian Endian { get; set; }
    ...
    public List<FileCollection_SEGY_1_1_0_Data_VectorHeaderMapping> VectorHeaderMapping { get; set; }
...
public enum FileCollection_SEGY_1_1_0_Data_Endian
{
...
/// Array of objects which define the meaning and format of a tabular structure used in a binary file as a header.  The initial use case is the trace headers of a SEG-Y file.  Note that some of this information may be repeated in the SEG-Y EBCDIC header.
/// </summary>
public class FileCollection_SEGY_1_1_0_Data_VectorHeaderMapping
{
    /// <summary>
    ...
    public FileCollection_SEGY_1_1_0_Data_VectorHeaderMapping_ScalarIndicator ScalarIndicator { get; set; }
...
/// </summary>
[JsonConverter(typeof(JsonStringEnumConverter))]
public enum FileCollection_SEGY_1_1_0_Data_VectorHeaderMapping_ScalarIndicator
{
