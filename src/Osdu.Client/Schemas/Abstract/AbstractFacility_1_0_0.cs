...
public class AbstractFacility_1_0_0
{
    ...
    public List<AbstractFacilityOperator100> FacilityOperators { get; set; }
    ...
    public List<AbstractAliasNames100> FacilityNameAliases { get; set; }

    /// <summary>
    /// The history of life cycle states the facility has been through.
    /// </summary>
    [JsonPropertyName("FacilityStates")]
    public List<AbstractFacilityState100> FacilityStates { get; set; }

    /// <summary>
    /// A list of key facility events.
    /// </summary>
    [JsonPropertyName("FacilityEvents")]
    public List<AbstractFacilityEvent100> FacilityEvents { get; set; }
    ...
    public List<AbstractFacilitySpecification100> FacilitySpecifications { get; set; }
