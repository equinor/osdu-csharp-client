...
public class AbstractTechnicalAssurance_1_1_0
{
    ...
    public List<AbstractTechnicalAssurance_1_1_0AcceptableUsage> AcceptableUsage { get; set; }
    ...
    public List<AbstractTechnicalAssurance_1_1_0UnacceptableUsage> UnacceptableUsage { get; set; }
...
/// </summary>
public class AbstractTechnicalAssurance_1_1_0AcceptableUsage
{
    /// <summary>
...
/// </summary>
public class AbstractTechnicalAssurance_1_1_0UnacceptableUsage
{
    /// <summary>
