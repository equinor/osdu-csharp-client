...
public class AbstractFacility_1_1_0
{
    ...
    public List<AbstractFacilityOperator110> FacilityOperators { get; set; }
    ...
    public List<AbstractFacilityState110> FacilityStates { get; set; }

    /// <summary>
    /// A list of key facility events.
    /// </summary>
    [JsonPropertyName("FacilityEvents")]
    public List<AbstractFacilityEvent110> FacilityEvents { get; set; }
