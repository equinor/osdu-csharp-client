...
public class AbstractWPCActivity_1_2_1
{
    ...
    public List<AbstractWPCActivity_1_2_1SoftwareSpecifications> SoftwareSpecifications { get; set; }
    ...
    public List<AbstractActivityState100> ActivityStates { get; set; }

    [JsonPropertyName("LastActivityState")]
    public AbstractActivityState100? LastActivityState { get; set; }
...
/// </summary>
public class AbstractWPCActivity_1_2_1SoftwareSpecifications
{
    /// <summary>
