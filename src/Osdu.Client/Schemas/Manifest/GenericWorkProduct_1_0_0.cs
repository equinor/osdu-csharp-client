...
/// <summary>
/// An auto-generated placeholder schema representing work-product group-type records in data loading/ingestion/creation manifests. Do not use this kind for actual records.
/// </summary>
public class GenericWorkProduct_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^(surrogate-key:.+|[\w\-\.]+:work-product\-\-[\w\-\.]+:[\w\-\.\:\%]+)$")]
    [JsonPropertyName("id")]
    ...
    public GenericWorkProduct_1_0_0Data? Data { get; set; }

}

public class GenericWorkProduct_1_0_0Data : AbstractCommonResources100
{
    /// <summary>
    ...
    public List<GenericWorkProduct_1_0_0DataArtefacts> Artefacts { get; set; }
    ...
    public List<AbstractTechnicalAssurance100> TechnicalAssurances { get; set; }
    ...
    public List<AbstractGeoContext100> GeoContexts { get; set; }
    ...
    public List<GenericWorkProduct_1_0_0DataLineageAssertions> LineageAssertions { get; set; }
...
/// An array of Artefacts - each artefact has a Role, Resource tuple. An artefact is distinct from the file, in the sense certain valuable information is generated during loading process (Artefact generation process). Examples include retrieving location data, performing an OCR which may result in the generation of artefacts which need to be preserved distinctly
/// </summary>
public class GenericWorkProduct_1_0_0DataArtefacts
{
    /// <summary>
    ...
    /// </summary>
    [RegularExpression(@"^(surrogate-key:.+|[\w\-\.]+:dataset\-\-[\w\-\.]+:[\w\-\.\:\%]+:[0-9]*)$")]
...
/// Defines relationships with other objects (any kind of Resource) upon which this work product component depends.  The assertion is directed only from the asserting WPC to ancestor objects, not children.  It should not be used to refer to files or artefacts within the WPC -- the association within the WPC is sufficient and Artefacts are actually children of the main WPC file. They should be recorded in the data.Artefacts[] array.
/// </summary>
public class GenericWorkProduct_1_0_0DataLineageAssertions
{
    /// <summary>
