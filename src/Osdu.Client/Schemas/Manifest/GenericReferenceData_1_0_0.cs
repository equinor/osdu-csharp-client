...
/// <summary>
/// An auto-generated placeholder schema representing reference-data group-type records in data loading/ingestion/creation manifests. Do not use this kind for actual records.
/// </summary>
public class GenericReferenceData_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [Required]
    [RegularExpression(@"^(surrogate-key:.+|[\w\-\.]+:reference-data\-\-[\w\-\.]+:[\w\-\.\:\%]+)$")]
    [JsonPropertyName("id")]
...
public class GenericReferenceData_1_0_0Data : AbstractCommonResources100
{
    /// <summary>
    ...
    public List<AbstractAliasNames100> NameAlias { get; set; }
