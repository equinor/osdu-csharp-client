...
/// <summary>
/// An auto-generated placeholder schema representing dataset group-type records in data loading/ingestion/creation manifests. Do not use this kind for actual records.
/// </summary>
public class GenericDataset_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^(surrogate-key:.+|[\w\-\.]+:dataset\-\-[\w\-\.]+:[\w\-\.\:\%]+)$")]
    [JsonPropertyName("id")]
...
public class GenericDataset_1_0_0Data : AbstractCommonResources100
{
    /// <summary>
