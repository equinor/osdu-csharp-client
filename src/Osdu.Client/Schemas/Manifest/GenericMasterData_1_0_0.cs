...
/// <summary>
/// An auto-generated placeholder schema representing master-data group-type records in data loading/ingestion/creation manifests. Do not use this kind for actual records.
/// </summary>
public class GenericMasterData_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [Required]
    [RegularExpression(@"^(surrogate-key:.+|[\w\-\.]+:master-data\-\-[\w\-\.]+:[\w\-\.\:\%]+)$")]
    [JsonPropertyName("id")]
...
public class GenericMasterData_1_0_0Data : AbstractCommonResources100
{
    /// <summary>
    ...
    public AbstractSpatialLocation100? SpatialLocation { get; set; }
