...
/// <summary>
/// The list of estimated in-place or technical recoverable volume property types. Used by ReservoirEstimatedVolume.
/// </summary>
public class ReservoirEstimatedVolumePropertyType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-ReservoirEstimatedVolumePropertyType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public ReservoirEstimatedVolumePropertyType_1_0_0Data? Data { get; set; }

}

public class ReservoirEstimatedVolumePropertyType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
