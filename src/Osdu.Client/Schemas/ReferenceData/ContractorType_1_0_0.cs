...
/// <summary>
/// The role of a contractor providing services, such as Recording, Line Clearing, Positioning, Data Processing.
/// </summary>
public class ContractorType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-ContractorType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public ContractorType_1_0_0Data? Data { get; set; }

}

public class ContractorType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
