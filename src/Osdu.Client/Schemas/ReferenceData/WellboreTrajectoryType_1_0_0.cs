...
/// <summary>
/// Profile Type [Well Profile Type, Wellbore Trajectory Type] is the general geometry of the wellbore relative to the vertical plane. The specific criteria may vary by operator or regulator. The facet value may change if conditions encountered during drilling are not what was planned or permitted.
/// </summary>
public class WellboreTrajectoryType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-WellboreTrajectoryType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public WellboreTrajectoryType_1_0_0Data? Data { get; set; }

}

public class WellboreTrajectoryType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
