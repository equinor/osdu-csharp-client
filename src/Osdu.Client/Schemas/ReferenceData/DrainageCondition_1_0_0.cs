...
/// <summary>
/// Identifies whether a physical rock sample has been drained of fluid as a part of rock analysis such as triaxial testing.
/// </summary>
public class DrainageCondition_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-DrainageCondition:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public DrainageCondition_1_0_0Data? Data { get; set; }

}

public class DrainageCondition_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
