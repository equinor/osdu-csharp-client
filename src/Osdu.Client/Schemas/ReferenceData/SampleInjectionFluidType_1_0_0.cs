...
/// <summary>
/// The type of fluid injected into a rock sample during the lab experiment, usually to displace other fluids.
/// </summary>
public class SampleInjectionFluidType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-SampleInjectionFluidType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public SampleInjectionFluidType_1_0_0Data? Data { get; set; }

}

public class SampleInjectionFluidType_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
