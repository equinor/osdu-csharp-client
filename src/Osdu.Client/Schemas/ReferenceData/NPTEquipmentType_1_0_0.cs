...
/// <summary>
/// Non-Productive Time Equipment Type - types of Rig/Work Unit, other Surface and Downhole Equipment list whose failure may cause NPT
/// </summary>
public class NPTEquipmentType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-NPTEquipmentType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public NPTEquipmentType_1_0_0Data? Data { get; set; }

}

public class NPTEquipmentType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
