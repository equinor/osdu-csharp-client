...
/// <summary>
/// The definition of north in a spatial reference survey. A reference table identifying valid north references used in surveying to define angular measurements
/// </summary>
public class AzimuthReferenceType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-AzimuthReferenceType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public AzimuthReferenceType_1_0_0Data? Data { get; set; }

}

public class AzimuthReferenceType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
