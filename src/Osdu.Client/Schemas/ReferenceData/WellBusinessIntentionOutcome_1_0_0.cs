...
/// <summary>
/// Outcome [Well Business Intention Outcome] is the result of attempting to accomplish the Business Intention [Well Business Intention].
/// </summary>
public class WellBusinessIntentionOutcome_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-WellBusinessIntentionOutcome:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public WellBusinessIntentionOutcome_1_0_0Data? Data { get; set; }

}

public class WellBusinessIntentionOutcome_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
