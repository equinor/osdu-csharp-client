...
/// <summary>
/// For external data source ingestion system to notify users on the ingestion run status
/// </summary>
public class EdsNotificationPolicy_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-EdsNotificationPolicy:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public EdsNotificationPolicy_1_0_0Data? Data { get; set; }

}

public class EdsNotificationPolicy_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
