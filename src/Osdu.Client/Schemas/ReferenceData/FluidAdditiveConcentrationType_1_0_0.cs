...
/// <summary>
/// Fluid Additive Concentration Type - Percentage concentration of additive in fluid and basis for that percentage representation.
/// </summary>
public class FluidAdditiveConcentrationType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-FluidAdditiveConcentrationType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public FluidAdditiveConcentrationType_1_0_0Data? Data { get; set; }

}

public class FluidAdditiveConcentrationType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
