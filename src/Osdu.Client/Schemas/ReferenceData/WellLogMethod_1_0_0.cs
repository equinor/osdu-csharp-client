...
/// <summary>
/// A reference value list for well logging methods as defined by the Energistics Practical Well Log Standard (PWLS), which is referred to by  WellLoggingTool.
/// </summary>
public class WellLogMethod_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-WellLogMethod:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public WellLogMethod_1_0_0Data? Data { get; set; }

}

public class WellLogMethod_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
