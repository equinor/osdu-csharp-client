...
/// <summary>
/// The role of a facet, e.g. maximum threshold, cumulative, surface condition, reservoir condition, oil, water, gas, condensate.
/// </summary>
public class FacetRole_1_1_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-FacetRole:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public FacetRole_1_1_0Data? Data { get; set; }

}

public class FacetRole_1_1_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
    /// <summary>
    /// The FacetType, to which this FacetRole belongs to. When used in AbstractFacet, the FacetRoleID's data.FacetTypeID must match the AbstractFacet's FacetTypeID (business rule).
    /// </summary>
