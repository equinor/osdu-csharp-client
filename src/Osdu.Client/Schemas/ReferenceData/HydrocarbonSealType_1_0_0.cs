...
/// <summary>
/// A classification of hydrocarbon seals based on their geological characteristics and sealing mechanisms. A hydrocarbon seal is a geological barrier that prevents the upward migration of hydrocarbons (such as oil and gas) from a subsurface reservoir.
/// </summary>
public class HydrocarbonSealType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-HydrocarbonSealType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public HydrocarbonSealType_1_0_0Data? Data { get; set; }

}

public class HydrocarbonSealType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
