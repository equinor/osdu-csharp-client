...
/// <summary>
/// Class of imaging algorithm used, such as Kirchhoff, Full Wave Inversion, Reverse Time. May be qualified with domain like depth|time and prestack|poststack.
/// </summary>
public class SeismicMigrationType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-SeismicMigrationType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public SeismicMigrationType_1_0_0Data? Data { get; set; }

}

public class SeismicMigrationType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
