...
/// <summary>
/// The type of filter applied to the light source of a sample image, for example, Cross Polarised, Brightfield and Darkfield.
/// </summary>
public class SampleImageOpticalLightFilter_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-SampleImageOpticalLightFilter:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public SampleImageOpticalLightFilter_1_0_0Data? Data { get; set; }

}

public class SampleImageOpticalLightFilter_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
