...
/// <summary>
/// Picking method used for horizons, faults, and other feature types, such as Primary seed pick (seed), Interpolated seed pick (int), Autotracked seed pick (aut), Mixed.
/// </summary>
public class SeismicPickingType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-SeismicPickingType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public SeismicPickingType_1_0_0Data? Data { get; set; }

}

public class SeismicPickingType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
