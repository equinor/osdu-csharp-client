...
/// <summary>
/// High-level definition of the slurry type, which often relates to the objective of the Cement slurry.
/// </summary>
public class CementSlurryType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-CementSlurryType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public CementSlurryType_1_0_0Data? Data { get; set; }

}

public class CementSlurryType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
