...
/// <summary>
/// The Document Taxonomy provides a structured taxonomy for categorising document types. This taxonomy adheres to a consistent naming convention of a DISCIPLINE followed by a relevant DocumentType. In the practical implementation it uses a dot-based nomenclature e.g., &lt;DISCIPLINE&gt;.&lt;DocumentType&gt;, allowing for a two level hierarchy of the document type to support classification and search.
/// </summary>
public class DocumentTaxonomy_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-DocumentTaxonomy:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public DocumentTaxonomy_1_0_0Data? Data { get; set; }

}

public class DocumentTaxonomy_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
