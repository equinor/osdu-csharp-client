...
/// <summary>
/// To allow Data Provider/Operator to define the JSON payload template tailored to the API they are making requests to.
/// </summary>
public class PayloadTemplate_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-PayloadTemplate:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public PayloadTemplate_1_0_0Data? Data { get; set; }

}

public class PayloadTemplate_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
    /// <summary>
    /// The JSON object payload template to be used for the API request.
    /// </summary>
