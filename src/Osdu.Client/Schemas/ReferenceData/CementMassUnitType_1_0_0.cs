...
/// <summary>
/// Cement Mass unit type to be defined to give necessary context to other volume and mass calculations.
/// </summary>
public class CementMassUnitType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-CementMassUnitType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public CementMassUnitType_1_0_0Data? Data { get; set; }

}

public class CementMassUnitType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
