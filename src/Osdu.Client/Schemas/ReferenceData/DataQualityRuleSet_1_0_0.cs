...
/// <summary>
/// A set of data quality rules to assess a specific aspect in the trustworthiness of data. It can
/// </summary>
public class DataQualityRuleSet_1_0_0
{
    /// <summary>
    ...
    public DataQualityRuleSet_1_0_0Data? Data { get; set; }

}

public class DataQualityRuleSet_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
    /// <summary>
    ...
    public List<DataQualityRuleSet_1_0_0DataDataRules> DataRules { get; set; }
...
public class DataQualityRuleSet_1_0_0DataDataRules
{
    /// <summary>
