...
/// <summary>
/// ColumnBasedTableType holds the values for the various possible and non exhaustive column based table types.
/// </summary>
public class ColumnBasedTableType_1_1_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-ColumnBasedTableType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public ColumnBasedTableType_1_1_0Data? Data { get; set; }

}

public class ColumnBasedTableType_1_1_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
    /// <summary>
