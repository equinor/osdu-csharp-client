...
/// <summary>
/// Wellbore Hold Up Depth type
/// </summary>
public class HoldUpDepthType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-HoldUpDepthType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public HoldUpDepthType_1_0_0Data? Data { get; set; }

}

public class HoldUpDepthType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
