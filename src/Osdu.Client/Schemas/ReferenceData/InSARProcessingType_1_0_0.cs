...
/// <summary>
/// Describes what main process or workflow manipulated the data before arriving at its current state or that it is as acquired
/// </summary>
public class InSARProcessingType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-InSARProcessingType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public InSARProcessingType_1_0_0Data? Data { get; set; }

}

public class InSARProcessingType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
