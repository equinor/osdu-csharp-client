...
/// <summary>
/// The type of vertical distance of a point in a well relative to a defined reference point.
/// </summary>
public class VerticalMeasurementPath_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-VerticalMeasurementPath:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public VerticalMeasurementPath_1_0_0Data? Data { get; set; }

}

public class VerticalMeasurementPath_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
