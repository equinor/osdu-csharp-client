...
/// <summary>
/// DEPRECATED: Please use SampleType and SampleAcquisitionToolFamily as appropriate. A type of sidewall core based on the method of collection.
/// </summary>
public class SidewallCoreType_1_0_2
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-SidewallCoreType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public SidewallCoreType_1_0_2Data? Data { get; set; }

}

public class SidewallCoreType_1_0_2Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
