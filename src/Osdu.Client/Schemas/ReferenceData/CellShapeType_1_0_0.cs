...
/// <summary>
/// An enumeration of cell shape types based on the RESQML model, i.e. tetrahedral, pyramidal, prism, hexahedral, polyhedral.
/// </summary>
public class CellShapeType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-CellShapeType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public CellShapeType_1_0_0Data? Data { get; set; }

}

public class CellShapeType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
