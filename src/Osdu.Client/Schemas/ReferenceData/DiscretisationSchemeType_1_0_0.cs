...
/// <summary>
/// Describes geometrically where in a discretised cell representation of a velocity number field the value applies, such as vertex, cell center, average across cell.
/// </summary>
public class DiscretisationSchemeType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-DiscretisationSchemeType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public DiscretisationSchemeType_1_0_0Data? Data { get; set; }

}

public class DiscretisationSchemeType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
