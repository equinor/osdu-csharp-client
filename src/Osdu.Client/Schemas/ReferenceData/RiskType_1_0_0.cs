...
/// <summary>
/// Proposed reference values: risk, event, near miss, best practice, lessons learned, other, unknown
/// </summary>
public class RiskType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-RiskType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public RiskType_1_0_0Data? Data { get; set; }

}

public class RiskType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
