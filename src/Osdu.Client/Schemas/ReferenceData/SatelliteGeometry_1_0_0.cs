...
/// <summary>
/// the reference value type defining the orbit or flight direction of the satellite over the image area
/// </summary>
public class SatelliteGeometry_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-SatelliteGeometry:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public SatelliteGeometry_1_0_0Data? Data { get; set; }

}

public class SatelliteGeometry_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
