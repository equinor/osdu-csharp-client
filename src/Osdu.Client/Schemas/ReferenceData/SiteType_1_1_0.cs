...
/// <summary>
/// Identifies the type of non-facility location (e.g. beach, oil seep, outcrop, sinkhole) that can be used for energy industry related activities, such as the collection of a rock or fluid sample. Being different from a facility, a generic site is usually a natural location, not a man-made structure or a grouping of equipment.
/// </summary>
public class SiteType_1_1_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-SiteType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public SiteType_1_1_0Data? Data { get; set; }

}

public class SiteType_1_1_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
