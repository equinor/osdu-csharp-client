...
/// <summary>
/// Method of determining/measuring or estimating/calculating the Top Of Cement (TOC). TOC is the top of the Cement column.
/// </summary>
public class CementTOCLocateMethod_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-CementTOCLocateMethod:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public CementTOCLocateMethod_1_0_0Data? Data { get; set; }

}

public class CementTOCLocateMethod_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
