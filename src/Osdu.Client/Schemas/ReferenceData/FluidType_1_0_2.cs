...
/// <summary>
/// DEPRECATED: Superseded by reference-data--WellFluidType. Type of drilling or completions fluid.
/// </summary>
public class FluidType_1_0_2
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-FluidType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public FluidType_1_0_2Data? Data { get; set; }

}

public class FluidType_1_0_2Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
