...
/// <summary>
/// The direction of flow into, or out of the entity to which a production value recorded is associated
/// OR
/// HAL : "This table is used to store information for the types of volumes flow . Ex. Open Inventory , Closing Inventory, Production, Injection Disposition."
/// </summary>
public class VolumeFlowMeasurementType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-VolumeFlowMeasurementType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public VolumeFlowMeasurementType_1_0_0Data? Data { get; set; }

}

public class VolumeFlowMeasurementType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
