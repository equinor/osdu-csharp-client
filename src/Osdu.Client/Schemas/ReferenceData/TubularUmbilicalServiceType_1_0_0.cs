...
/// <summary>
/// Used to describe the service the umbilical is designed for (such as "Standard", "H2S Sour Service",...).
/// </summary>
public class TubularUmbilicalServiceType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-TubularUmbilicalServiceType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public TubularUmbilicalServiceType_1_0_0Data? Data { get; set; }

}

public class TubularUmbilicalServiceType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
