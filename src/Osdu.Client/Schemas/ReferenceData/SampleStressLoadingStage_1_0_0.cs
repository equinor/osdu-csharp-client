...
/// </summary>
public class SampleStressLoadingStage_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-SampleStressLoadingStage:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public SampleStressLoadingStage_1_0_0Data? Data { get; set; }

}

public class SampleStressLoadingStage_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
