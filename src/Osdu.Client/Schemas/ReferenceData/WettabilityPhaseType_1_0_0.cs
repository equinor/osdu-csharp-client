...
/// <summary>
/// Identifies how a liquid phase interacts with a dissimilar solid or liquid phase, such as by spreading out and adhering to a solid surface or by forming droplets on it. This behavior is largely defined by the contact angle, where a smaller angle indicates better wetting properties, and a larger angle indicates poor wetting.
/// </summary>
public class WettabilityPhaseType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-WettabilityPhaseType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public WettabilityPhaseType_1_0_0Data? Data { get; set; }

}

public class WettabilityPhaseType_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
