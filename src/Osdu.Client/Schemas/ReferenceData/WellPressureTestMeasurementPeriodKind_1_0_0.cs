...
/// <summary>
/// In Well Pressure Test - records can be splitted in small individual, discrete events or periods. This captures the type of period/events
/// </summary>
public class WellPressureTestMeasurementPeriodKind_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-WellPressureTestMeasurementPeriodKind:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public WellPressureTestMeasurementPeriodKind_1_0_0Data? Data { get; set; }

}

public class WellPressureTestMeasurementPeriodKind_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
