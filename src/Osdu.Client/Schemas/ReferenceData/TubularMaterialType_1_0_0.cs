...
/// <summary>
/// The general or specific description of the material used to make tubular goods (casing, pipe, etc.)
/// </summary>
public class TubularMaterialType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-TubularMaterialType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public TubularMaterialType_1_0_0Data? Data { get; set; }

}

public class TubularMaterialType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
