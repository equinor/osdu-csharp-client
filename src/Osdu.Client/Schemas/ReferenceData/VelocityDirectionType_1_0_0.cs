...
/// <summary>
/// Direction or orientation associated with the velocity model such as vertical, dip-azimuth.
/// </summary>
public class VelocityDirectionType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-VelocityDirectionType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public VelocityDirectionType_1_0_0Data? Data { get; set; }

}

public class VelocityDirectionType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
