...
/// <summary>
/// Method used by the RSS to direct the deviation of the trajectory: point the bit or push the bit
/// </summary>
public class RotarySteerableDeflectionMethod_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-RotarySteerableDeflectionMethod:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public RotarySteerableDeflectionMethod_1_0_0Data? Data { get; set; }

}

public class RotarySteerableDeflectionMethod_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
