...
/// <summary>
/// Describes the boundary relation of a body with surrounding stratigraphic units: unconformable, conformable
/// </summary>
public class BoundaryRelationType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-BoundaryRelationType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public BoundaryRelationType_1_0_0Data? Data { get; set; }

}

public class BoundaryRelationType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
