...
/// </summary>
public class PetroleumSystemElementType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-PetroleumSystemElementType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public PetroleumSystemElementType_1_0_0Data? Data { get; set; }

}

public class PetroleumSystemElementType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
