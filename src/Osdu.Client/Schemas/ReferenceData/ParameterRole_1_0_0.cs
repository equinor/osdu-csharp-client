...
/// <summary>
/// Reference value type describing how an activity  parameter was used by an activity, such as input, output, control, constraint, agent, predecessor activity, successor activity.
/// </summary>
public class ParameterRole_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-ParameterRole:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public ParameterRole_1_0_0Data? Data { get; set; }

}

public class ParameterRole_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
