...
/// <summary>
/// Well Barrier Element test sub-types for the barrier component being tested such as Subsea BOP interval test, Surface BOP test, Surface PCE test, Wireline PCE Test
/// </summary>
public class TestSubType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-TestSubType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public TestSubType_1_0_0Data? Data { get; set; }

}

public class TestSubType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
