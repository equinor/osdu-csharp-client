...
/// </summary>
public class IsolatedIntervalCementOption_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-IsolatedIntervalCementOption:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public IsolatedIntervalCementOption_1_0_0Data? Data { get; set; }

}

public class IsolatedIntervalCementOption_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
