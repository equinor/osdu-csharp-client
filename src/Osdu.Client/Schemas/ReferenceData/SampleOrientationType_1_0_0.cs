...
/// <summary>
/// The sample orientation direction, which describes the core sample's relationship to the bedding or drilling direction.
/// </summary>
public class SampleOrientationType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-SampleOrientationType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public SampleOrientationType_1_0_0Data? Data { get; set; }

}

public class SampleOrientationType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
