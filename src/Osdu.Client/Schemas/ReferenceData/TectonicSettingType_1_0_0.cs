...
/// <summary>
/// Reference object to offer a list of values to describe the Tectonic Setting - which is a scenario used for Planning and Pore Pressure Practitioners - such as 'Strike Slip'
/// </summary>
public class TectonicSettingType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-TectonicSettingType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public TectonicSettingType_1_0_0Data? Data { get; set; }

}

public class TectonicSettingType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
