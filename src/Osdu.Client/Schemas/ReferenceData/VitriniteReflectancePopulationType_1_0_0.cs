...
/// <summary>
/// Identifies the relative state of vitrinite reflectance as a result of thermal alteration, also called thermal maturity.
/// </summary>
public class VitriniteReflectancePopulationType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-VitriniteReflectancePopulationType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public VitriniteReflectancePopulationType_1_0_0Data? Data { get; set; }

}

public class VitriniteReflectancePopulationType_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
