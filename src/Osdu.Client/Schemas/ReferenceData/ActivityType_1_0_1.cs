...
/// <summary>
/// DEPRECATED: please use TubularAssemblyActivityType instead. Used to describe the type of activity the data results - such as RunActivity, PullActivity,...
/// </summary>
public class ActivityType_1_0_1
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-ActivityType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public ActivityType_1_0_1Data? Data { get; set; }

}

public class ActivityType_1_0_1Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
