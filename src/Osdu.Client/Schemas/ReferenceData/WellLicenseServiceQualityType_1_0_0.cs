...
/// <summary>
/// Service Quality is the perspective of the customer on the reliability or other factors about the performance of a business associate in the context of a Well License.
/// </summary>
public class WellLicenseServiceQualityType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-WellLicenseServiceQualityType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public WellLicenseServiceQualityType_1_0_0Data? Data { get; set; }

}

public class WellLicenseServiceQualityType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
