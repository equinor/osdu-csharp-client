...
/// <summary>
/// The method of porosity measurement used to determine basic rock properties by routine core analysis (RCA) and crushed rock analysis. Not for special core analysis.
/// </summary>
public class PorosityMeasurementType_1_0_1
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-PorosityMeasurementType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public PorosityMeasurementType_1_0_1Data? Data { get; set; }

}

public class PorosityMeasurementType_1_0_1Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
