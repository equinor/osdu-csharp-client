...
/// <summary>
/// Role of the contact within the associated organisation, such as Account owner, Sales Representative, Technical Support, Project Manager, Party Chief, Client Representative, Senior Observer.
/// </summary>
public class ContactRoleType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-ContactRoleType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public ContactRoleType_1_0_0Data? Data { get; set; }

}

public class ContactRoleType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
