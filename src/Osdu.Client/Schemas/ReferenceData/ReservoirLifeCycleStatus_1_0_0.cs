...
/// <summary>
/// The Life Cycle Status of the Reservoir or ReservoirSegment, a concept which is typically chronological.
/// </summary>
public class ReservoirLifeCycleStatus_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-ReservoirLifeCycleStatus:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public ReservoirLifeCycleStatus_1_0_0Data? Data { get; set; }

}

public class ReservoirLifeCycleStatus_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
