...
/// <summary>
/// The Deposition Geometry classification (corresponding to Energistics RESQML DepositionMode). Examples are parallel to top, parallel to bottom, etc.
/// </summary>
public class DepositionGeometryType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-DepositionGeometryType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public DepositionGeometryType_1_0_0Data? Data { get; set; }

}

public class DepositionGeometryType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
