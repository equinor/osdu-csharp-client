...
/// <summary>
/// Specific chemical compounds, such as alkanes, hopanes and steranes, used in Isotope Analysis.
/// </summary>
public class CompoundSpecificIsotopeComponents_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-CompoundSpecificIsotopeComponents:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public CompoundSpecificIsotopeComponents_1_0_0Data? Data { get; set; }

}

public class CompoundSpecificIsotopeComponents_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
