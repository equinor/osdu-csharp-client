...
/// </summary>
public class RiskConsequenceSubCategory_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-RiskConsequenceSubCategory:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
...
public class RiskConsequenceSubCategory_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
    /// <summary>
    ...
    [JsonPropertyName("RiskConsequenceCategoryID")]
    public string RiskConsequenceCategoryID { get; set; }
