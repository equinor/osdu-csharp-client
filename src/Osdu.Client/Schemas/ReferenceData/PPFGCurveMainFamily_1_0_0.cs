...
/// <summary>
/// Reflects the Geological Physical Quantity measured within the PPFG Curve - can be 'Pore Pressure', 'FractureGradient', 'HorizontalStress'...
/// </summary>
public class PPFGCurveMainFamily_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-PPFGCurveMainFamily:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public PPFGCurveMainFamily_1_0_0Data? Data { get; set; }

}

public class PPFGCurveMainFamily_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
