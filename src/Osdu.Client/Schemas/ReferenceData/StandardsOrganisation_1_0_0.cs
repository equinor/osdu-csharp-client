...
/// <summary>
/// The reference-data type holding a StandardsOrganisation, e.g. ISO, IOGP, Energistics, etc. The main purpose is to define organisations, which provide alias names to reference-data.
/// </summary>
public class StandardsOrganisation_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-StandardsOrganisation:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public StandardsOrganisation_1_0_0Data? Data { get; set; }

}

public class StandardsOrganisation_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
