...
/// <summary>
/// DEPRECATED: (not used anywhere) Object that describes the actual planning status of an object - such as Tubular Assembly - to indicate if it is planned, concrete, prototyped or any other relevant status.
/// </summary>
public class ActualIndicatorType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-ActualIndicatorType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public ActualIndicatorType_1_0_0Data? Data { get; set; }

}

public class ActualIndicatorType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
