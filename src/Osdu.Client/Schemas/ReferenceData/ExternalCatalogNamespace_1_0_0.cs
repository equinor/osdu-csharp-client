...
/// <summary>
/// A namespace for a group of catalog records. This is used in conjunction with external catalogs to group records of a particular kind belonging together to achieve unique code and name look-ups.
/// </summary>
public class ExternalCatalogNamespace_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-ExternalCatalogNamespace:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public ExternalCatalogNamespace_1_0_0Data? Data { get; set; }

}

public class ExternalCatalogNamespace_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
