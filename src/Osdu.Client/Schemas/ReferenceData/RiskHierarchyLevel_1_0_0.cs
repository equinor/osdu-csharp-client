...
/// <summary>
/// Area within organisation where risks will be most applicable, includes Well-level, Field-level, Region-level, Global-level
/// </summary>
public class RiskHierarchyLevel_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-RiskHierarchyLevel:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public RiskHierarchyLevel_1_0_0Data? Data { get; set; }

}

public class RiskHierarchyLevel_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
