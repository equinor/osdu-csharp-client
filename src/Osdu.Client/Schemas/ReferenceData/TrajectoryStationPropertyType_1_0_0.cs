...
/// <summary>
/// The trajectory station property catalog for e.g. WellboreTrajectory AvailableTrajectoryStationProperties. Similar to LogCurveType the TrajectoryStationPropertyType describes well-known properties (or curves or channels in an array view), which can be accessed via the Wellbore Domain Data Management Services.
/// </summary>
public class TrajectoryStationPropertyType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-TrajectoryStationPropertyType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public TrajectoryStationPropertyType_1_0_0_Data? Data { get; set; }

}

public class TrajectoryStationPropertyType_1_0_0_Data : AbstractCommonResources_1_0_0 // Also composes: AbstractReferenceType_1_0_0, AbstractReferencePropertyType_1_0_0
{
    /// <summary>
