...
/// <summary>
/// Workflow status for the state of the Activity, e.g., Planned, InProgress, Completed and more. This is a OPEN value list. State transitions follow the activity's life cycle.
/// </summary>
public class ActivityStatus_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-ActivityStatus:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public ActivityStatus_1_0_0Data? Data { get; set; }

}

public class ActivityStatus_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
