...
/// <summary>
/// A list of hierarchical Well Operations Reporting Codes. OSDU Data Definition delivered content is considered a default, which can be extended by operators. Extensions should avoid re-defining OSDU codes by applying namespace prefixes; populating the AttributionAuthority is also recommended.
/// </summary>
public class ActivityCode_1_0_1
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-ActivityCode:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public ActivityCode_1_0_1Data? Data { get; set; }

}

public class ActivityCode_1_0_1Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
    /// <summary>
    /// The relationship to the ActivityLevel record describing the ActivityCode's position in the hierarchy.
    /// </summary>
