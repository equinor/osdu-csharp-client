...
/// <summary>
/// The IADC list of Bit Types
/// </summary>
public class BitType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-BitType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public BitType_1_0_0Data? Data { get; set; }

}

public class BitType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
