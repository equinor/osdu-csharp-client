...
/// </summary>
public class ChronoStratigraphy_1_1_0
{
    /// <summary>
...
public class ChronoStratigraphy_1_1_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
    /// <summary>
    /// The scheme this record is belonging to. The name of the record is expected to be unique within the given scheme.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-ChronoStratigraphicScheme:[\w\-\.\:\%]+:[0-9]*$")]
    [JsonPropertyName("ChronoStratigraphicSchemeID")]
    public string ChronoStratigraphicSchemeID { get; set; }
