...
/// <summary>
/// The super class of Depositional Environment, referred to by DepositionalEnvironment and DepositionalSubEnvironment, which further detail the environment.
/// </summary>
public class DepositionalGrossEnvironment_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-DepositionalGrossEnvironment:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public DepositionalGrossEnvironment_1_0_0Data? Data { get; set; }

}

public class DepositionalGrossEnvironment_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
