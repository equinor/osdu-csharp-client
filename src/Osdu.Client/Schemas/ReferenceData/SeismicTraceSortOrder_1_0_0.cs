...
/// <summary>
/// The types of sorting orders for pre-stack seismic datasets. It describes the trace order of the persisted dataset.
/// </summary>
public class SeismicTraceSortOrder_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-SeismicTraceSortOrder:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public SeismicTraceSortOrder_1_0_0Data? Data { get; set; }

}

public class SeismicTraceSortOrder_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
