...
/// <summary>
/// A liquid, solid or gaseous substance used to manipulate the function or properties of a fluid.
/// </summary>
public class AdditiveType_1_0_1
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-AdditiveType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public AdditiveType_1_0_1Data? Data { get; set; }

}

public class AdditiveType_1_0_1Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
