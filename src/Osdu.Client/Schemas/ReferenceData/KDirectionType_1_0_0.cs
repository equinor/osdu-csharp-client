...
/// <summary>
/// An enumeration for the K-Direction based on the RESQML model, i.e. up, down, not monotonic.
/// </summary>
public class KDirectionType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-KDirectionType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public KDirectionType_1_0_0Data? Data { get; set; }

}

public class KDirectionType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
