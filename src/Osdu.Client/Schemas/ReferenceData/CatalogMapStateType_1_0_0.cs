...
/// <summary>
/// A qualification of a mapping between catalog items. Mappings can be between 'identical' items, similar but not identical items or not supported.
/// </summary>
public class CatalogMapStateType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-CatalogMapStateType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public CatalogMapStateType_1_0_0Data? Data { get; set; }

}

public class CatalogMapStateType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
