...
/// <summary>
/// Values that capture the saturation dynamics - that is, whether water, oil, or gas is increasing, decreasing, or remaining constant, and the cycle number.
/// </summary>
public class WOGnCycleNotation_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-WOGnCycleNotation:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public WOGnCycleNotation_1_0_0Data? Data { get; set; }

}

public class WOGnCycleNotation_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
