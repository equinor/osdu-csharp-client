...
/// <summary>
/// Sequence Stratigraphic Schema type, valid if Stratigraphic Column role type is set to Chronostratigraphic
/// </summary>
public class SequenceStratigraphicSchemaType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-SequenceStratigraphicSchemaType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public SequenceStratigraphicSchemaType_1_0_0Data? Data { get; set; }

}

public class SequenceStratigraphicSchemaType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
