...
/// <summary>
/// Downhole Depth Measurement Type
/// </summary>
public class DepthMeasurementType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-DepthMeasurementType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public DepthMeasurementType_1_0_0Data? Data { get; set; }

}

public class DepthMeasurementType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
