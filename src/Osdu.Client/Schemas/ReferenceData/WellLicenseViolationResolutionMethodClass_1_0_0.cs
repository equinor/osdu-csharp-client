...
/// <summary>
/// A classification of kinds of violations. This is a broad grouping of violations that can be used for metrics and other analysis.
/// </summary>
public class WellLicenseViolationResolutionMethodClass_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-WellLicenseViolationResolutionMethodClass:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public WellLicenseViolationResolutionMethodClass_1_0_0Data? Data { get; set; }

}

public class WellLicenseViolationResolutionMethodClass_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
