...
/// <summary>
/// A status attribute of the Cement plug (whether it is installed in place or has since changed status, including drill out, dressed, etc.).
/// </summary>
public class CementPlugStatusType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-CementPlugStatusType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public CementPlugStatusType_1_0_0Data? Data { get; set; }

}

public class CementPlugStatusType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
