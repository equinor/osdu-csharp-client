...
/// <summary>
/// The technique used to remove oil or water from the rock sample, usually in preparation for lab analysis.
/// </summary>
public class DesaturationMethod_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-DesaturationMethod:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public DesaturationMethod_1_0_0Data? Data { get; set; }

}

public class DesaturationMethod_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
