...
/// <summary>
/// Reference data for header names of standard fields used in storage file formats, such as CDPX, INLINE in SEGY.
/// </summary>
public class HeaderKeyName_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-HeaderKeyName:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public HeaderKeyName_1_0_0Data? Data { get; set; }

}

public class HeaderKeyName_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
