...
/// </summary>
public class PerforationGunPhasingType_1_0_1
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-PerforationGunPhasingType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public PerforationGunPhasingType_1_0_1Data? Data { get; set; }

}

public class PerforationGunPhasingType_1_0_1Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
