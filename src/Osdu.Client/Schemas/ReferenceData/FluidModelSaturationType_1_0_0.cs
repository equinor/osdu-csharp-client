...
/// <summary>
/// The list of the phase behavior systems, assigned to the saturation type, that are used by the simulator to equilibrate the model (e.g. bubble point, etc).
/// </summary>
public class FluidModelSaturationType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-FluidModelSaturationType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public FluidModelSaturationType_1_0_0Data? Data { get; set; }

}

public class FluidModelSaturationType_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
