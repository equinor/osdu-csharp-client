...
/// <summary>
/// The type of X Ray detector used for a sample image, for example, Wavelength Dispersive Detector WDS/WDX) and Energy Dispersive Detector (EDS/EDX).
/// </summary>
public class SampleImageXRayDetector_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-SampleImageXRayDetector:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public SampleImageXRayDetector_1_0_0Data? Data { get; set; }

}

public class SampleImageXRayDetector_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
