...
/// <summary>
/// The PPFG Curve Family reflects the level of probability associated to the Curve - defined by any company - could be 'Most Likely', 'Min Case',...
/// </summary>
public class PPFGCurveProbability_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-PPFGCurveProbability:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public PPFGCurveProbability_1_0_0Data? Data { get; set; }

}

public class PPFGCurveProbability_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
