...
/// <summary>
/// The type of fluid being displaced from the rock sample during saturation or desaturation measurements.
/// </summary>
public class DisplacedFluidType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-DisplacedFluidType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public DisplacedFluidType_1_0_0Data? Data { get; set; }

}

public class DisplacedFluidType_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
