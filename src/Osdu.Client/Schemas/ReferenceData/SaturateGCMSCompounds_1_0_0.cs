...
/// <summary>
/// Saturates are saturated hydrocarbons, which means they contain only single bonds between carbon atoms and are saturated with hydrogen atoms. These compounds are also known as alkanes or paraffins and have the general formula CnH2n+2.
/// </summary>
public class SaturateGCMSCompounds_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-SaturateGCMSCompounds:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public SaturateGCMSCompounds_1_0_0Data? Data { get; set; }

}

public class SaturateGCMSCompounds_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
