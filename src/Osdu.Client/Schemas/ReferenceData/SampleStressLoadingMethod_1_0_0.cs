...
/// <summary>
/// Identifies the method by which pressure is applied to the sample, whether continuously or in one or multiple stages.
/// </summary>
public class SampleStressLoadingMethod_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-SampleStressLoadingMethod:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public SampleStressLoadingMethod_1_0_0Data? Data { get; set; }

}

public class SampleStressLoadingMethod_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
