...
/// <summary>
/// The technique or medium used to mount a vitrinite sample for analysis, e.g. epoxy resin or impregnation with a low-viscosity liquid.
/// </summary>
public class VitriniteMountTechnique_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-VitriniteMountTechnique:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public VitriniteMountTechnique_1_0_0Data? Data { get; set; }

}

public class VitriniteMountTechnique_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
