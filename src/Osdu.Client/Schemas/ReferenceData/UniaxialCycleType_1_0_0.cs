...
/// <summary>
/// The cycle type identifies whether a pressure cycle is loading or unloading, to include preliminary cycles used to precondition or assess initial response and the main test pressure cycles.
/// </summary>
public class UniaxialCycleType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-UniaxialCycleType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public UniaxialCycleType_1_0_0Data? Data { get; set; }

}

public class UniaxialCycleType_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
