...
/// <summary>
/// Well Business Interest [Well Interest Type] describes whether a company currently considers a well entity or its data to be a real or planned asset, and if so, the nature of and motivation for that company's interest.
/// </summary>
public class WellInterestType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-WellInterestType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public WellInterestType_1_0_0Data? Data { get; set; }

}

public class WellInterestType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
