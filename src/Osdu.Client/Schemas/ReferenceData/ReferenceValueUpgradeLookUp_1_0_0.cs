...
/// <summary>
/// ReferenceValueUpgradeLookUp provides a list of reference-data usages, associated to a look-up table from deprecated to superseded reference values.
/// </summary>
public class ReferenceValueUpgradeLookUp_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-ReferenceValueUpgradeLookUp:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public ReferenceValueUpgradeLookUp_1_0_0_Data? Data { get; set; }

}

public class ReferenceValueUpgradeLookUp_1_0_0_Data : AbstractCommonResources_1_0_0 // Also composes: AbstractReferenceType_1_0_0, AbstractReferenceValueUpgrade_1_0_0
{
    /// <summary>
