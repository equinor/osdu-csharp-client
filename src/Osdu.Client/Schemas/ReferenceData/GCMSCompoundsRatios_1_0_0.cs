...
/// <summary>
/// Identifies specific ratios between compounds or groupings of compounds useful in Gas Chromatography Mass Spectrometry.
/// </summary>
public class GCMSCompoundsRatios_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-GCMSCompoundsRatios:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public GCMSCompoundsRatios_1_0_0Data? Data { get; set; }

}

public class GCMSCompoundsRatios_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
