...
/// <summary>
/// The type of a representation, such as, for example, 'PointSet', 'Polyline', 'PolylineSet', 'TriangulatedSurface', etc.
/// </summary>
public class RepresentationType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-RepresentationType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public RepresentationType_1_0_0Data? Data { get; set; }

}

public class RepresentationType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
