...
/// </summary>
public class TubularExtCompAttachMechanism_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-TubularExtCompAttachMechanism:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public TubularExtCompAttachMechanism_1_0_0Data? Data { get; set; }

}

public class TubularExtCompAttachMechanism_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
