...
/// <summary>
/// The type of hydrocarbon reservoir described (Could be conventional or oil sands deposit - Could also refers to the reason: administrative reasons or for geologic definitions.
/// </summary>
public class ReservoirType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-ReservoirType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public ReservoirType_1_0_0Data? Data { get; set; }

}

public class ReservoirType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
