...
/// <summary>
/// List of biostratigraphic disciplines which are defined by the fossil group analysed, e.g., palynology.
/// </summary>
public class BiostratigraphicDiscipline_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-BiostratigraphicDiscipline:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public BiostratigraphicDiscipline_1_0_0Data? Data { get; set; }

}

public class BiostratigraphicDiscipline_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
