...
/// <summary>
/// Describes what main process or workflow manipulated the data before arriving at its current state or that it is as acquired in the field, such as partial processing, migration, modeling result, synthetic model, inversion, phase rotation.
/// </summary>
public class SeismicProcessingStageType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-SeismicProcessingStageType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public SeismicProcessingStageType_1_0_0Data? Data { get; set; }

}

public class SeismicProcessingStageType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
