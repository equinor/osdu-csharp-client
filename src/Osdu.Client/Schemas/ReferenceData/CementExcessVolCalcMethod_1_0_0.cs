...
/// <summary>
/// The method used to derive the planned excess volume of Cement slurry pumped. The method is not limited to measurements or software simulations.
/// </summary>
public class CementExcessVolCalcMethod_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-CementExcessVolCalcMethod:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public CementExcessVolCalcMethod_1_0_0Data? Data { get; set; }

}

public class CementExcessVolCalcMethod_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
