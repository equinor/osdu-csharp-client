...
/// <summary>
/// Identifies the type of pore pressure control during the pressure test, such as constant or depletion.
/// </summary>
public class UniaxialTestControlType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-UniaxialTestControlType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public UniaxialTestControlType_1_0_0Data? Data { get; set; }

}

public class UniaxialTestControlType_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
