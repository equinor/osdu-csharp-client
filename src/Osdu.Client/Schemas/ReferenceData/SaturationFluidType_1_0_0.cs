...
/// <summary>
/// The type of fluid used to saturate (fill the pore spaces) of the rock sample during lab analysis; e.g. water, gas, or oil.
/// </summary>
public class SaturationFluidType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-SaturationFluidType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public SaturationFluidType_1_0_0Data? Data { get; set; }

}

public class SaturationFluidType_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
