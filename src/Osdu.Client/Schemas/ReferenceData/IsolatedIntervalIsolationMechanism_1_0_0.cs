...
/// <summary>
/// Isolated interval isolation mechanism, for example, Swellable Packers, Cement, Hydraulic Swell Packers, Inflatable Packers, etc.
/// </summary>
public class IsolatedIntervalIsolationMechanism_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-IsolatedIntervalIsolationMechanism:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public IsolatedIntervalIsolationMechanism_1_0_0Data? Data { get; set; }

}

public class IsolatedIntervalIsolationMechanism_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
