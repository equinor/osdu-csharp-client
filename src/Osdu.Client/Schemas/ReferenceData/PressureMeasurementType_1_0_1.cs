...
/// <summary>
/// The actual or theoretical pressure conditions applied to a rock or fluid sample during an experiment.
/// </summary>
public class PressureMeasurementType_1_0_1
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-PressureMeasurementType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public PressureMeasurementType_1_0_1Data? Data { get; set; }

}

public class PressureMeasurementType_1_0_1Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
