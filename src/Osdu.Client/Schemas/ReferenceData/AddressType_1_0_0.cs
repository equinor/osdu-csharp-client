...
/// <summary>
/// Descriptive phrase that classifies the address type (HomeAddress, BusinessAddress, BillingAddress, ShippingAddress).
/// </summary>
public class AddressType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-AddressType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public AddressType_1_0_0Data? Data { get; set; }

}

public class AddressType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
