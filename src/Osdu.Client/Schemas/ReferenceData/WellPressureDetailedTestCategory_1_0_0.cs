...
/// <summary>
/// Indicates which detailed type of test (DST, miniDST, sampling,…) has been conducted within a well pressure test
/// </summary>
public class WellPressureDetailedTestCategory_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-WellPressureDetailedTestCategory:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public WellPressureDetailedTestCategory_1_0_0Data? Data { get; set; }

}

public class WellPressureDetailedTestCategory_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
