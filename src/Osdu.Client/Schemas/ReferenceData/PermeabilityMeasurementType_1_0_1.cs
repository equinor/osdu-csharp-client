...
/// <summary>
/// The method used in routine core analysis to measure the ability of gas or fluid to flow through a sample.
/// </summary>
public class PermeabilityMeasurementType_1_0_1
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-PermeabilityMeasurementType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public PermeabilityMeasurementType_1_0_1Data? Data { get; set; }

}

public class PermeabilityMeasurementType_1_0_1Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
