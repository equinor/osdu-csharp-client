...
/// <summary>
/// Types of Drilling Rigs. Possible reference values: Barge, Coiled Tubing, Floater, Jackup, Land, Platform, Semi_Submersible, Unknown.
/// </summary>
public class RigType_1_0_1
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-RigType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public RigType_1_0_1Data? Data { get; set; }

}

public class RigType_1_0_1Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
