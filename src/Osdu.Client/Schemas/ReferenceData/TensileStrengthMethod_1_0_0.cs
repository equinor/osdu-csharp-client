...
/// <summary>
/// The method by which a sample's ability to resist tearing under tension was measured or calculated.
/// </summary>
public class TensileStrengthMethod_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-TensileStrengthMethod:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public TensileStrengthMethod_1_0_0Data? Data { get; set; }

}

public class TensileStrengthMethod_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
