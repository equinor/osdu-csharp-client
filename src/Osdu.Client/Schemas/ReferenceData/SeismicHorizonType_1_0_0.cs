...
/// <summary>
/// Position on waveform where horizon is picked such as Peak (pk), Trough (tr), Plus to Minus Zero Crossing, Minus to Plus Zero Crossing, Envelope (env).
/// </summary>
public class SeismicHorizonType_1_0_0
{
    /// <summary>
    ...
    public SeismicHorizonType_1_0_0Data? Data { get; set; }

}

public class SeismicHorizonType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
