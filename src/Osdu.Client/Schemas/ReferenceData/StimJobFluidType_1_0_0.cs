...
/// <summary>
/// The Fluid Types and associated Sub-types which may be pumped during a Stimulation Job/Stage.
/// </summary>
public class StimJobFluidType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-StimJobFluidType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public StimJobFluidType_1_0_0Data? Data { get; set; }

}

public class StimJobFluidType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
