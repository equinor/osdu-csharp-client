...
/// <summary>
/// Status often serves as a shortcut to summarize information derived from one or more data systems. They may also imply legal or regulatory conditions or stipulations or serve as triggers for certain kinds of obligations.
/// </summary>
public class WellLicenseStatusClass_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-WellLicenseStatusClass:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public WellLicenseStatusClass_1_0_0Data? Data { get; set; }

}

public class WellLicenseStatusClass_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
