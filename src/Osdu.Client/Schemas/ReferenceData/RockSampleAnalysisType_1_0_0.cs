...
/// <summary>
/// A reference value catalog containing the names of the nested analysis objects in the work-product-component--RockSampleAnalysis. Examples are RoutineCoreAnalysis, GrainSizeAnalysis. Using these values it will be possible to query for RockSampleAnalysis records containing a specific kind of analysis. This list is fixed and governed by OSDU.
/// </summary>
public class RockSampleAnalysisType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-RockSampleAnalysisType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public RockSampleAnalysisType_1_0_0Data? Data { get; set; }

}

public class RockSampleAnalysisType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
