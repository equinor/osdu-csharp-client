...
/// <summary>
/// The process of selecting the optimal wave speed (velocity) to stack or migrate seismic traces.
/// </summary>
public class VelocityAnalysisMethod_1_0_1
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-VelocityAnalysisMethod:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public VelocityAnalysisMethod_1_0_1Data? Data { get; set; }

}

public class VelocityAnalysisMethod_1_0_1Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
