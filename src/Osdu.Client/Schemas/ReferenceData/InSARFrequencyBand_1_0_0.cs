...
/// <summary>
/// The reference value type defining the frequency band of the radar used for the image acquisition
/// </summary>
public class InSARFrequencyBand_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-InSARFrequencyBand:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public InSARFrequencyBand_1_0_0Data? Data { get; set; }

}

public class InSARFrequencyBand_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
