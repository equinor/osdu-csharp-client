...
/// <summary>
/// A specification of the role, which the representation in context plays. For example: 'Map', 'Pick', 'FaultCenterLine', 'InnerRing', 'OuterRing'.
/// </summary>
public class RepresentationRole_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-RepresentationRole:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public RepresentationRole_1_0_0Data? Data { get; set; }

}

public class RepresentationRole_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
