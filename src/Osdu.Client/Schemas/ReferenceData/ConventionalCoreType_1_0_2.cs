...
/// <summary>
/// DEPRECATED: Please use SampleType, ConventionalCoreCatcherType, SampleAcquisitionToolFamily, and ConventionalCoreInnerSleeveMaterial, as appropriate. An interval of rock core extracted from the bottom of a wellbore.
/// </summary>
public class ConventionalCoreType_1_0_2
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-ConventionalCoreType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public ConventionalCoreType_1_0_2Data? Data { get; set; }

}

public class ConventionalCoreType_1_0_2Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
