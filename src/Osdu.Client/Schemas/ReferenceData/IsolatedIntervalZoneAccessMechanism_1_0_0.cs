...
/// <summary>
/// Isolated interval zone access mechanism, for example, Abrasive Jet, Casing Deployed Perforations, Pump down, Plug &amp; Perf, Tubing Conveyed Perforation, Sliding Sleeves, etc.
/// </summary>
public class IsolatedIntervalZoneAccessMechanism_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-IsolatedIntervalZoneAccessMechanism:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public IsolatedIntervalZoneAccessMechanism_1_0_0Data? Data { get; set; }

}

public class IsolatedIntervalZoneAccessMechanism_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
