...
/// <summary>
/// Describes the type of initialisation applied for a specific reservoir simulation model. I.e., enumerated, equilibrium, or mixed.
/// </summary>
public class ReservoirSimulationInitialisationType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-ReservoirSimulationInitialisationType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public ReservoirSimulationInitialisationType_1_0_0Data? Data { get; set; }

}

public class ReservoirSimulationInitialisationType_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
