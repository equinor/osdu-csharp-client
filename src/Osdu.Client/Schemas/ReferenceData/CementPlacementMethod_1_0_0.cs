...
/// <summary>
/// Further details on the Cement plug placement methods (pump and pull, or balanced)  or chosen circulation path (reverse or forward).
/// </summary>
public class CementPlacementMethod_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-CementPlacementMethod:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public CementPlacementMethod_1_0_0Data? Data { get; set; }

}

public class CementPlacementMethod_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
