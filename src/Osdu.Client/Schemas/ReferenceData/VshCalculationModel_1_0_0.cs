...
/// <summary>
/// The volume of shale (Vsh) calculation models used to derive a Vsh output from gamma-ray (GR) measurements.
/// </summary>
public class VshCalculationModel_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-VshCalculationModel:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public VshCalculationModel_1_0_0Data? Data { get; set; }

}

public class VshCalculationModel_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
