...
/// <summary>
/// The data source location of the measured values acquired during a Formation Integrity Test.
/// </summary>
public class FormationIntegrityPressureDataSource_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-FormationIntegrityPressureDataSource:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public FormationIntegrityPressureDataSource_1_0_0Data? Data { get; set; }

}

public class FormationIntegrityPressureDataSource_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
