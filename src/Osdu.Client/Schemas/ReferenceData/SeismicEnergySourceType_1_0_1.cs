...
/// <summary>
/// The method of introducing seismic energy  into the earth. This list is about types of sources, not about types of seismic energy.
/// </summary>
public class SeismicEnergySourceType_1_0_1
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-SeismicEnergySourceType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public SeismicEnergySourceType_1_0_1Data? Data { get; set; }

}

public class SeismicEnergySourceType_1_0_1Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
