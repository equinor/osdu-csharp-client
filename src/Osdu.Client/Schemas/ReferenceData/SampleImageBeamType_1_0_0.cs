...
/// <summary>
/// The type of beam used in an electron microscope for a sample image, for example, electron or ion beam.
/// </summary>
public class SampleImageBeamType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-SampleImageBeamType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public SampleImageBeamType_1_0_0Data? Data { get; set; }

}

public class SampleImageBeamType_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
