...
/// <summary>
/// A governed purpose code for collections, e.g. 'Flow simulation output properties', 'Study', or similar.
/// </summary>
public class CollectionPurpose_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-CollectionPurpose:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public CollectionPurpose_1_0_0Data? Data { get; set; }

}

public class CollectionPurpose_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
