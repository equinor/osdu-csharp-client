...
/// <summary>
/// The textual label of a grain size classification interval. GrainSizeClassification codes are referred to by GrainSizeClassificationSchemes, which will associate an actual grain size range and optionally ASTM sieve number to a GrainSizeClassification.
/// </summary>
public class GrainSizeClassification_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-GrainSizeClassification:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public GrainSizeClassification_1_0_0Data? Data { get; set; }

}

public class GrainSizeClassification_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
