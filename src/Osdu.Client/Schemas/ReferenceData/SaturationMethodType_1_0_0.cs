...
/// <summary>
/// The method used to obtain the saturation measurement values, e.g., Dean Stark, Retort, Karl Fischer.
/// </summary>
public class SaturationMethodType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-SaturationMethodType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public SaturationMethodType_1_0_0Data? Data { get; set; }

}

public class SaturationMethodType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
