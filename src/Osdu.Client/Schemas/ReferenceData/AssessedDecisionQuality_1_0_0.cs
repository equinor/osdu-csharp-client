...
/// <summary>
/// It is a measure of how well a decision is made, taking into account factors such as the information available, the logic applied, and the potential consequences.
/// </summary>
public class AssessedDecisionQuality_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-AssessedDecisionQuality:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public AssessedDecisionQuality_1_0_0Data? Data { get; set; }

}

public class AssessedDecisionQuality_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
