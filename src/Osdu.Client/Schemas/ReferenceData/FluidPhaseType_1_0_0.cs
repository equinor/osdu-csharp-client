...
/// <summary>
/// The fluid phase present in a geological unit's pore space. Examples: aquifer, gas cap, oil column, etc.
/// </summary>
public class FluidPhaseType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-FluidPhaseType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public FluidPhaseType_1_0_0Data? Data { get; set; }

}

public class FluidPhaseType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
