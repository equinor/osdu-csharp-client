...
/// <summary>
/// The formal indexing schema for all reference-data entities, which do not contain any individual properties. ReferenceDataIndexTemplate is not supposed to be populated with reference values. No manifest is provided by OSDU.
/// </summary>
public class ReferenceDataIndexTemplate_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-ReferenceDataIndexTemplate:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public ReferenceDataIndexTemplate_1_0_0Data? Data { get; set; }

}

public class ReferenceDataIndexTemplate_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
