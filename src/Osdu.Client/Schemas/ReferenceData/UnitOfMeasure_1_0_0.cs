...
public class UnitOfMeasure_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
    /// <summary>
    ...
    /// <summary>
    /// The self-contained, stringified JSON reference for the unit. This value can be attached to data values and data records and carry the unit reference independent of a UnitOfRecord instance.
    /// </summary>
