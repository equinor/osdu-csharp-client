...
/// <summary>
/// The method used to calculate the phase saturation at the end face of a rock core - that is, the exposed circular end of the core.
/// </summary>
public class EndFaceEstimationMethod_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-EndFaceEstimationMethod:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public EndFaceEstimationMethod_1_0_0Data? Data { get; set; }

}

public class EndFaceEstimationMethod_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
