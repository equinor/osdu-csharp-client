...
/// <summary>
/// List of higher level grouping terms that are used to search for reservoir simulation models based on various aspects of model type (e.g., purpose).
/// </summary>
public class ReservoirSimulationTypeTag_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-ReservoirSimulationTypeTag:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
...
public class ReservoirSimulationTypeTag_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
    /// <summary>
    /// The category that classifies the reservoir simulation type tag more broadly for filtering purposes.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-ReservoirSimulationTypeTagCategory:[\w\-\.\:\%]+:[0-9]*$")]
    [JsonPropertyName("ReservoirSimulationTypeTagCategoryID")]
    public string ReservoirSimulationTypeTagCategoryID { get; set; }
