...
/// <summary>
/// Used to describe the resource lifecycle statuses, where the resource is in the process to ingest and release it.
/// </summary>
public class ResourceLifecycleStatus_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-ResourceLifecycleStatus:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public ResourceLifecycleStatus_1_0_0Data? Data { get; set; }

}

public class ResourceLifecycleStatus_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
