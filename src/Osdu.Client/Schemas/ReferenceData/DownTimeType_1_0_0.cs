...
/// <summary>
/// Specifies the loss caused by this event, or the type of the down time event is Planned, Unplanned or External.
/// </summary>
public class DownTimeType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-DownTimeType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public DownTimeType_1_0_0Data? Data { get; set; }

}

public class DownTimeType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
