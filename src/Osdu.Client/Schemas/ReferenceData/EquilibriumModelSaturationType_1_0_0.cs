...
/// <summary>
/// List of types of fluid saturation systems applicable to reservoir simulation equilibrium models.
/// </summary>
public class EquilibriumModelSaturationType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-EquilibriumModelSaturationType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public EquilibriumModelSaturationType_1_0_0Data? Data { get; set; }

}

public class EquilibriumModelSaturationType_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
