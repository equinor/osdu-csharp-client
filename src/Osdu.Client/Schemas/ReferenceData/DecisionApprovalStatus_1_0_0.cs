...
/// <summary>
/// The technical approval level for decisions, e.g., Peer Review, Discipline Expert, Holistic Integration.
/// </summary>
public class DecisionApprovalStatus_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-DecisionApprovalStatus:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public DecisionApprovalStatus_1_0_0Data? Data { get; set; }

}

public class DecisionApprovalStatus_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
