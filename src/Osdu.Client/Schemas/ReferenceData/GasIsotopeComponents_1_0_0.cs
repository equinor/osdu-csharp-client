...
/// </summary>
public class GasIsotopeComponents_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-GasIsotopeComponents:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
...
public class GasIsotopeComponents_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
