...
/// <summary>
/// The time period covered by a production value record. Examples include Day, Month, Year.
/// </summary>
public class ReportingPeriod_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-ReportingPeriod:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public ReportingPeriod_1_0_0Data? Data { get; set; }

}

public class ReportingPeriod_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
