...
/// <summary>
/// Class of trace stacking state - the dimension stacked along, like partial (offset), full, angle, azimuth.  May be qualified with range indicator such as Near, Mid, Far.
/// </summary>
public class SeismicStackingType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-SeismicStackingType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public SeismicStackingType_1_0_0Data? Data { get; set; }

}

public class SeismicStackingType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
