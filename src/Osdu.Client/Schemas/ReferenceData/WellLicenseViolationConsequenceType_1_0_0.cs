...
/// <summary>
/// The consequence of the violation as assigned by the regulatory or other authority, there may be more than one consequences.
/// </summary>
public class WellLicenseViolationConsequenceType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-WellLicenseViolationConsequenceType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public WellLicenseViolationConsequenceType_1_0_0Data? Data { get; set; }

}

public class WellLicenseViolationConsequenceType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
