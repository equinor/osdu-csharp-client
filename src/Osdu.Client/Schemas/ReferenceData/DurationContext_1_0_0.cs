...
/// <summary>
/// The explicit duration of activity within a nominal reporting period.
/// </summary>
public class DurationContext_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-DurationContext:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public DurationContext_1_0_0Data? Data { get; set; }

}

public class DurationContext_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
