...
/// <summary>
/// Identifies the method of interpolation to be used with a depth shift when the distance between original depths differs from the distance between shifted depths (e.g., None, Linear, Bilinear).
/// </summary>
public class DepthShiftInterpolationMethod_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-DepthShiftInterpolationMethod:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public DepthShiftInterpolationMethod_1_0_0Data? Data { get; set; }

}

public class DepthShiftInterpolationMethod_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
