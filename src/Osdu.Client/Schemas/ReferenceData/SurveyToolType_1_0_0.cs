...
/// <summary>
/// Standardized Type of survey tool used. The content is generally derived from the ISCWSA Set of Generic Tool Codes.
/// </summary>
public class SurveyToolType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-SurveyToolType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public SurveyToolType_1_0_0Data? Data { get; set; }

}

public class SurveyToolType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
