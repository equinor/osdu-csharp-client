...
/// <summary>
/// In compositional fluid model only (reservoir simulation context), describes the type of gridded property used for assignment - and the facet of this property assignment
/// </summary>
public class ReservoirSimulationPropertyFacetType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-ReservoirSimulationPropertyFacetType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public ReservoirSimulationPropertyFacetType_1_0_0Data? Data { get; set; }

}

public class ReservoirSimulationPropertyFacetType_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
