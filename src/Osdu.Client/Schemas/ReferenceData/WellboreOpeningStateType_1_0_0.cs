...
/// <summary>
/// Wellbore Opening State Type describes the physical state history of the Wellbore Opening that is significant for monitoring the completion and inform regulators and/or business stakeholders. Values are Open, Closed and Squeezed.
/// </summary>
public class WellboreOpeningStateType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-WellboreOpeningStateType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public WellboreOpeningStateType_1_0_0Data? Data { get; set; }

}

public class WellboreOpeningStateType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
