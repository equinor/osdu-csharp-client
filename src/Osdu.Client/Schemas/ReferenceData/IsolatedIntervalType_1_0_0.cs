...
/// <summary>
/// The classification of an IsolatedInterval (aka. Completion). Values are CasedHole.FullString, CaseHole.ProductionLiner and OpenHole.
/// </summary>
public class IsolatedIntervalType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-IsolatedIntervalType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public IsolatedIntervalType_1_0_0Data? Data { get; set; }

}

public class IsolatedIntervalType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
