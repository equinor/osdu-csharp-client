...
/// <summary>
/// Name of the role or personas that the record is technical assurance value is valid or not valid for.
/// </summary>
public class WorkflowPersonaType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-WorkflowPersonaType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public WorkflowPersonaType_1_0_0Data? Data { get; set; }

}

public class WorkflowPersonaType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
