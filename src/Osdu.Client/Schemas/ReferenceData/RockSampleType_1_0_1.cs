...
/// <summary>
/// DEPRECATED: Please use SampleType or SamplePreparationType, as appropriate. The classification of rock samples.
/// </summary>
public class RockSampleType_1_0_1
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-RockSampleType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public RockSampleType_1_0_1Data? Data { get; set; }

}

public class RockSampleType_1_0_1Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
