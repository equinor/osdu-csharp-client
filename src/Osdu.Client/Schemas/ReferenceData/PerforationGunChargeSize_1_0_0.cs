...
/// <summary>
/// The Perforating Gun Charge Size used in a perforation interval. The value is a number as string, always measured in grams (g = 0.001 kg).
/// </summary>
public class PerforationGunChargeSize_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-PerforationGunChargeSize:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public PerforationGunChargeSize_1_0_0Data? Data { get; set; }

}

public class PerforationGunChargeSize_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
