...
/// <summary>
/// A reference value list of well log tool codes and associated information, including LogCurveType references typically expected to be present.
/// </summary>
public class WellLogToolCode_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-WellLogToolCode:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public WellLogToolCode_1_0_0Data? Data { get; set; }

}

public class WellLogToolCode_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
    /// <summary>
    ...
    /// </summary>
    [JsonPropertyName("LogCurveTypeIDs")]
    public List<string> LogCurveTypeIDs { get; set; }
