...
/// <summary>
/// Play Type [Well Play Type] is the focus or area conducive to hydrocarbon discovery and includes the related activities for the development and production of the reservoir.
/// </summary>
public class PlayType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-PlayType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public PlayType_1_0_0Data? Data { get; set; }

}

public class PlayType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
