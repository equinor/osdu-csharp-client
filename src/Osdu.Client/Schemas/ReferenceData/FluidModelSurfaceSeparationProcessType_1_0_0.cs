...
/// <summary>
/// List of the types of processes used to separate the produced fluid into a gas and liquid stream at the surface.
/// </summary>
public class FluidModelSurfaceSeparationProcessType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-FluidModelSurfaceSeparationProcessType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public FluidModelSurfaceSeparationProcessType_1_0_0Data? Data { get; set; }

}

public class FluidModelSurfaceSeparationProcessType_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
