...
/// <summary>
/// A reservoir trapping mechanism refers to the geological processes and conditions that lead to the retention of hydrocarbons (oil and gas) within a subsurface reservoir. The presence of an effective trapping mechanism enhances the chances of discovering and exploiting economically viable hydrocarbon reserves.
/// </summary>
public class ReservoirTrappingMechanismType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-ReservoirTrappingMechanismType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public ReservoirTrappingMechanismType_1_0_0Data? Data { get; set; }

}

public class ReservoirTrappingMechanismType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
