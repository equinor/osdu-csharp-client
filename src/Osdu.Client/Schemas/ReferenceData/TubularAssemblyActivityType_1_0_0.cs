...
/// <summary>
/// Used to describe the type of activity on TubularAssembly, such as RunActivity, PullActivity,…
/// </summary>
public class TubularAssemblyActivityType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-TubularAssemblyActivityType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public TubularAssemblyActivityType_1_0_0Data? Data { get; set; }

}

public class TubularAssemblyActivityType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
