...
/// <summary>
/// Fluid Direction [Well Fluid Direction] is the flow direction of the wellhead stream. The facet value can change over the life of the well.
/// </summary>
public class WellFluidDirection_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-WellFluidDirection:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public WellFluidDirection_1_0_0Data? Data { get; set; }

}

public class WellFluidDirection_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
