...
/// <summary>
/// Consequence category of the risk for possible effects on Asset, Business &amp; Reputation, Environment, Health &amp; Safety…
/// </summary>
public class RiskConsequenceCategory_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-RiskConsequenceCategory:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public RiskConsequenceCategory_1_0_0Data? Data { get; set; }

}

public class RiskConsequenceCategory_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
