...
/// <summary>
/// The reference type for the well log, e.g. the domain of the reference curve. The most common value is Depth but it can also be calendar time, e.g. TimePast-1970-01-01 or SeismicTwoWayTravelTime.
/// </summary>
public class WellLogSamplingDomainType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-WellLogSamplingDomainType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public WellLogSamplingDomainType_1_0_0Data? Data { get; set; }

}

public class WellLogSamplingDomainType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
