...
/// <summary>
/// Service Quality is the perspective of the customer on the reliability or other factors about the performance of a business associate.
/// </summary>
public class BusinessAssociateServiceQualityType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-BusinessAssociateServiceQualityType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public BusinessAssociateServiceQualityType_1_0_0Data? Data { get; set; }

}

public class BusinessAssociateServiceQualityType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
