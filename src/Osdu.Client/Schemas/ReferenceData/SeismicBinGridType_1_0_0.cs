...
/// <summary>
/// Activity responsible for creating node list such as Acquisition, Processing, Velocity.  Usually Processing.
/// </summary>
public class SeismicBinGridType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-SeismicBinGridType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public SeismicBinGridType_1_0_0Data? Data { get; set; }

}

public class SeismicBinGridType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
