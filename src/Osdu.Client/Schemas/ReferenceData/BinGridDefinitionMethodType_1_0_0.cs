...
/// <summary>
/// Mathematical model describing generation of nodes for a regular grid.  Either 4 corner points using perspective transformation or P6 for origin and direction using affine operation.
/// </summary>
public class BinGridDefinitionMethodType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-BinGridDefinitionMethodType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public BinGridDefinitionMethodType_1_0_0Data? Data { get; set; }

}

public class BinGridDefinitionMethodType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
