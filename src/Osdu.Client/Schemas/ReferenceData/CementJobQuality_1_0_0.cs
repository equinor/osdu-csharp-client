...
/// <summary>
/// Cement Job Quality Assessment - A post-job assessment of the quality of the cement job (open assessment method).
/// </summary>
public class CementJobQuality_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-CementJobQuality:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public CementJobQuality_1_0_0Data? Data { get; set; }

}

public class CementJobQuality_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
