...
/// <summary>
/// Describes the anisotropy model assumed and solved for such as Isotropic, VTI, HTI, TTI, Orthorhombic.
/// </summary>
public class AnisotropyType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-AnisotropyType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public AnisotropyType_1_0_0Data? Data { get; set; }

}

public class AnisotropyType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
