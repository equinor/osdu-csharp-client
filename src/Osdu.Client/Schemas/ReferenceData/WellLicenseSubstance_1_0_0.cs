...
/// <summary>
/// When a product or other substance is named as an element in a well license condition, use this reference list to select the product or products.
/// </summary>
public class WellLicenseSubstance_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-WellLicenseSubstance:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public WellLicenseSubstance_1_0_0Data? Data { get; set; }

}

public class WellLicenseSubstance_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
