...
/// <summary>
/// Proposed reference values: hydraulics, mechanical, time related, wellbore stability, directional drilling, bit, equipment failure, completion, casing, other, HSE, unknown
/// </summary>
public class RiskCategory_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-RiskCategory:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public RiskCategory_1_0_0Data? Data { get; set; }

}

public class RiskCategory_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
