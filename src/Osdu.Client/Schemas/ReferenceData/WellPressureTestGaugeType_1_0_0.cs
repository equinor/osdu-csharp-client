...
/// <summary>
/// Describes the specific type of gauge installed in an acquisition string and usable to run WellPressureTests
/// </summary>
public class WellPressureTestGaugeType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-WellPressureTestGaugeType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public WellPressureTestGaugeType_1_0_0Data? Data { get; set; }

}

public class WellPressureTestGaugeType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
