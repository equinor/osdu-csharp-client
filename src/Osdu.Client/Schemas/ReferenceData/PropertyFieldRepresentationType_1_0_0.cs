...
/// <summary>
/// The type of topology used to represent the discrete velocity observations, such as Grid or Mesh.
/// </summary>
public class PropertyFieldRepresentationType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-PropertyFieldRepresentationType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public PropertyFieldRepresentationType_1_0_0Data? Data { get; set; }

}

public class PropertyFieldRepresentationType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
