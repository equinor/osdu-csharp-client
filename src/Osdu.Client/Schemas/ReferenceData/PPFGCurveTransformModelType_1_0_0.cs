...
/// <summary>
/// Name of the empirical calibrated model used for pressure calculation from a petrophysical curve (sonic or resistivity logs) - such as "Eaton" and  "Bowers",...
/// </summary>
public class PPFGCurveTransformModelType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-PPFGCurveTransformModelType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public PPFGCurveTransformModelType_1_0_0Data? Data { get; set; }

}

public class PPFGCurveTransformModelType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
