...
/// <summary>
/// The activity to enhance the reservoir properties for fluid flow or to repair damage to the formation and/or the production string(s).
/// </summary>
public class WellTreatmentType_1_0_1
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-WellTreatmentType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public WellTreatmentType_1_0_1Data? Data { get; set; }

}

public class WellTreatmentType_1_0_1Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
