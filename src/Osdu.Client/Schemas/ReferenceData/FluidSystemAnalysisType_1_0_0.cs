...
/// <summary>
/// A fluid system in the context of sample analysis is the combination of certain fluids (e.g. oil, water) and/or gases (e.g. air, CO2), used in lab tests on rock specimens.
/// </summary>
public class FluidSystemAnalysisType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-FluidSystemAnalysisType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public FluidSystemAnalysisType_1_0_0Data? Data { get; set; }

}

public class FluidSystemAnalysisType_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
