...
/// <summary>
/// A geologic region where an accumulation of deposited sediments has depressed or is preserved within the crust.
/// </summary>
public class BasinType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-BasinType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public BasinType_1_0_0Data? Data { get; set; }

}

public class BasinType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
