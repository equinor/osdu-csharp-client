...
/// </summary>
public class WellPressureTestProbeType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-WellPressureTestProbeType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public WellPressureTestProbeType_1_0_0Data? Data { get; set; }

}

public class WellPressureTestProbeType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
