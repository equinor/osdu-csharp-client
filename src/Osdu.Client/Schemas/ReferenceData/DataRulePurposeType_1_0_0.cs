...
/// <summary>
/// Reference value used by QualityDataRule to indicate the purpose and expected reaction on pass or failure.
/// </summary>
public class DataRulePurposeType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-DataRulePurposeType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public DataRulePurposeType_1_0_0Data? Data { get; set; }

}

public class DataRulePurposeType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
