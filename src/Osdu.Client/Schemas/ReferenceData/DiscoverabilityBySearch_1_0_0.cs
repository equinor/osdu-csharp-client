...
/// <summary>
/// The enumeration of different levels of query discoverability from simple queries, flattened array queries, nested array queries or no discoverability at all (no-indexed arrays of objects).
/// </summary>
public class DiscoverabilityBySearch_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-DiscoverabilityBySearch:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
...
public class DiscoverabilityBySearch_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
