...
/// <summary>
/// A variable that can be changed independently and often arbitrarily between calculations but which remains constant during any calculation. (SEG)
/// </summary>
public class ProcessingParameterType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-ProcessingParameterType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public ProcessingParameterType_1_0_0Data? Data { get; set; }

}

public class ProcessingParameterType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
