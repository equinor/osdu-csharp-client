...
/// <summary>
/// Reference data for primitive data format types which describe the computer interpretation of a storage word, such as Integer, Float.
/// </summary>
public class WordFormatType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-WordFormatType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public WordFormatType_1_0_0Data? Data { get; set; }

}

public class WordFormatType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
