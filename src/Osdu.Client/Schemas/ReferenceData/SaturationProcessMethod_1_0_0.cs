...
/// <summary>
/// The method used to saturate the rock sample (fill the pore spaces) with a particular fluid in the lab experiment.
/// </summary>
public class SaturationProcessMethod_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-SaturationProcessMethod:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public SaturationProcessMethod_1_0_0Data? Data { get; set; }

}

public class SaturationProcessMethod_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
