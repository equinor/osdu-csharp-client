...
/// <summary>
/// Defines the type of gantry used on the rig.
/// </summary>
public class GantryType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-GantryType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public GantryType_1_0_0Data? Data { get; set; }

}

public class GantryType_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
