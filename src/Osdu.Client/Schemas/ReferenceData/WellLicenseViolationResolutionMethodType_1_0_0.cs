...
/// </summary>
public class WellLicenseViolationResolutionMethodType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-WellLicenseViolationResolutionMethodType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
...
public class WellLicenseViolationResolutionMethodType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
    /// <summary>
    ...
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-WellLicenseViolationResolutionMethodClass:[\w\-\.\:\%]+:[0-9]*$")]
    [JsonPropertyName("MethodClassID")]
    public string MethodClassID { get; set; }
