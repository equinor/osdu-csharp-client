...
/// <summary>
/// A reference list containing schema upgrade specifications feeding the OSDU schema upgrade service.
/// </summary>
public class SchemaUpgradeSpecification_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-SchemaUpgradeSpecification:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
...
public class SchemaUpgradeSpecification_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
    /// <summary>
    ...
    /// </summary>
    [JsonPropertyName("JoltConfigurations")]
    public List<object> JoltConfigurations { get; set; }
