...
/// <summary>
/// Non-Productive Time Cause Sub Type. Sub-types are parented by a Cause type and provide additional detail on assigned causes of NPT.
/// </summary>
public class NPTCauseSubType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-NPTCauseSubType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public NPTCauseSubType_1_0_0Data? Data { get; set; }

}

public class NPTCauseSubType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
