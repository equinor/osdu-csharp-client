...
/// <summary>
/// Seismic polarity describes the appearance of the seismic response to an isolated impedance contrast.
/// </summary>
public class SeismicPolarity_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-SeismicPolarity:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public SeismicPolarity_1_0_0Data? Data { get; set; }

}

public class SeismicPolarity_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
