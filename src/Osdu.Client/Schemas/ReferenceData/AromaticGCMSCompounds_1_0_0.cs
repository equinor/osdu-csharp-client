...
/// <summary>
/// An aromatic compound is a type of organic molecule characterized primarily by its stable ring-like structure, consisting of alternating double and single bonds between carbon atoms.
/// </summary>
public class AromaticGCMSCompounds_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-AromaticGCMSCompounds:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public AromaticGCMSCompounds_1_0_0Data? Data { get; set; }

}

public class AromaticGCMSCompounds_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
