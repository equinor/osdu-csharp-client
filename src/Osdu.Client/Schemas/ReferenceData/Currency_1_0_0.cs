...
public class Currency_1_0_0
{
    ...
    public Currency_1_0_0Data? Data { get; set; }

}

public class Currency_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
    /// <summary>
    /// The symbol for the currency.
    /// </summary>
    [JsonPropertyName("CurrencySymbolText")]
    public string CurrencySymbolText { get; set; }

    /// <summary>
    /// Standard numeric number assigned to a currency
    /// </summary>
    [JsonPropertyName("CurrencyCodeNumericNumber")]
    public int? CurrencyCodeNumericNumber { get; set; }
