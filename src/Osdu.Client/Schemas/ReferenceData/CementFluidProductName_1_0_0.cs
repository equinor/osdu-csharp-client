...
/// </summary>
public class CementFluidProductName_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-CementFluidProductName:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public CementFluidProductName_1_0_0Data? Data { get; set; }

}

public class CementFluidProductName_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
    /// <summary>
    /// The relationship to the cementing fluid.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-CementMudType:[\w\-\.\:\%]+:[0-9]*$")]
    [JsonPropertyName("CementMudTypeID")]
    public string CementMudTypeID { get; set; }
