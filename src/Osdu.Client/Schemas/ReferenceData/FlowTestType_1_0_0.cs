...
/// <summary>
/// The method used to produce an instance of a flow test record
/// </summary>
public class FlowTestType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-FlowTestType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public FlowTestType_1_0_0Data? Data { get; set; }

}

public class FlowTestType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
