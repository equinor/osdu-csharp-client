...
/// <summary>
/// Geometry along which a velocity model is defined, such as line (could be checkshot), surface, volume, time series (for 4D/time lapse). Ex. 1D, 2D, 3D, 1D_TL, 2D_TL, and 3D_TL.
/// </summary>
public class DimensionType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-DimensionType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public DimensionType_1_0_0Data? Data { get; set; }

}

public class DimensionType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
