...
/// <summary>
/// Phase of the value chain to which the referring item has been associated with, e.g., Exploration, Field Development, Production or Late Life.
/// </summary>
public class ValueChainStatusType_1_0_1
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-ValueChainStatusType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public ValueChainStatusType_1_0_1Data? Data { get; set; }

}

public class ValueChainStatusType_1_0_1Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
