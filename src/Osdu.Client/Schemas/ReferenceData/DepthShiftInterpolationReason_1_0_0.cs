...
/// <summary>
/// Identifies the reason for interpolation to be used with a depth shift when the distance between original depths differs from the distance between shifted depths (e.g., rubble zone, a gap in the sample, an unconsolidated sample or other discrepancies).
/// </summary>
public class DepthShiftInterpolationReason_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-DepthShiftInterpolationReason:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public DepthShiftInterpolationReason_1_0_0Data? Data { get; set; }

}

public class DepthShiftInterpolationReason_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
