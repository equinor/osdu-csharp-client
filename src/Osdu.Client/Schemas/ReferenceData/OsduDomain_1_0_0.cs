...
public class OsduDomain_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
    /// <summary>
    /// The parent domain. Root level (L1) domain keep this property absent.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-OsduDomain:[\w\-\.\:\%]+:[0-9]*$")]
