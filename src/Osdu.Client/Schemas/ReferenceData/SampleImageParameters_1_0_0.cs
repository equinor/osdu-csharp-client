...
/// <summary>
/// The Image parameters for this sample image. Examples include magnification, pixel size and camera resolution.
/// </summary>
public class SampleImageParameters_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-SampleImageParameters:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public SampleImageParameters_1_0_0Data? Data { get; set; }

}

public class SampleImageParameters_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
    /// <summary>
    /// The expected `Image Parameter Value Type` for this image parameter, for example, "Numeric", "Boolean", or "String".
    /// </summary>
    [RegularExpression(@"^Numeric$|^Boolean$|^String$")]
    [JsonPropertyName("ParameterValueType")]
