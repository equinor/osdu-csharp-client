...
/// <summary>
/// FIT, LOT, XLOT etc. Proposed reference values: Formation Integrity Test, Leak Off Test, Extended Leak Off Test
/// </summary>
public class FormationPressureTestType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-FormationPressureTestType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public FormationPressureTestType_1_0_0Data? Data { get; set; }

}

public class FormationPressureTestType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
