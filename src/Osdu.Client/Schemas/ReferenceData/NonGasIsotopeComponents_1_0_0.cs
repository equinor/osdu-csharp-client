...
/// <summary>
/// Types of non-gas compounds, such as aromatics, saturates, water or bitumen, used in isotope analysis.
/// </summary>
public class NonGasIsotopeComponents_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-NonGasIsotopeComponents:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public NonGasIsotopeComponents_1_0_0Data? Data { get; set; }

}

public class NonGasIsotopeComponents_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
