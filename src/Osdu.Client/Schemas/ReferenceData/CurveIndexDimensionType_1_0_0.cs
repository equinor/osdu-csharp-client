...
/// <summary>
/// DEPRECATED: (not used anywhere) Describes the physical dimension a curve index is defined from - can be Depth, Time, Counter,...
/// </summary>
public class CurveIndexDimensionType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-CurveIndexDimensionType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public CurveIndexDimensionType_1_0_0Data? Data { get; set; }

}

public class CurveIndexDimensionType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
