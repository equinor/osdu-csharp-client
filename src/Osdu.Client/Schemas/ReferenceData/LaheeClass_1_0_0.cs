...
/// <summary>
/// A traditional, commonly accepted, scheme to categorize wells by the general degree of risk assumed by the operator at the time of drilling.
/// </summary>
public class LaheeClass_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-LaheeClass:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public LaheeClass_1_0_0Data? Data { get; set; }

}

public class LaheeClass_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
