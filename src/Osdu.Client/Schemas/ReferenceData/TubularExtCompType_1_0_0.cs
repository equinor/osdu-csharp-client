...
/// <summary>
/// List of tubular assembly external component (equipment) types for drilling, casing/liner and completion assemblies.
/// </summary>
public class TubularExtCompType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-TubularExtCompType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public TubularExtCompType_1_0_0Data? Data { get; set; }

}

public class TubularExtCompType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
