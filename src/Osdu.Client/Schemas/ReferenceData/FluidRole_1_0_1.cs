...
/// <summary>
/// DEPRECATED: Superseded by reference-data--WellFluidRole: Purpose the fluid will play in the wellbore, such as Cement Displacement, Hole Cleaning, Sweep, Completion Fluid
/// </summary>
public class FluidRole_1_0_1
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-FluidRole:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public FluidRole_1_0_1Data? Data { get; set; }

}

public class FluidRole_1_0_1Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
