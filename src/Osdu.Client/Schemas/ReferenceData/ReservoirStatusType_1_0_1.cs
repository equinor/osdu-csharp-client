...
/// <summary>
/// DEPRECATED: Use ReservoirLifeCycleStatus and IsActiveCondition property instead; List of reservoir status values, describing past and current state of the reservoir entity (Active / Abandoned / First Production / Discovery / First Injection).
/// </summary>
public class ReservoirStatusType_1_0_1
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-ReservoirStatusType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public ReservoirStatusType_1_0_1Data? Data { get; set; }

}

public class ReservoirStatusType_1_0_1Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
