...
/// <summary>
/// These records build the catalog of OSDU JSON extensions tags, which are known to the system.
/// </summary>
public class OSDUJsonExtensions_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-OSDUJsonExtensions:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public OSDUJsonExtensions_1_0_0Data? Data { get; set; }

}

public class OSDUJsonExtensions_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
