...
/// </summary>
public class PerforationGunFiringHeadType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-PerforationGunFiringHeadType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public PerforationGunFiringHeadType_1_0_0Data? Data { get; set; }

}

public class PerforationGunFiringHeadType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
