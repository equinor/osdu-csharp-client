...
/// <summary>
/// Class of final applied filters, for ex. high cut, low cut, spiking deconvolution, multiple elimination.
/// </summary>
public class SeismicFilteringType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-SeismicFilteringType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public SeismicFilteringType_1_0_0Data? Data { get; set; }

}

public class SeismicFilteringType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
