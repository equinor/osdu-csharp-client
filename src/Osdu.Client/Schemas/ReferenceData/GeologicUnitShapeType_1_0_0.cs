...
/// <summary>
/// GeologicUnitShapeType holds the values for 3D shape classifications corresponding to the Energistics Shape3dExt.
/// </summary>
public class GeologicUnitShapeType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-GeologicUnitShapeType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public GeologicUnitShapeType_1_0_0Data? Data { get; set; }

}

public class GeologicUnitShapeType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
