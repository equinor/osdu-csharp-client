...
/// <summary>
/// List of reservoir status values, describing past and current state of the reservoir entity (Active / Abandoned / First Production / Discovery / First Injection).
/// </summary>
public class ReservoirStatusType_1_0_0
{
    /// <summary>
    ...
    public ReservoirStatusType_1_0_0Data? Data { get; set; }

}

public class ReservoirStatusType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
