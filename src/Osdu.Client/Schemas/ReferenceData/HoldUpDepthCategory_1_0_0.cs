...
/// <summary>
/// Wellbore Hold Up Depth Category (HUD or Fish)
/// </summary>
public class HoldUpDepthCategory_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-HoldUpDepthCategory:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public HoldUpDepthCategory_1_0_0Data? Data { get; set; }

}

public class HoldUpDepthCategory_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
