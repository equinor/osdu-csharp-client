...
/// <summary>
/// Identifies the type of depth shift by specifying the entity to be shifted and the shift target (e.g., CoreToLog is intended to shift a set of core sample depths to align with a target well log).
/// </summary>
public class DepthShiftType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-DepthShiftType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public DepthShiftType_1_0_0Data? Data { get; set; }

}

public class DepthShiftType_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
