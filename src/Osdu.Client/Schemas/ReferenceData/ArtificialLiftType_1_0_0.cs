...
/// <summary>
/// Used to reflect the type of Artificial Lift the data went out - 'Surface Pump', 'Submersible Pump',...
/// </summary>
public class ArtificialLiftType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-ArtificialLiftType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public ArtificialLiftType_1_0_0Data? Data { get; set; }

}

public class ArtificialLiftType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
