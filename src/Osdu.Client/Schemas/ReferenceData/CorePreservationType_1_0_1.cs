...
/// <summary>
/// The technique to preserve or stabilize the core sample on removal from the core barrel or at the time of sample extraction.
/// </summary>
public class CorePreservationType_1_0_1
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-CorePreservationType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public CorePreservationType_1_0_1Data? Data { get; set; }

}

public class CorePreservationType_1_0_1Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
