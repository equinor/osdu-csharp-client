...
/// <summary>
/// Purpose or intended use of a work product component, such as Stacking, Depth Migration, Time Migration, Time-depth Conversion.
/// </summary>
public class ObjectiveType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-ObjectiveType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public ObjectiveType_1_0_0Data? Data { get; set; }

}

public class ObjectiveType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
