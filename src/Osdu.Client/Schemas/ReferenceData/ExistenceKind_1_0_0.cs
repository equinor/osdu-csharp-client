...
/// <summary>
/// ExistenceKind describes at which stage the instance is in the cradle-to-grave span of its existence. Typical values are: "Proposed", "Planned", "Active", "Inactive", "Marked for Disposal".
/// </summary>
public class ExistenceKind_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-ExistenceKind:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public ExistenceKind_1_0_0Data? Data { get; set; }

}

public class ExistenceKind_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
