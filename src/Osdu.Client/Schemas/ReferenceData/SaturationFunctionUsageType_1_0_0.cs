...
/// <summary>
/// How a saturation function may be used, such as drainage (relevant to reservoir depletion or gas injection) or imbibition (relevant to water-flooding).
/// </summary>
public class SaturationFunctionUsageType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-SaturationFunctionUsageType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public SaturationFunctionUsageType_1_0_0Data? Data { get; set; }

}

public class SaturationFunctionUsageType_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
