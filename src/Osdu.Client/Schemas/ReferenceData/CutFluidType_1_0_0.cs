...
/// <summary>
/// Identifies the type of lubricating fluid used when physically cutting a rock sample, usually in preparation for testing.
/// </summary>
public class CutFluidType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-CutFluidType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public CutFluidType_1_0_0Data? Data { get; set; }

}

public class CutFluidType_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
