...
/// <summary>
/// The reason why a production amendment was posted, such as instrument calibration, calculation error or volume balancing.
/// </summary>
public class AmendReason_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-AmendReason:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public AmendReason_1_0_0Data? Data { get; set; }

}

public class AmendReason_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
