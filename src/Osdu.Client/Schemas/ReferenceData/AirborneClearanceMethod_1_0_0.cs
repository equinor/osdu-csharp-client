...
/// </summary>
public class AirborneClearanceMethod_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-AirborneClearanceMethod:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public AirborneClearanceMethod_1_0_0Data? Data { get; set; }

}

public class AirborneClearanceMethod_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
