...
/// <summary>
/// List of fluid model property types that may be represented in a Fluid Model, such as phase equilibrium, densities, and viscosities.
/// </summary>
public class FluidModelPropertyType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-FluidModelPropertyType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public FluidModelPropertyType_1_0_0Data? Data { get; set; }

}

public class FluidModelPropertyType_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
