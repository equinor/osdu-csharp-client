...
/// <summary>
/// Isolated interval classification, for example, Single Completion, Dual Completion, Mixed Water Injection, Produced Water Injection, Reservoir Surveillance, Sour Gas Producer, Sour Oil Producer, Sweet Gas Producer, Sweet Oil Producer.
/// </summary>
public class IsolatedIntervalClassification_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-IsolatedIntervalClassification:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public IsolatedIntervalClassification_1_0_0Data? Data { get; set; }

}

public class IsolatedIntervalClassification_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
