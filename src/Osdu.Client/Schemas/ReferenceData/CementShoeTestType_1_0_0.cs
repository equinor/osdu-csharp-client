...
/// <summary>
/// Type of (pressure) test to determine the strength of the Cement surrounding the shoe (after drill-out).
/// </summary>
public class CementShoeTestType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-CementShoeTestType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public CementShoeTestType_1_0_0Data? Data { get; set; }

}

public class CementShoeTestType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
