...
/// <summary>
/// The soil gas application or situational setting that the data is being used for or acquired within. Examples include carbon capture &amp; storage, depleted oil or gas field, water reservoir, producing oil or gas, fracking, etc
/// </summary>
public class SoilGasApplication_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-SoilGasApplication:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public SoilGasApplication_1_0_0Data? Data { get; set; }

}

public class SoilGasApplication_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
