...
/// <summary>
/// List of types of fluid models, which are approaches used to describe the behavior and characteristics of fluids. They vary in complexity of approach and physical processes modelled.
/// </summary>
public class FluidModelType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-FluidModelType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public FluidModelType_1_0_0Data? Data { get; set; }

}

public class FluidModelType_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
