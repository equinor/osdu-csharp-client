...
/// <summary>
/// The data governance role a persona in data management can play as defined by the data governance processes.
/// </summary>
public class DataGovernanceRoleType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-DataGovernanceRoleType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public DataGovernanceRoleType_1_0_0Data? Data { get; set; }

}

public class DataGovernanceRoleType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
