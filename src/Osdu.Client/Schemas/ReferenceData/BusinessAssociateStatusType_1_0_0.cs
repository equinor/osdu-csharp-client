...
/// <summary>
/// The current status of the Business Associate, such as Active, In Receivership, Sold, Merged.
/// </summary>
public class BusinessAssociateStatusType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-BusinessAssociateStatusType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public BusinessAssociateStatusType_1_0_0Data? Data { get; set; }

}

public class BusinessAssociateStatusType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
