...
/// </summary>
public class WellActivityProgramType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-WellActivityProgramType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public WellActivityProgramType_1_0_0Data? Data { get; set; }

}

public class WellActivityProgramType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
