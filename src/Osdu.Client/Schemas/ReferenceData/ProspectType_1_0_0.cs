...
/// <summary>
/// A kind of potential trap that must be evaluated by drilling to determine whether it contains commercial quantities of petroleum.
/// </summary>
public class ProspectType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-ProspectType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public ProspectType_1_0_0Data? Data { get; set; }

}

public class ProspectType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
