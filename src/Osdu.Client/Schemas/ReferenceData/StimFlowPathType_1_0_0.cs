...
/// <summary>
/// The fluid flow path type used during a Stimulation Job which describes how where fluid is pumped from surface to the stimulated interval.
/// </summary>
public class StimFlowPathType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-StimFlowPathType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public StimFlowPathType_1_0_0Data? Data { get; set; }

}

public class StimFlowPathType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
