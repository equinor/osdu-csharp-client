...
/// <summary>
/// Identifies the technique, and in some cases instruments, used to perform bulk pyrolysis - that is, heating organic materials in the absence of oxygen to produce energy and by-products.
/// </summary>
public class BulkPyrolysisMethod_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-BulkPyrolysisMethod:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public BulkPyrolysisMethod_1_0_0Data? Data { get; set; }

}

public class BulkPyrolysisMethod_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
