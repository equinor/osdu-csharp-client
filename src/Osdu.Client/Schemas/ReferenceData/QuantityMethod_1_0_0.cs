...
/// <summary>
/// The context as to how a production metric value was captured or created and the appropriateness of its use for analytics and reporting.
/// </summary>
public class QuantityMethod_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-QuantityMethod:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public QuantityMethod_1_0_0Data? Data { get; set; }

}

public class QuantityMethod_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
