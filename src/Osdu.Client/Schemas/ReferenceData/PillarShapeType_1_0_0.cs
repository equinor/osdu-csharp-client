...
/// <summary>
/// An enumeration of the pillar shape type based on the RESQML model, i.e., vertical, straight, curved.
/// </summary>
public class PillarShapeType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-PillarShapeType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public PillarShapeType_1_0_0Data? Data { get; set; }

}

public class PillarShapeType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
