...
/// <summary>
/// PropertyType is part of Energistics PWLS 3, which defines a detailed hierarchy of properties linked to the Energistics UnitQuantity/UnitOfMeasure.
/// </summary>
public class PropertyType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-PropertyType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
...
public class PropertyType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
    /// <summary>
    ...
    [JsonPropertyName("ParentPropertyTypeID")]
