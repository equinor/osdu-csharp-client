...
/// <summary>
/// The dimensionality of Seismic trace data sets, represent reflections of seismic waves from subsurface layers. They come in different values based on the data acquired and its representation.
/// </summary>
public class SeismicTraceDataDimensionalityType_1_0_1
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-SeismicTraceDataDimensionalityType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public SeismicTraceDataDimensionalityType_1_0_1Data? Data { get; set; }

}

public class SeismicTraceDataDimensionalityType_1_0_1Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
