...
/// <summary>
/// DEPRECATED: No longer recommended for use due to a mixture of concepts. Superseded by a free-text property on master-data--ReservoirSegment. Previously: List of brief reservoir segment description. such as intent/purpose/use
/// </summary>
public class ReservoirSegmentType_1_0_1
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-ReservoirSegmentType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public ReservoirSegmentType_1_0_1Data? Data { get; set; }

}

public class ReservoirSegmentType_1_0_1Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
