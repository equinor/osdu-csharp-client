...
/// <summary>
/// The wellbore marker property catalog for e.g. WellboreMarkerSet data.AvailableMarkerProperties. Similar to LogCurveType and the TrajectoryStationPropertyType which describes well-known properties (or curves or channels in an array view), which can be accessed via the Wellbore Domain Data Management Services.
/// </summary>
public class MarkerPropertyType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-MarkerPropertyType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public MarkerPropertyType_1_0_0_Data? Data { get; set; }

}

public class MarkerPropertyType_1_0_0_Data : AbstractCommonResources_1_0_0 // Also composes: AbstractReferenceType_1_0_0, AbstractReferencePropertyType_1_0_0
{
    /// <summary>
