...
/// <summary>
/// High-level type definition of the main fluid types used during a Cement job (includes circulation pre- and post-pumping of Cement slurry).
/// </summary>
public class CementFluidType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-CementFluidType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public CementFluidType_1_0_0Data? Data { get; set; }

}

public class CementFluidType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
