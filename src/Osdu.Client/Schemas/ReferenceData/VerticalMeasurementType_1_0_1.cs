...
/// <summary>
/// The horizontal plane of reference for well depth and elevation measurements, where the measured value is zero.
/// </summary>
public class VerticalMeasurementType_1_0_1
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-VerticalMeasurementType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public VerticalMeasurementType_1_0_1Data? Data { get; set; }

}

public class VerticalMeasurementType_1_0_1Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
