...
/// <summary>
/// Fluid Additive Concentration Unit of Measure - Unit of measurement for the selected Additive concentration.
/// </summary>
public class FluidAdditiveConcUnitOfMeasure_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-FluidAdditiveConcUnitOfMeasure:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public FluidAdditiveConcUnitOfMeasure_1_0_0Data? Data { get; set; }

}

public class FluidAdditiveConcUnitOfMeasure_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
