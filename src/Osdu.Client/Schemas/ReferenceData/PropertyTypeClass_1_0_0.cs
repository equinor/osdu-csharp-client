...
/// <summary>
/// The classification of the nature of a property type (e.g., discrete, continuous, or categorical).
/// </summary>
public class PropertyTypeClass_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-PropertyTypeClass:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public PropertyTypeClass_1_0_0Data? Data { get; set; }

}

public class PropertyTypeClass_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
