...
/// <summary>
/// The type of loss experienced. This may include fuel spills from a vehicle, gas emissions from a wellhead or feeder line, or any other substance.
/// </summary>
public class WellLicenseSubstanceLossType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-WellLicenseSubstanceLossType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public WellLicenseSubstanceLossType_1_0_0Data? Data { get; set; }

}

public class WellLicenseSubstanceLossType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
