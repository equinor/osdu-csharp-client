...
/// <summary>
/// A mud-additive with a unique signature or traceability to help understand mud-movement and/or contamination in subsequent rock, fluid, and subsurface tests.
/// </summary>
public class MudTracerType_1_0_1
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-MudTracerType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public MudTracerType_1_0_1Data? Data { get; set; }

}

public class MudTracerType_1_0_1Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
