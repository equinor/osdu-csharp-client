...
/// <summary>
/// A reference list containing the different types of sampling points. It refers to the information associated with specific locations or points where samples are collected
/// </summary>
public class SamplingPointType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-SamplingPointType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public SamplingPointType_1_0_0Data? Data { get; set; }

}

public class SamplingPointType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
