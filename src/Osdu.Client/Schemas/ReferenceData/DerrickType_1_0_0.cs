...
/// <summary>
/// Defines the type of derrick used on the rig.
/// </summary>
public class DerrickType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-DerrickType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public DerrickType_1_0_0Data? Data { get; set; }

}

public class DerrickType_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
