...
/// <summary>
/// A descriptive term applied to a seismic velocity to indicate the type of calculation applied to the seismic data.
/// </summary>
public class VelocityType_1_0_1
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-VelocityType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public VelocityType_1_0_1Data? Data { get; set; }

}

public class VelocityType_1_0_1Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
