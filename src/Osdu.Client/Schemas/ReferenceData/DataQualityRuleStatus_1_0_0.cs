...
/// <summary>
/// The status of a DataQualityRule in assessments controlling whether or not the rule is evaluated or under development.
/// </summary>
public class DataQualityRuleStatus_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-DataQualityRuleStatus:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public DataQualityRuleStatus_1_0_0Data? Data { get; set; }

}

public class DataQualityRuleStatus_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
