...
/// <summary>
/// Seismic phase describes the phase of the seismic wavelet.  The seismic wavelet contains a broad range of frequencies. A zero phase wavelet is symmetric around  time zero, while mixed phase or minimum-phase are asymmetric.
/// </summary>
public class SeismicPhase_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-SeismicPhase:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public SeismicPhase_1_0_0Data? Data { get; set; }

}

public class SeismicPhase_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
