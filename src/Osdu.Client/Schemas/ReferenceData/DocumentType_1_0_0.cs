...
/// <summary>
/// A piece of printed or electronic material containing communication or evidence that is intended for persistent or permanent record.
/// </summary>
public class DocumentType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-DocumentType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public DocumentType_1_0_0Data? Data { get; set; }

}

public class DocumentType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
