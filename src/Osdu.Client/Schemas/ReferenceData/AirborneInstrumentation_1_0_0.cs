...
/// <summary>
/// The instruments or equipment used to measure the specified flying height. This can be one or several different types of equipment, for example, laser scanner, GPS, radar altimeter.
/// </summary>
public class AirborneInstrumentation_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-AirborneInstrumentation:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public AirborneInstrumentation_1_0_0Data? Data { get; set; }

}

public class AirborneInstrumentation_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
