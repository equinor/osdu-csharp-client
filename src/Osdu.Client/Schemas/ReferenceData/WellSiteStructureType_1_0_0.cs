...
/// <summary>
/// A classification of a Well Site Structure instance, often in a structured way using a hierarchical code convention, e.g., generic 'Platform' and 'Platform (Gravity Base)'.
/// </summary>
public class WellSiteStructureType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-WellSiteStructureType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public WellSiteStructureType_1_0_0Data? Data { get; set; }

}

public class WellSiteStructureType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
