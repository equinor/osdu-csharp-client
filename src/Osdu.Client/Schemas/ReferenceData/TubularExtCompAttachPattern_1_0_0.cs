...
/// <summary>
/// List of external component placement patterns which describe frequency of the equipment being installed onto the tubular assembly.
/// </summary>
public class TubularExtCompAttachPattern_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-TubularExtCompAttachPattern:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public TubularExtCompAttachPattern_1_0_0Data? Data { get; set; }

}

public class TubularExtCompAttachPattern_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
