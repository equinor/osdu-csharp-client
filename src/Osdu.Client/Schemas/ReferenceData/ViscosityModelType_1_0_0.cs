...
/// <summary>
/// List of the viscosity model types used in fluid models.
/// </summary>
public class ViscosityModelType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-ViscosityModelType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public ViscosityModelType_1_0_0Data? Data { get; set; }

}

public class ViscosityModelType_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
