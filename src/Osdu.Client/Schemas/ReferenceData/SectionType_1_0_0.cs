...
/// <summary>
/// Used to describe the type of sections.
/// </summary>
public class SectionType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-SectionType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public SectionType_1_0_0Data? Data { get; set; }

}

public class SectionType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
