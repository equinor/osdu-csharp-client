...
/// <summary>
/// A kind of document, record or other publication containing the terms of an agreed understanding, undertaking, contract or mutual consent between two or more parties.
/// </summary>
public class AgreementType_1_0_1
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-AgreementType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public AgreementType_1_0_1Data? Data { get; set; }

}

public class AgreementType_1_0_1Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
