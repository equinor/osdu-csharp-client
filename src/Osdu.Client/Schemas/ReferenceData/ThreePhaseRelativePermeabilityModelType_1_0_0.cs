...
/// <summary>
/// A list of the types of specific computational approaches or methods used to calculate the relative permeability relationships between oil, water, and gas phases as a function of their saturations.
/// </summary>
public class ThreePhaseRelativePermeabilityModelType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-ThreePhaseRelativePermeabilityModelType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public ThreePhaseRelativePermeabilityModelType_1_0_0Data? Data { get; set; }

}

public class ThreePhaseRelativePermeabilityModelType_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
