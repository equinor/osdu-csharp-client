...
/// <summary>
/// Sub-level type definition of one (of potentially several) mud systems used during the cement job.
/// </summary>
public class CementMudType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-CementMudType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public CementMudType_1_0_0Data? Data { get; set; }

}

public class CementMudType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
