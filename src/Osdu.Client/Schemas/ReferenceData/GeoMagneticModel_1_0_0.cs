...
/// <summary>
/// The name of the model used to calculate the geomagnetic field at a given date, location or depth down a wellbore.
/// </summary>
public class GeoMagneticModel_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-GeoMagneticModel:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public GeoMagneticModel_1_0_0Data? Data { get; set; }

}

public class GeoMagneticModel_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
