...
/// <summary>
/// Used to describe the type of markers.
/// </summary>
public class MarkerType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-MarkerType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public MarkerType_1_0_0Data? Data { get; set; }

}

public class MarkerType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
