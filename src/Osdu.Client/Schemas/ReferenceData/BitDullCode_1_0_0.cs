...
/// <summary>
/// The IADC bit dull codes
/// </summary>
public class BitDullCode_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-BitDullCode:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public BitDullCode_1_0_0Data? Data { get; set; }

}

public class BitDullCode_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
