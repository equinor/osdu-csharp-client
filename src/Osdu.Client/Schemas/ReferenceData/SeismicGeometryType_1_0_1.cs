...
/// <summary>
/// Standard values for the general geometrical layout of the seismic acquisition survey.  This can be a hierarchical value (via data.ParentID).  The top value is like 2D, 3D, Borehole, Passive.  More specific values are constructed like 3D.NarrowAzimuth, 3D.WideAzimuth.
/// </summary>
public class SeismicGeometryType_1_0_1
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-SeismicGeometryType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public SeismicGeometryType_1_0_1Data? Data { get; set; }

}

public class SeismicGeometryType_1_0_1Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
    /// <summary>
