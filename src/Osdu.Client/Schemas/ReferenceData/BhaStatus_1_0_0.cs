...
/// <summary>
/// The status of the Bottom Hole Assembly. Proposed reference values: final, progress, plan, unknown
/// </summary>
public class BhaStatus_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-BhaStatus:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public BhaStatus_1_0_0Data? Data { get; set; }

}

public class BhaStatus_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
