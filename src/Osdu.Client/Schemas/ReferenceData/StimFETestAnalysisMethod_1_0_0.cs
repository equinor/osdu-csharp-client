...
/// <summary>
/// The analysis methods used in a Fluid Efficiency Test for a Stimulation Job Pumping Diagnostic Session.
/// </summary>
public class StimFETestAnalysisMethod_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-StimFETestAnalysisMethod:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public StimFETestAnalysisMethod_1_0_0Data? Data { get; set; }

}

public class StimFETestAnalysisMethod_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
