...
/// <summary>
/// The position on a seismic waveform where a reflection or refraction horizon is picked in order to investigate a subsurface formation definition.
/// </summary>
public class SeismicHorizonType_1_0_2
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-SeismicHorizonType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public SeismicHorizonType_1_0_2Data? Data { get; set; }

}

public class SeismicHorizonType_1_0_2Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
