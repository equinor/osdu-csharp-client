...
/// <summary>
/// The type of fluid present in the wellbore at the time of the wellbore activity, not to be confused with WellProductType which is the produced fluid of the wellbore.
/// </summary>
public class WellboreFluidType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-WellboreFluidType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public WellboreFluidType_1_0_0Data? Data { get; set; }

}

public class WellboreFluidType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
