...
/// <summary>
/// The type of Opening constructed along a Wellbore depth interval to enable flow between the reservoir and production tubing.
/// </summary>
public class WellboreOpeningType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-WellboreOpeningType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public WellboreOpeningType_1_0_0Data? Data { get; set; }

}

public class WellboreOpeningType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
