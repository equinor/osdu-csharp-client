...
/// <summary>
/// Definitions of various types of biostratigraphic events, such as the first downhole occurrence of an event taxa.
/// </summary>
public class BiostratigraphicEventType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-BiostratigraphicEventType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public BiostratigraphicEventType_1_0_0Data? Data { get; set; }

}

public class BiostratigraphicEventType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
