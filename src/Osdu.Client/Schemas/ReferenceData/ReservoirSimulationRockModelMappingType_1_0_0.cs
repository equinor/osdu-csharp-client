...
/// <summary>
/// A list of aspects of the Reservoir Simulation Rock Model considered for a specific region-to-model assignment (e.g., Saturation Function, Rock Physics).
/// </summary>
public class ReservoirSimulationRockModelMappingType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-ReservoirSimulationRockModelMappingType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public ReservoirSimulationRockModelMappingType_1_0_0Data? Data { get; set; }

}

public class ReservoirSimulationRockModelMappingType_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
