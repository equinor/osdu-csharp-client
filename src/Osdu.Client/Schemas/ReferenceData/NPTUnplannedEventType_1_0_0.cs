...
/// <summary>
/// Non-Productive Time Unplanned Event Type - Equipment Failure causing NPT, non-Equipment Failure NPTs and no operations impact  Equipment Failures (no NPT).
/// </summary>
public class NPTUnplannedEventType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-NPTUnplannedEventType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public NPTUnplannedEventType_1_0_0Data? Data { get; set; }

}

public class NPTUnplannedEventType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
