...
/// <summary>
/// Defines the type of flare used on the rig.
/// </summary>
public class FlareType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-FlareType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public FlareType_1_0_0Data? Data { get; set; }

}

public class FlareType_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
