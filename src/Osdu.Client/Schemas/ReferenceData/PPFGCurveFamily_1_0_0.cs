...
/// <summary>
/// The PPFG Curve Family reflects the 'Detailed' Geological Physical Quantity Measured - such Pore Pressure in Shale
/// </summary>
public class PPFGCurveFamily_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-PPFGCurveFamily:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public PPFGCurveFamily_1_0_0Data? Data { get; set; }

}

public class PPFGCurveFamily_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
