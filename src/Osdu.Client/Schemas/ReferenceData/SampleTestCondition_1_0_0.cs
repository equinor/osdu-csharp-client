...
/// <summary>
/// The category of environmental parameters and conditions under which fluid samples are analyzed and tested. These test conditions are designed to replicate the temperature and pressure conditions found in the subsurface reservoir.
/// </summary>
public class SampleTestCondition_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-SampleTestCondition:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public SampleTestCondition_1_0_0Data? Data { get; set; }

}

public class SampleTestCondition_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
