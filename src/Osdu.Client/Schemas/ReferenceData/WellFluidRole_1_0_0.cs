...
/// <summary>
/// Purpose the fluid will play in the wellbore, such as Cement Displacement, Hole Cleaning, Sweep, Completion Fluid.
/// </summary>
public class WellFluidRole_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-WellFluidRole:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public WellFluidRole_1_0_0Data? Data { get; set; }

}

public class WellFluidRole_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
