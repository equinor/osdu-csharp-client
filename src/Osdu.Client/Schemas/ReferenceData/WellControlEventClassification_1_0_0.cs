...
/// </summary>
public class WellControlEventClassification_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-WellControlEventClassification:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public WellControlEventClassification_1_0_0Data? Data { get; set; }

}

public class WellControlEventClassification_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
