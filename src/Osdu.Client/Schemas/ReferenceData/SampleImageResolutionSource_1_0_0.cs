...
/// <summary>
/// The source of the pixel resolution for s sample image, for example, it may be inferred from a scale bar or a known reference.
/// </summary>
public class SampleImageResolutionSource_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-SampleImageResolutionSource:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public SampleImageResolutionSource_1_0_0Data? Data { get; set; }

}

public class SampleImageResolutionSource_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
