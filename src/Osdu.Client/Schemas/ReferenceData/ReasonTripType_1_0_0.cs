...
/// <summary>
/// BHA trip reason such as Change Bottomhole Assembly, Downhole Motor Failure, Drill Stem Failure
/// </summary>
public class ReasonTripType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-ReasonTripType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public ReasonTripType_1_0_0Data? Data { get; set; }

}

public class ReasonTripType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
