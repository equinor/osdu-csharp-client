...
/// <summary>
/// the reference value type defining the radar polarisation utilised for the image acquisition. The polarisation being the direction of the electromagnetic wave.
/// </summary>
public class InSARPolarisation_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-InSARPolarisation:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public InSARPolarisation_1_0_0Data? Data { get; set; }

}

public class InSARPolarisation_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
