...
/// <summary>
/// List of values that indicate the phases of a relative permeability curve in a two-phase or three-phase system.
/// </summary>
public class RockModelRelativePermeabilityPhase_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-RockModelRelativePermeabilityPhase:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public RockModelRelativePermeabilityPhase_1_0_0Data? Data { get; set; }

}

public class RockModelRelativePermeabilityPhase_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
