...
/// <summary>
/// The reference list to specify the material grade standard.  Typically the type is "API/ISO" or "Proprietary".
/// </summary>
public class MaterialGradeStandardType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-MaterialGradeStandardType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public MaterialGradeStandardType_1_0_0Data? Data { get; set; }

}

public class MaterialGradeStandardType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
