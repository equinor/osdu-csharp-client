...
/// <summary>
/// Reference list of facet names, includes items such as such as  Minimum, Maximum  and Average
/// </summary>
public class FluidPropertyFacetName_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-FluidPropertyFacetName:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public FluidPropertyFacetName_1_0_0Data? Data { get; set; }

}

public class FluidPropertyFacetName_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
