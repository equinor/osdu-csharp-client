...
/// <summary>
/// Defines the type of Mooring used to secure the rig.
/// </summary>
public class MooringType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-MooringType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public MooringType_1_0_0Data? Data { get; set; }

}

public class MooringType_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
