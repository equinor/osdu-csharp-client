...
/// <summary>
/// The discriminator type to scope work-product-component--ReservoirEstimatedVolumes to either in-place or technical recoverable volume.
/// </summary>
public class ReservoirEstimatedVolumeType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-ReservoirEstimatedVolumeType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public ReservoirEstimatedVolumeType_1_0_0Data? Data { get; set; }

}

public class ReservoirEstimatedVolumeType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
