...
/// </summary>
public class PersonnelServiceType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-PersonnelServiceType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public PersonnelServiceType_1_0_0Data? Data { get; set; }

}

public class PersonnelServiceType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
