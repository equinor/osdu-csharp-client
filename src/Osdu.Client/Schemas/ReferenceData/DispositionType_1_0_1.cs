...
/// <summary>
/// The result of a stage of movement, or use, of a product within the value stream of a well or facility.
/// </summary>
public class DispositionType_1_0_1
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-DispositionType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public DispositionType_1_0_1Data? Data { get; set; }

}

public class DispositionType_1_0_1Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
