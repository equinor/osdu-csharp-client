...
/// <summary>
/// The type of violation of a license that is being recorded. Can be as simple as failure to submit necessary reports or something more difficult such as improper procedures.
/// </summary>
public class WellLicenseViolationType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-WellLicenseViolationType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public WellLicenseViolationType_1_0_0Data? Data { get; set; }

}

public class WellLicenseViolationType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
