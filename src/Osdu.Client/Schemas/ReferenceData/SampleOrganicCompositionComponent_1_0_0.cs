...
/// <summary>
/// Names of chemical elements and compounds, including many hydrocarbon compounds, found in a fluid.
/// </summary>
public class SampleOrganicCompositionComponent_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-SampleOrganicCompositionComponent:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public SampleOrganicCompositionComponent_1_0_0Data? Data { get; set; }

}

public class SampleOrganicCompositionComponent_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
