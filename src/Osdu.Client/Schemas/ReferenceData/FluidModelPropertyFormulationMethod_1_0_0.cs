...
/// <summary>
/// List of formulation methods, such as Peng-Robinson equation of state, used in generating the numerical values assigned to Fluid Model properties.
/// </summary>
public class FluidModelPropertyFormulationMethod_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-FluidModelPropertyFormulationMethod:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public FluidModelPropertyFormulationMethod_1_0_0Data? Data { get; set; }

}

public class FluidModelPropertyFormulationMethod_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
