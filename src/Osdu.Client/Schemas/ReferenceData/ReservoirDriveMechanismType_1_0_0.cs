...
/// <summary>
/// A reservoir drive mechanism refers to the energy source that helps displace hydrocarbons from a subsurface reservoir and push them toward the production well. The drive mechanism is crucial for designing effective reservoir management strategies and optimizing hydrocarbon recovery.
/// </summary>
public class ReservoirDriveMechanismType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-ReservoirDriveMechanismType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public ReservoirDriveMechanismType_1_0_0Data? Data { get; set; }

}

public class ReservoirDriveMechanismType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
