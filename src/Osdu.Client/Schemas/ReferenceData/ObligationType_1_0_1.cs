...
/// <summary>
/// An article or clause [OSDU calls this Obligation Type] that introduces a condition or term which the fulfillment of an agreement depends (provides operational and/or earning requirements) A kind of commitment or duty that in specific scenarios requires a particular course of action as defined in an agreement.
/// </summary>
public class ObligationType_1_0_1
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-ObligationType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public ObligationType_1_0_1Data? Data { get; set; }

}

public class ObligationType_1_0_1Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
