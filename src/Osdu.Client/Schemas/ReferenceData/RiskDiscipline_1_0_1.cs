...
/// <summary>
/// Organisational unit accountable for maintaining appropriate focus on a risk and its management and for appropriate consultation with stakeholders
/// </summary>
public class RiskDiscipline_1_0_1
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-RiskDiscipline:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public RiskDiscipline_1_0_1Data? Data { get; set; }

}

public class RiskDiscipline_1_0_1Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
