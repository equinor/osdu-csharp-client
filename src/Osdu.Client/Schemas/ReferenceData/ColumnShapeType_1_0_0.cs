...
/// <summary>
/// An enumeration for column shape types based on RESQML, i.e. triangular, quadrilateral, polygonal.
/// </summary>
public class ColumnShapeType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-ColumnShapeType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public ColumnShapeType_1_0_0Data? Data { get; set; }

}

public class ColumnShapeType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
