...
/// <summary>
/// Describes the meaning of the seismic sample measurements such as amplitude, phase, dip, azimuth.
/// </summary>
public class SeismicAttributeType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-SeismicAttributeType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public SeismicAttributeType_1_0_0Data? Data { get; set; }

}

public class SeismicAttributeType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
