...
/// <summary>
/// Non-Productive Time SeverityLevel - gradational scale based on assessed Time and/or Cost impact to the ongoing well activity
/// </summary>
public class NPTSeverityLevel_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-NPTSeverityLevel:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public NPTSeverityLevel_1_0_0Data? Data { get; set; }

}

public class NPTSeverityLevel_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
