...
/// <summary>
/// Identifies the phases of fluid present in the sample. In this context, the concept is a combination of substance type and phase.
/// </summary>
public class FluidPhasesPresent_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-FluidPhasesPresent:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public FluidPhasesPresent_1_0_0Data? Data { get; set; }

}

public class FluidPhasesPresent_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
