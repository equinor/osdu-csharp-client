...
/// <summary>
/// A classification of how well an aquifer delivers recharge water to the reservoir. It also refers to how well the aquifer mitigates the reservoir's normal pressure decline.
/// </summary>
public class AquiferStrengthType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-AquiferStrengthType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public AquiferStrengthType_1_0_0Data? Data { get; set; }

}

public class AquiferStrengthType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
