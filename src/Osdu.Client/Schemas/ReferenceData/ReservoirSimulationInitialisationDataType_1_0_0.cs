...
/// </summary>
public class ReservoirSimulationInitialisationDataType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-ReservoirSimulationInitialisationDataType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public ReservoirSimulationInitialisationDataType_1_0_0Data? Data { get; set; }

}

public class ReservoirSimulationInitialisationDataType_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
