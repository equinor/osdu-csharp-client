...
/// <summary>
/// Defines the Cement job stage(s). Allows combination of several stages for one Cement Job. Most conventional jobs constitute one stage.
/// </summary>
public class CementStageType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-CementStageType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public CementStageType_1_0_0Data? Data { get; set; }

}

public class CementStageType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
