...
/// <summary>
/// The base fluid type of the Mud/Drilling Fluid in well at time of the Formation Integrity test.
/// </summary>
public class MudBaseType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-MudBaseType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public MudBaseType_1_0_0Data? Data { get; set; }

}

public class MudBaseType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
