...
/// <summary>
/// LogCurveFamily is the detailed Geological Physical Quantity Measured - such as neutron porosity.
/// </summary>
public class LogCurveFamily_1_1_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-LogCurveFamily:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public LogCurveFamily_1_1_0Data? Data { get; set; }

}

public class LogCurveFamily_1_1_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
    [JsonPropertyName("PropertyType")]
    public AbstractPropertyType100? PropertyType { get; set; }

    /// <summary>
    /// Only populated of the ValueType is "number". It holds the UnitQuantity associated with this reference property type. It is a relationship to UnitQuantity record.  Denormalized value: the UnitQuantityID is derived from the PropertyType's UnitQuantity.
    /// </summary>
