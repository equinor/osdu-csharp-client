...
/// <summary>
/// A type of fluid used during core analysis experiments, e.g., for saturation or desaturation of the sample.
/// </summary>
public class CoreAnalysisFluidType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-CoreAnalysisFluidType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public CoreAnalysisFluidType_1_0_0Data? Data { get; set; }

}

public class CoreAnalysisFluidType_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
