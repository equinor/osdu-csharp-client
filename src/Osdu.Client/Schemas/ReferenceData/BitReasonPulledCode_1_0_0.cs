...
/// <summary>
/// IADC Dull Grade Reason Pulled or Run Terminated Codes for Roller Cone and Fixed Cutter Bit Types.
/// </summary>
public class BitReasonPulledCode_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-BitReasonPulledCode:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public BitReasonPulledCode_1_0_0Data? Data { get; set; }

}

public class BitReasonPulledCode_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
