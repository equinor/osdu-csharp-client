...
/// <summary>
/// A list of well log tool class codes and a description of each code. It is used for classifications in context of the Energistics Practical Well Log Standard (PWLS).
/// </summary>
public class WellLogToolClass_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-WellLogToolClass:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public WellLogToolClass_1_0_0Data? Data { get; set; }

}

public class WellLogToolClass_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
