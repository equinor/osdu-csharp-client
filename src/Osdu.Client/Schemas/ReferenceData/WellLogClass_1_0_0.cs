...
/// <summary>
/// Identifies the business domain of a set of associated well log curves. Examples include, Petrophysical Logs, Drilling Logs and Production Logs.
/// </summary>
public class WellLogClass_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-WellLogClass:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public WellLogClass_1_0_0Data? Data { get; set; }

}

public class WellLogClass_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
