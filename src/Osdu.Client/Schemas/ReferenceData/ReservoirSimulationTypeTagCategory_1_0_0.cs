...
/// <summary>
/// Categories that classify reservoir simulation type tags more broadly for filtering purposes.
/// </summary>
public class ReservoirSimulationTypeTagCategory_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-ReservoirSimulationTypeTagCategory:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public ReservoirSimulationTypeTagCategory_1_0_0Data? Data { get; set; }

}

public class ReservoirSimulationTypeTagCategory_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
