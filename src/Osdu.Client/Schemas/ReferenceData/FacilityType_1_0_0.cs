...
/// <summary>
/// Used to identify and describe the type of facility. A facility is a grouping of equipment that is located within a specific geographic boundary or site and that is used in the context of energy-related activities such as exploration, extraction, generation, storage, processing, disposal, supply, or transfer. Clarifications: (1) A facility may be surface or subsurface located. (2) Usually facility equipment is commonly owned or operated. (3) Industry definitions may vary and differ from this one.
/// </summary>
public class FacilityType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-FacilityType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public FacilityType_1_0_0Data? Data { get; set; }

}

public class FacilityType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
