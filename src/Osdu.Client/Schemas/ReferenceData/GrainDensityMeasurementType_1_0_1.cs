...
/// <summary>
/// The type of measurement used to calculate the mass of solid material within a sample relative to the volume of the sample.
/// </summary>
public class GrainDensityMeasurementType_1_0_1
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-GrainDensityMeasurementType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public GrainDensityMeasurementType_1_0_1Data? Data { get; set; }

}

public class GrainDensityMeasurementType_1_0_1Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
