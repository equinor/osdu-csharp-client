...
/// <summary>
/// The role of an individual supporting a Project, such as Project Manager, Party Chief, Client Representative, Senior Observer.
/// </summary>
public class ProjectRole_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-ProjectRole:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public ProjectRole_1_0_0Data? Data { get; set; }

}

public class ProjectRole_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
