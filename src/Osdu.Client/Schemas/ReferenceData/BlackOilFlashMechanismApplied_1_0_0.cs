...
/// <summary>
/// List of the liberation or flash processes that can represent the depletion in the reservoir, and therefore applied to create the Black Oil model. This is only applicable for Black Oil models.
/// </summary>
public class BlackOilFlashMechanismApplied_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-BlackOilFlashMechanismApplied:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public BlackOilFlashMechanismApplied_1_0_0Data? Data { get; set; }

}

public class BlackOilFlashMechanismApplied_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
