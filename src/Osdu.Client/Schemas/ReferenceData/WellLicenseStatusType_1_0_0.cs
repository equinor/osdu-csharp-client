...
/// <summary>
/// Some status information is permanent or semipermanent. Other status information may indicate where a specific data object is on a life cycle, workflow or business process.
/// </summary>
public class WellLicenseStatusType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-WellLicenseStatusType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
...
public class WellLicenseStatusType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
    /// <summary>
    ...
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-WellLicenseStatusClass:[\w\-\.\:\%]+:[0-9]*$")]
    [JsonPropertyName("StatusClassID")]
    public string StatusClassID { get; set; }
