...
/// <summary>
/// Identifies the way in which soil or rock was compacted in the context of triaxial compressibility testing.
/// </summary>
public class ConsolidationType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-ConsolidationType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public ConsolidationType_1_0_0Data? Data { get; set; }

}

public class ConsolidationType_1_0_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
