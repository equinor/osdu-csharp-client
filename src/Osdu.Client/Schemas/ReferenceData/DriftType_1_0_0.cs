...
/// <summary>
/// The reference list of possible tubular drift types.  For example, is the drift type "Standard" or "Special".
/// </summary>
public class DriftType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-DriftType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public DriftType_1_0_0Data? Data { get; set; }

}

public class DriftType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
