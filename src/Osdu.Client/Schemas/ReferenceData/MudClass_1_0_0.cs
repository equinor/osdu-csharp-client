...
/// <summary>
/// The status of the fluid liquid. Proposed reference values: water based, oil based, other, pneumatic, unknown
/// </summary>
public class MudClass_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-MudClass:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public MudClass_1_0_0Data? Data { get; set; }

}

public class MudClass_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
