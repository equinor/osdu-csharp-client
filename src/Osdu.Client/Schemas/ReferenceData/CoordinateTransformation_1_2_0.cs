...
/// </summary>
public class CoordinateTransformation_1_2_0
{
    /// <summary>
    ...
    public CoordinateTransformation_1_2_0Data? Data { get; set; }

}

public class CoordinateTransformation_1_2_0Data : AbstractCommonResources101 // Also composes: AbstractReferenceType100
{
    /// <summary>
    ...
    public CoordinateTransformation_1_2_0DataMethod? Method { get; set; }
    ...
    public List<CoordinateTransformation_1_2_0DataConcatenatedTransformations> ConcatenatedTransformations { get; set; }
    ...
    public CoordinateTransformation_1_2_0DataCoordinateTransformationType CoordinateTransformationType { get; set; }

    /// <summary>
    /// The source CRS of the Transformation.
    /// </summary>
    [JsonPropertyName("SourceCRS")]
    public CoordinateTransformation_1_2_0DataSourceCRS? SourceCRS { get; set; }

    /// <summary>
    /// The target CRS of this Transformation.
    /// </summary>
    [JsonPropertyName("TargetCRS")]
    public CoordinateTransformation_1_2_0DataTargetCRS? TargetCRS { get; set; }

    /// <summary>
    /// Contextual information about scope and extent/area of use.
    /// </summary>
    [JsonPropertyName("Usages")]
    public List<CoordinateTransformation_1_2_0DataUsages> Usages { get; set; }

    /// <summary>
    /// Scope and extent information about the described transformation.
    /// </summary>
    [JsonPropertyName("PreferredUsage")]
    public CoordinateTransformation_1_2_0DataPreferredUsage? PreferredUsage { get; set; }
...
/// The Transformation method; "Concatenated" for CoordinateTransformationType == ConcatenatedOperation; EPSG method code and name for CoordinateTransformationType == Transformation.
/// </summary>
public class CoordinateTransformation_1_2_0DataMethod
{
    /// <summary>
    /// The method authority code, corresponding to the ISO19111 ID and 'projjson' id.
    /// </summary>
    [JsonPropertyName("AuthorityCode")]
    public CoordinateTransformation_1_2_0DataMethodAuthorityCode? AuthorityCode { get; set; }
...
/// The method authority code, corresponding to the ISO19111 ID and 'projjson' id.
/// </summary>
public class CoordinateTransformation_1_2_0DataMethodAuthorityCode
{
    /// <summary>
...
/// Only populated for CoordinateTransformationType == ConcatenatedOperation: the ordered list of chained transformations.
/// </summary>
public class CoordinateTransformation_1_2_0DataConcatenatedTransformations
{
    /// <summary>
    /// The Transformation authority code, corresponding to the ISO19111 ID and 'projjson' id.
    /// </summary>
    [JsonPropertyName("AuthorityCode")]
    public CoordinateTransformation_1_2_0DataConcatenatedTransformationsAuthorityCode? AuthorityCode { get; set; }
...
/// The Transformation authority code, corresponding to the ISO19111 ID and 'projjson' id.
/// </summary>
public class CoordinateTransformation_1_2_0DataConcatenatedTransformationsAuthorityCode
{
    /// <summary>
...
public enum CoordinateTransformation_1_2_0DataCoordinateTransformationType
{
...
/// The source CRS of the Transformation.
/// </summary>
public class CoordinateTransformation_1_2_0DataSourceCRS
{
    /// <summary>
    /// The source CRS authority code, corresponding to the ISO19111 ID and 'projjson' id.
    /// </summary>
    [JsonPropertyName("AuthorityCode")]
    public CoordinateTransformation_1_2_0DataSourceCRSAuthorityCode? AuthorityCode { get; set; }
...
/// The source CRS authority code, corresponding to the ISO19111 ID and 'projjson' id.
/// </summary>
public class CoordinateTransformation_1_2_0DataSourceCRSAuthorityCode
{
    /// <summary>
    /// The authority governing the 'Code'.
    /// </summary>
...
/// The target CRS of this Transformation.
/// </summary>
public class CoordinateTransformation_1_2_0DataTargetCRS
{
    /// <summary>
    /// The target CRS authority code, corresponding to the ISO19111 ID and 'projjson' id.
    /// </summary>
    [JsonPropertyName("AuthorityCode")]
    public CoordinateTransformation_1_2_0DataTargetCRSAuthorityCode? AuthorityCode { get; set; }
...
/// The target CRS authority code, corresponding to the ISO19111 ID and 'projjson' id.
/// </summary>
public class CoordinateTransformation_1_2_0DataTargetCRSAuthorityCode
{
    /// <summary>
    /// The authority governing the 'Code'.
    /// </summary>
...
/// Scope and extent information about the described transformation.
/// </summary>
public class CoordinateTransformation_1_2_0DataUsages
{
    /// <summary>
    /// The Usage authority code, corresponding to the ISO19111 ID and 'projjson' id.
    /// </summary>
    [JsonPropertyName("AuthorityCode")]
    public CoordinateTransformation_1_2_0DataUsagesAuthorityCode? AuthorityCode { get; set; }
    ...
    public CoordinateTransformation_1_2_0DataUsagesExtent? Extent { get; set; }

    [JsonPropertyName("Scope")]
    public CoordinateTransformation_1_2_0DataUsagesScope? Scope { get; set; }
...
/// The Usage authority code, corresponding to the ISO19111 ID and 'projjson' id.
/// </summary>
public class CoordinateTransformation_1_2_0DataUsagesAuthorityCode
{
    /// <summary>
    /// The authority governing the 'Code'.
    /// </summary>
...
/// Extent or area of use information.
/// </summary>
public class CoordinateTransformation_1_2_0DataUsagesExtent
{
    /// <summary>
    /// The Extent authority code, corresponding to the ISO19111 ID and 'projjson' id.
    /// </summary>
    [JsonPropertyName("AuthorityCode")]
    public CoordinateTransformation_1_2_0DataUsagesExtentAuthorityCode? AuthorityCode { get; set; }
...
/// The Extent authority code, corresponding to the ISO19111 ID and 'projjson' id.
/// </summary>
public class CoordinateTransformation_1_2_0DataUsagesExtentAuthorityCode
{
    /// <summary>
    /// The authority governing the 'Code'.
    /// </summary>
...
public class CoordinateTransformation_1_2_0DataUsagesScope
{
    /// <summary>
    /// The Scope authority code, corresponding to the ISO19111 ID and 'projjson' id.
    /// </summary>
    [JsonPropertyName("AuthorityCode")]
    public CoordinateTransformation_1_2_0DataUsagesScopeAuthorityCode? AuthorityCode { get; set; }
...
/// The Scope authority code, corresponding to the ISO19111 ID and 'projjson' id.
/// </summary>
public class CoordinateTransformation_1_2_0DataUsagesScopeAuthorityCode
{
    /// <summary>
    /// The authority governing the 'Code'.
    /// </summary>
...
/// Scope and extent information about the described transformation.
/// </summary>
public class CoordinateTransformation_1_2_0DataPreferredUsage
{
    /// <summary>
    /// The Preferred Usage authority code, corresponding to the ISO19111 ID and 'projjson' id.
    /// </summary>
    [JsonPropertyName("AuthorityCode")]
    public CoordinateTransformation_1_2_0DataPreferredUsageAuthorityCode? AuthorityCode { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("Extent")]
    public CoordinateTransformation_1_2_0DataPreferredUsageExtent? Extent { get; set; }

    [JsonPropertyName("Scope")]
    public CoordinateTransformation_1_2_0DataPreferredUsageScope? Scope { get; set; }
...
/// The Preferred Usage authority code, corresponding to the ISO19111 ID and 'projjson' id.
/// </summary>
public class CoordinateTransformation_1_2_0DataPreferredUsageAuthorityCode
{
    /// <summary>
    /// The authority governing the 'Code'.
    /// </summary>
...
/// Extent or area of use information.
/// </summary>
public class CoordinateTransformation_1_2_0DataPreferredUsageExtent
{
    /// <summary>
    /// The Preferred Extent authority code, corresponding to the ISO19111 ID and 'projjson' id.
    /// </summary>
    [JsonPropertyName("AuthorityCode")]
    public CoordinateTransformation_1_2_0DataPreferredUsageExtentAuthorityCode? AuthorityCode { get; set; }
...
/// The Preferred Extent authority code, corresponding to the ISO19111 ID and 'projjson' id.
/// </summary>
public class CoordinateTransformation_1_2_0DataPreferredUsageExtentAuthorityCode
{
    /// <summary>
    /// The authority governing the 'Code'.
    /// </summary>
...
public class CoordinateTransformation_1_2_0DataPreferredUsageScope
{
    /// <summary>
    /// The Scope authority code, corresponding to the ISO19111 ID and 'projjson' id.
    /// </summary>
    [JsonPropertyName("AuthorityCode")]
    public CoordinateTransformation_1_2_0DataPreferredUsageScopeAuthorityCode? AuthorityCode { get; set; }
...
/// The Scope authority code, corresponding to the ISO19111 ID and 'projjson' id.
/// </summary>
public class CoordinateTransformation_1_2_0DataPreferredUsageScopeAuthorityCode
{
    /// <summary>
    /// The authority governing the 'Code'.
    /// </summary>
