...
/// <summary>
/// Geological type of fault geometry, such as Thrust (thr), Reverse (rev), Normal(norm), Strike-slip.
/// </summary>
public class SeismicFaultType_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-SeismicFaultType:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public SeismicFaultType_1_0_0Data? Data { get; set; }

}

public class SeismicFaultType_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
