...
/// <summary>
/// ChronoStratigraphicScheme defines a scheme, which groups ChronoStratigraphy records into a consistent set. The schemes are associated to well-known publications.
/// </summary>
public class ChronoStratigraphicScheme_1_0_0
{
    /// <summary>
    /// Previously called ResourceID or SRN which identifies this OSDU resource object without version.
    /// </summary>
    [RegularExpression(@"^[\w\-\.]+:reference-data\-\-ChronoStratigraphicScheme:[\w\-\.\:\%]+$")]
    [JsonPropertyName("id")]
    ...
    public ChronoStratigraphicScheme_1_0_0Data? Data { get; set; }

}

public class ChronoStratigraphicScheme_1_0_0Data : AbstractCommonResources100 // Also composes: AbstractReferenceType100
{
