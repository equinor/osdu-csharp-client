...
public partial class MainWindow : Window
{
    ...
    private async void SearchButton1_Click(object sender, RoutedEventArgs e)
    {
        ...
        try
        {
            ...
            List<Record> records = new List<Record>()
            {
                new Record()
                {
                    ...
                    Acl = new StorageAcl {Viewers = ["data.office.global.viewers@dev.dataservices.energy"], Owners = ["data.masterdata.owners@dev.dataservices.energy"]},
